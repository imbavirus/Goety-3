...
public class BrewingCatalystProcessor {
    ...
    public static Map<String, String> process(String effectId, Object level) {
        try {
            ...
            if (effect == null) {
                Goetied.LOGGER.warn("Mob effect {} not found", effectId);
            ...
            if (level != null) {
                try {
                    ...
                    Goetied.LOGGER.warn("Failed to load brewing recipe for effect {} from recipe manager: {}", effectId, e.getMessage());
                }
            }
            ...
            Goetied.LOGGER.error("Error processing brewing catalyst recipe {}: {}", effectId, e.getMessage(), e);
            return java.util.Collections.emptyMap();
        }
    }
}
