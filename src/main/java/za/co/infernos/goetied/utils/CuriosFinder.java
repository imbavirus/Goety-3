...
import za.co.infernos.goetied.common.items.brew.ThrowableBrewItem;
import top.theillusivec4.curios.api.CuriosApi;
import top.theillusivec4.curios.api.SlotResult;
import za.co.infernos.goetied.common.items.curios.*;

import za.co.infernos.goetied.common.items.handler.BrewBagItemHandler;
import za.co.infernos.goetied.compat.curios.CuriosLoaded;
...
public class CuriosFinder {
    ...
    public static boolean neutralWildSet(LivingEntity livingEntity) {
        return hasWildSet(livingEntity) && za.co.infernos.goetied.utils.ConfigHelper.getBoolean(ItemConfig.WildSetMobNeutral, false);
    }
    ...
    public static boolean validWildMob(LivingEntity livingEntity) {
        return (livingEntity instanceof Animal
                ...
                && livingEntity.getMaxHealth() <= za.co.infernos.goetied.utils.ConfigHelper.getDouble(ItemConfig.WildSetMobNeutralHealth, 50.0D)
    ...
    public static boolean neutralVoidSet(LivingEntity livingEntity) {
        return hasVoidSet(livingEntity) && za.co.infernos.goetied.utils.ConfigHelper.getBoolean(ItemConfig.VoidSetMobNeutral, false);
    }
    ...
    public static boolean validVoidMob(LivingEntity livingEntity) {
        return (livingEntity instanceof AbstractEnderling
                ...
                && livingEntity.getMaxHealth() <= za.co.infernos.goetied.utils.ConfigHelper.getDouble(ItemConfig.VoidSetMobNeutralHealth, 50.0D)
                && !(livingEntity instanceof IOwned && !(livingEntity instanceof Enemy));
    }
    ...
    public static boolean neutralNetherSet(LivingEntity livingEntity) {
        return hasNetherSet(livingEntity) && za.co.infernos.goetied.utils.ConfigHelper.getBoolean(ItemConfig.NetherSetMobNeutral, false);
    }
    ...
    public static boolean validNetherMob(LivingEntity livingEntity) {
        return (livingEntity instanceof Blaze
                ...
                && livingEntity.getMaxHealth() <= za.co.infernos.goetied.utils.ConfigHelper.getDouble(ItemConfig.NetherSetMobNeutralHealth, 50.0D)
                && !(livingEntity instanceof IOwned && !(livingEntity instanceof Enemy));
    }
    ...
    public static boolean isWitchFriendly(LivingEntity livingEntity) {
        return (hasWitchSet(livingEntity) && za.co.infernos.goetied.utils.ConfigHelper.getBoolean(ItemConfig.WitchSetWitchNeutral, false))
                || (hasWarlockRobe(livingEntity) && za.co.infernos.goetied.utils.ConfigHelper.getBoolean(ItemConfig.WarlockRobeWitchNeutral, false))
                || (hasNetherRobe(livingEntity) && za.co.infernos.goetied.utils.ConfigHelper.getBoolean(ItemConfig.NetherRobeWitchNeutral, false))
    ...
    public static boolean neutralNecroCrown(LivingEntity livingEntity) {
        return hasNecroCrown(livingEntity) && za.co.infernos.goetied.utils.ConfigHelper.getBoolean(ItemConfig.NecroSetUndeadNeutral, false);
    }

    public static boolean neutralNecroCape(LivingEntity livingEntity) {
        return hasNecroCape(livingEntity) && za.co.infernos.goetied.utils.ConfigHelper.getBoolean(ItemConfig.NecroSetUndeadNeutral, false);
    }
    ...
    public static boolean neutralNecroSet(LivingEntity livingEntity) {
        return hasNecroSet(livingEntity) && za.co.infernos.goetied.utils.ConfigHelper.getBoolean(ItemConfig.NecroSetUndeadNeutral, false);
    }
    ...
    public static boolean validNecroUndead(LivingEntity livingEntity) {
        return (livingEntity.isInvertedHealAndHarm()
                ...
                && livingEntity.getMaxHealth() <= za.co.infernos.goetied.utils.ConfigHelper.getDouble(ItemConfig.NecroSetUndeadNeutralHealth, 20.0D)
                && !(livingEntity instanceof IOwned && !(livingEntity instanceof Enemy));
    }
    ...
    public static boolean neutralNamelessCrown(LivingEntity livingEntity) {
        return hasNamelessCrown(livingEntity) && za.co.infernos.goetied.utils.ConfigHelper.getBoolean(ItemConfig.NamelessSetUndeadNeutral, false);
    }

    public static boolean neutralNamelessCape(LivingEntity livingEntity) {
        return hasNamelessCape(livingEntity) && za.co.infernos.goetied.utils.ConfigHelper.getBoolean(ItemConfig.NamelessSetUndeadNeutral, false);
    }
    ...
    public static boolean neutralNamelessSet(LivingEntity livingEntity) {
        return hasNamelessSet(livingEntity) && za.co.infernos.goetied.utils.ConfigHelper.getBoolean(ItemConfig.NamelessSetUndeadNeutral, false);
    }

    public static boolean validNamelessUndead(LivingEntity livingEntity) {
        return ((livingEntity.isInvertedHealAndHarm())
                || livingEntity.getType().is(ModTags.EntityTypes.NECRO_SET_NEUTRAL))
                && livingEntity.getMaxHealth() <= za.co.infernos.goetied.utils.ConfigHelper.getDouble(ItemConfig.NamelessSetUndeadNeutralHealth, 50.0D)
                && !(livingEntity instanceof IOwned && !(livingEntity instanceof Enemy));
    }
    ...
    public static boolean hasUndeadCrown(LivingEntity livingEntity) {
        return CuriosFinder.hasCurio(livingEntity,
                ...
                || (livingEntity instanceof AbstractNecromancer && za.co.infernos.goetied.utils.ConfigHelper.getBoolean(MobsConfig.NecromancerSummonsLife, false));
    }
    ...
    public static boolean neutralFrostSet(LivingEntity livingEntity) {
        return hasFrostSet(livingEntity) && za.co.infernos.goetied.utils.ConfigHelper.getBoolean(ItemConfig.FrostSetMobNeutral, false);
    }
    ...
    public static boolean validFrostMob(LivingEntity livingEntity) {
        return (livingEntity.getType().is(ModTags.EntityTypes.FROST_SET_NEUTRAL))
                && livingEntity.getMaxHealth() <= za.co.infernos.goetied.utils.ConfigHelper.getDouble(ItemConfig.FrostSetMobNeutralHealth, 20.0D)
                && !(livingEntity instanceof IOwned && !(livingEntity instanceof Enemy));
    }
    ...
    public static boolean neutralAbyssSet(LivingEntity livingEntity) {
        return hasAbyssSet(livingEntity) && za.co.infernos.goetied.utils.ConfigHelper.getBoolean(ItemConfig.AbyssSetMobNeutral, false);
    }
    ...
    public static boolean validAbyssMob(LivingEntity livingEntity) {
        return (livingEntity.getType().is(ModTags.EntityTypes.ABYSS_SET_NEUTRAL))
                && livingEntity.getMaxHealth() <= za.co.infernos.goetied.utils.ConfigHelper.getDouble(ItemConfig.AbyssSetMobNeutralHealth, 50.0D)
                && !(livingEntity instanceof IOwned && !(livingEntity instanceof Enemy));
    }
