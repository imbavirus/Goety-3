...
import za.co.infernos.goetied.common.entities.ally.illager.PillagerServant;
...
import za.co.infernos.goetied.common.entities.ally.illager.VindicatorServant;
...
import za.co.infernos.goetied.common.entities.ally.undead.zombie.ZombieVillagerServant;
import za.co.infernos.goetied.common.entities.hostile.BorderWraith;
import za.co.infernos.goetied.common.entities.hostile.MuckWraith;
import za.co.infernos.goetied.common.entities.hostile.Wraith;
...
public class ServantUtil {
    ...
    public static InteractionResult equipServantArmor(Player player, Summoned summoned, ItemStack itemStack,
        ...
        if (itemStack.getItem() instanceof ArmorItem armor) {
            if (za.co.infernos.goetied.utils.ConfigHelper.getBoolean(MobsConfig.RaiderServantWearArmor, false) || !(summoned instanceof RaiderServant)) {
        ...
        } else if (itemStack.is(Items.CARVED_PUMPKIN) && za.co.infernos.goetied.utils.ConfigHelper.getBoolean(MobsConfig.ServantsCanWearPumpkin, false)) {
            summoned.playSound(SoundEvents.ARMOR_EQUIP_GENERIC.value(), 1.0F, 1.0F);
            summoned.setItemSlot(EquipmentSlot.HEAD, itemStack.copyWithCount(1));
            summoned.dropEquipment(EquipmentSlot.HEAD, helmet);
            summoned.setGuaranteedDrop(EquipmentSlot.HEAD);
    ...
    enum HealType {
        ABYSS(
                ...
                za.co.infernos.goetied.utils.ConfigHelper.getBoolean(MobsConfig.WaterMinionHeal, false),
                za.co.infernos.goetied.utils.ConfigHelper.getInt(MobsConfig.WaterMinionHealCost, 1),
                za.co.infernos.goetied.utils.ConfigHelper.getInt(MobsConfig.WaterMinionHealTime, 1),
                za.co.infernos.goetied.utils.ConfigHelper.getDouble(MobsConfig.WaterMinionHealAmount, 1.0D)),
        WILD(
                ServantUtil::isWildHeal,
                CuriosFinder::hasWildRobe,
                za.co.infernos.goetied.utils.ConfigHelper.getBoolean(MobsConfig.NaturalMinionHeal, false),
                za.co.infernos.goetied.utils.ConfigHelper.getInt(MobsConfig.NaturalMinionHealCost, 0),
                za.co.infernos.goetied.utils.ConfigHelper.getInt(MobsConfig.NaturalMinionHealTime, 0),
                za.co.infernos.goetied.utils.ConfigHelper.getDouble(MobsConfig.NaturalMinionHealAmount, 1.0D)),
        FROST(
                ServantUtil::isFrostHeal,
                CuriosFinder::hasFrostRobes,
                za.co.infernos.goetied.utils.ConfigHelper.getBoolean(MobsConfig.FrostMinionHeal, false),
                za.co.infernos.goetied.utils.ConfigHelper.getInt(MobsConfig.FrostMinionHealCost, 1),
                za.co.infernos.goetied.utils.ConfigHelper.getInt(MobsConfig.FrostMinionHealTime, 1),
                za.co.infernos.goetied.utils.ConfigHelper.getDouble(MobsConfig.FrostMinionHealAmount, 1.0D)),
        NETHER(
                ServantUtil::isNetherHeal,
                CuriosFinder::hasNetherRobe,
                za.co.infernos.goetied.utils.ConfigHelper.getBoolean(MobsConfig.NetherMinionHeal, false),
                za.co.infernos.goetied.utils.ConfigHelper.getInt(MobsConfig.NetherMinionHealCost, 0),
                za.co.infernos.goetied.utils.ConfigHelper.getInt(MobsConfig.NetherMinionHealTime, 1),
                za.co.infernos.goetied.utils.ConfigHelper.getDouble(MobsConfig.NetherMinionHealAmount, 1.0D)),
        VOID(
                ServantUtil::isVoidHeal,
                CuriosFinder::hasVoidRobe,
                za.co.infernos.goetied.utils.ConfigHelper.getBoolean(MobsConfig.VoidMinionHeal, false),
                za.co.infernos.goetied.utils.ConfigHelper.getInt(MobsConfig.VoidMinionHealCost, 0),
                za.co.infernos.goetied.utils.ConfigHelper.getInt(MobsConfig.VoidMinionHealTime, 1),
                za.co.infernos.goetied.utils.ConfigHelper.getDouble(MobsConfig.VoidMinionHealAmount, 1.0D)),
        NECRO(
                ServantUtil::isNecroHeal,
                CuriosFinder::hasUndeadCape,
                za.co.infernos.goetied.utils.ConfigHelper.getBoolean(MobsConfig.UndeadMinionHeal, false),
                za.co.infernos.goetied.utils.ConfigHelper.getInt(MobsConfig.UndeadMinionHealCost, 0),
                za.co.infernos.goetied.utils.ConfigHelper.getInt(MobsConfig.UndeadMinionHealTime, 1),
                za.co.infernos.goetied.utils.ConfigHelper.getDouble(MobsConfig.UndeadMinionHealAmount, 20.0D));
