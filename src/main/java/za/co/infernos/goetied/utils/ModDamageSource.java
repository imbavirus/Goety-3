...
public class ModDamageSource extends DamageSource {
    ...
    public static ResourceKey<DamageType> create(String name) {
        return ResourceKey.create(Registries.DAMAGE_TYPE, Goetied.location(name));
    }
    ...
    public static void bootstrap(BootstrapContext<DamageType> context) {
        context.register(SUMMON, new DamageType("goetied.summon", 0.1F));
        context.register(SHOCK, new DamageType("goetied.shock", 0.0F));
        context.register(DIRECT_SHOCK, new DamageType("goetied.directShock", 0.0F));
        context.register(INDIRECT_SHOCK, new DamageType("goetied.indirectShock", 0.0F));
        context.register(LIGHTNING, new DamageType("goetied.lightning", 0.0F));
        context.register(DIRECT_FREEZE, new DamageType("goetied.directFreeze", 0.0F, DamageEffects.FREEZING));
        context.register(INDIRECT_FREEZE, new DamageType("goetied.indirectFreeze", 0.0F, DamageEffects.FREEZING));
        context.register(ICE_SPIKE, new DamageType("goetied.indirectFreeze", 0.0F, DamageEffects.FREEZING));
        context.register(DRENCH, new DamageType("goetied.drench", 0.0F, DamageEffects.DROWNING));
        context.register(DIRECT_DRENCH, new DamageType("goetied.directDrench", 0.0F, DamageEffects.DROWNING));
        context.register(INDIRECT_DRENCH, new DamageType("goetied.indirectDrench", 0.0F, DamageEffects.DROWNING));
        context.register(SWORD, new DamageType("goetied.sword", 0.0F));
        context.register(WIND_BLAST, new DamageType("goetied.windBlast", 0.0F));
        context.register(ICE_BOUQUET, new DamageType("goetied.iceBouquet", 0.0F, DamageEffects.FREEZING));
        context.register(HELLFIRE, new DamageType("goetied.hellfire", 0.0F, DamageEffects.BURNING));
        context.register(INDIRECT_HELLFIRE, new DamageType("goetied.indirectHellfire", 0.0F, DamageEffects.BURNING));
        ...
        context.register(FIRE_BREATH, new DamageType("goetied.fireBreath", 0.0F, DamageEffects.BURNING));
        context.register(MAGIC_FIRE, new DamageType("goetied.fireBreath", 0.0F, DamageEffects.BURNING));
        context.register(FROST_BREATH, new DamageType("goetied.frostBreath", 0.0F, DamageEffects.FREEZING));
        context.register(BUBBLE_STREAM, new DamageType("goetied.bubbleStream", 0.0F, DamageEffects.DROWNING));
        context.register(MAGIC_BOLT, new DamageType("indirectMagic", 0.0F));
        context.register(ACID, new DamageType("goetied.acid", 0.0F));
        context.register(SOUL_LEECH, new DamageType("goetied.soulLeech", 0.0F));
        context.register(LIFE_LEECH, new DamageType("goetied.lifeLeech", 0.0F));
        context.register(SPIKE, new DamageType("goetied.spike", 0.0F, DamageEffects.POKING));
        context.register(BOILING, new DamageType("goetied.boiling", 0.0F, DamageEffects.BURNING));
        context.register(PHOBIA, new DamageType("goetied.phobia", 0.0F));
        context.register(CHOKE, new DamageType("goetied.choke", 0.0F));
        context.register(SWARM, new DamageType("goetied.swarm", 0.0F));
        context.register(VOIDED, new DamageType("goetied.voided", 0.0F));
        context.register(DISMISSED, new DamageType("goetied.dismissed", 0.0F));
        context.register(DOOM, new DamageType("goetied.doom", 0.0F));
        context.register(DEATH, new DamageType("goetied.death", 0.0F));
    }
