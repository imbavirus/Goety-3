...
import za.co.infernos.goetied.common.items.curios.MagicRobeItem;
...
public interface ISpell {
    ...
    default int SoulCalculation(LivingEntity caster){
        ...
        boolean enable = za.co.infernos.goetied.utils.ConfigHelper.getBoolean(SpellConfig.EnvironmentalCost, true);
    ...
    default MobEffectInstance summonDownEffect(LivingEntity caster){
        return caster.getEffect(GoetiedEffects.SUMMON_DOWN);
    }
