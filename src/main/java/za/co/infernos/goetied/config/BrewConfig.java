...
public class BrewConfig {
    ...
    public static final ModConfigSpec.ConfigValue<Integer> AbsorptionCost;
    public static final ModConfigSpec.ConfigValue<Integer> BlindnessCost;
    public static final ModConfigSpec.ConfigValue<Integer> DarknessCost;
    public static final ModConfigSpec.ConfigValue<Integer> FireResistanceCost;
    public static final ModConfigSpec.ConfigValue<Integer> GlowingCost;
    public static final ModConfigSpec.ConfigValue<Integer> HasteCost;
    public static final ModConfigSpec.ConfigValue<Integer> HungerCost;
    public static final ModConfigSpec.ConfigValue<Integer> HarmingCost;
    public static final ModConfigSpec.ConfigValue<Integer> HealingCost;
    public static final ModConfigSpec.ConfigValue<Integer> HealthBoostCost;
    public static final ModConfigSpec.ConfigValue<Integer> InvisibilityCost;
    public static final ModConfigSpec.ConfigValue<Integer> JumpBoostCost;
    public static final ModConfigSpec.ConfigValue<Integer> LevitationCost;
    public static final ModConfigSpec.ConfigValue<Integer> LuckCost;
    public static final ModConfigSpec.ConfigValue<Integer> MiningFatigueCost;
    public static final ModConfigSpec.ConfigValue<Integer> NauseaCost;
    public static final ModConfigSpec.ConfigValue<Integer> NightVisionCost;
    public static final ModConfigSpec.ConfigValue<Integer> PoisonCost;
    public static final ModConfigSpec.ConfigValue<Integer> RegenerationCost;
    public static final ModConfigSpec.ConfigValue<Integer> ResistanceCost;
    public static final ModConfigSpec.ConfigValue<Integer> SaturationCost;
    public static final ModConfigSpec.ConfigValue<Integer> SlowFallingCost;
    public static final ModConfigSpec.ConfigValue<Integer> SlownessCost;
    public static final ModConfigSpec.ConfigValue<Integer> SpeedCost;
    public static final ModConfigSpec.ConfigValue<Integer> StrengthCost;
    public static final ModConfigSpec.ConfigValue<Integer> UnluckCost;
    public static final ModConfigSpec.ConfigValue<Integer> WaterBreathingCost;
    public static final ModConfigSpec.ConfigValue<Integer> WeaknessCost;
    public static final ModConfigSpec.ConfigValue<Integer> WitherCost;

    public static final ModConfigSpec.ConfigValue<Integer> AbsorptionCapacity;
    public static final ModConfigSpec.ConfigValue<Integer> HarmingCapacity;
    public static final ModConfigSpec.ConfigValue<Integer> HealingCapacity;
    public static final ModConfigSpec.ConfigValue<Integer> HealthBoostCapacity;
    public static final ModConfigSpec.ConfigValue<Integer> LevitationCapacity;
    public static final ModConfigSpec.ConfigValue<Integer> ResistanceCapacity;
    public static final ModConfigSpec.ConfigValue<Integer> WitherCapacity;

    public static final ModConfigSpec.ConfigValue<Integer> ClimbingCost;
    public static final ModConfigSpec.ConfigValue<Integer> CorpseEaterCost;
    public static final ModConfigSpec.ConfigValue<Integer> PressureCost;
    public static final ModConfigSpec.ConfigValue<Integer> EnderGroundCost;
    public static final ModConfigSpec.ConfigValue<Integer> EnderFluxCost;
    public static final ModConfigSpec.ConfigValue<Integer> FlameHandsCost;
    public static final ModConfigSpec.ConfigValue<Integer> VenomousHandsCost;
    public static final ModConfigSpec.ConfigValue<Integer> VoidTouchedCost;
    public static final ModConfigSpec.ConfigValue<Integer> FreezingCost;
    public static final ModConfigSpec.ConfigValue<Integer> GoldTouchedCost;
    public static final ModConfigSpec.ConfigValue<Integer> GravityPulseCost;
    public static final ModConfigSpec.ConfigValue<Integer> NyctophobiaCost;
    public static final ModConfigSpec.ConfigValue<Integer> SnowSkinCost;
    public static final ModConfigSpec.ConfigValue<Integer> SappedCost;
    public static final ModConfigSpec.ConfigValue<Integer> StormsWrathCost;
    public static final ModConfigSpec.ConfigValue<Integer> SunAllergyCost;
    public static final ModConfigSpec.ConfigValue<Integer> EvilEyeCost;
    public static final ModConfigSpec.ConfigValue<Integer> TrippingCost;
    public static final ModConfigSpec.ConfigValue<Integer> RepulsiveCost;
    public static final ModConfigSpec.ConfigValue<Integer> PhotosynthesisCost;
    public static final ModConfigSpec.ConfigValue<Integer> SwiftSwimCost;
    public static final ModConfigSpec.ConfigValue<Integer> SwirlingCost;
    public static final ModConfigSpec.ConfigValue<Integer> ArrowmanticCost;
    public static final ModConfigSpec.ConfigValue<Integer> BottlingCost;
    public static final ModConfigSpec.ConfigValue<Integer> FlammableCost;
    public static final ModConfigSpec.ConfigValue<Integer> FlimsyCost;
    public static final ModConfigSpec.ConfigValue<Integer> FortunateCost;
    public static final ModConfigSpec.ConfigValue<Integer> InsightCost;
    public static final ModConfigSpec.ConfigValue<Integer> LeechingCost;
    public static final ModConfigSpec.ConfigValue<Integer> RallyingCost;
    public static final ModConfigSpec.ConfigValue<Integer> RadianceCost;
    public static final ModConfigSpec.ConfigValue<Integer> ExplosiveCost;
    public static final ModConfigSpec.ConfigValue<Integer> FieryAuraCost;
    public static final ModConfigSpec.ConfigValue<Integer> FrostyAuraCost;
    public static final ModConfigSpec.ConfigValue<Integer> WildRageCost;
    public static final ModConfigSpec.ConfigValue<Integer> FireTrailCost;
    public static final ModConfigSpec.ConfigValue<Integer> PlungeCost;
    public static final ModConfigSpec.ConfigValue<Integer> CursedCost;
    ...
    public static final ModConfigSpec.ConfigValue<Integer> CursedCapacity;
    public static final ModConfigSpec.ConfigValue<Integer> DeflectiveCapacity;
    public static final ModConfigSpec.ConfigValue<Integer> EvilEyeCapacity;
    public static final ModConfigSpec.ConfigValue<Integer> ExplosiveCapacity;
    public static final ModConfigSpec.ConfigValue<Integer> FieryAuraCapacity;
    public static final ModConfigSpec.ConfigValue<Integer> FireTrailCapacity;
    public static final ModConfigSpec.ConfigValue<Integer> FortunateCapacity;
    public static final ModConfigSpec.ConfigValue<Integer> FrostyAuraCapacity;
    public static final ModConfigSpec.ConfigValue<Integer> GravityPulseCapacity;
    public static final ModConfigSpec.ConfigValue<Integer> NyctophobiaCapacity;
    public static final ModConfigSpec.ConfigValue<Integer> PlungeCapacity;
    public static final ModConfigSpec.ConfigValue<Integer> RadianceCapacity;
    ...
    public static final ModConfigSpec.ConfigValue<Integer> SwirlingCapacity;
    ...
    public static final ModConfigSpec.ConfigValue<Integer> CombustCost;
    public static final ModConfigSpec.ConfigValue<Integer> CorrosionCost;
    public static final ModConfigSpec.ConfigValue<Integer> DroughtCost;
    public static final ModConfigSpec.ConfigValue<Integer> ExplodeCost;
    public static final ModConfigSpec.ConfigValue<Integer> ExtinguishCost;
    public static final ModConfigSpec.ConfigValue<Integer> FertilityCost;
    public static final ModConfigSpec.ConfigValue<Integer> FlayingCost;
    public static final ModConfigSpec.ConfigValue<Integer> FloodingCost;
    public static final ModConfigSpec.ConfigValue<Integer> FreezeCost;
    public static final ModConfigSpec.ConfigValue<Integer> GrowthCost;
    public static final ModConfigSpec.ConfigValue<Integer> GrowCactusCost;
    public static final ModConfigSpec.ConfigValue<Integer> GrowCaveVinesCost;
    public static final ModConfigSpec.ConfigValue<Integer> GrowTreeCost;
    public static final ModConfigSpec.ConfigValue<Integer> HarvestCost;
    public static final ModConfigSpec.ConfigValue<Integer> InfestCost;
    public static final ModConfigSpec.ConfigValue<Integer> LaunchCost;
    public static final ModConfigSpec.ConfigValue<Integer> LeafShellCost;
    public static final ModConfigSpec.ConfigValue<Integer> LoveCost;
    public static final ModConfigSpec.ConfigValue<Integer> MossifyCost;
    public static final ModConfigSpec.ConfigValue<Integer> PartLavaCost;
    public static final ModConfigSpec.ConfigValue<Integer> PartWaterCost;
    public static final ModConfigSpec.ConfigValue<Integer> PulverizeCost;
    public static final ModConfigSpec.ConfigValue<Integer> PurifyDebuffsCost;
    public static final ModConfigSpec.ConfigValue<Integer> PurifyBuffsCost;
    public static final ModConfigSpec.ConfigValue<Integer> PruningCost;
    public static final ModConfigSpec.ConfigValue<Integer> RaiseDeadCost;
    public static final ModConfigSpec.ConfigValue<Integer> ShearCost;
    public static final ModConfigSpec.ConfigValue<Integer> SnowyCost;
    public static final ModConfigSpec.ConfigValue<Integer> StripArmorCost;
    public static final ModConfigSpec.ConfigValue<Integer> SweetThornsCost;
    public static final ModConfigSpec.ConfigValue<Integer> ThornTrapCost;
    public static final ModConfigSpec.ConfigValue<Integer> TransposeCost;
    public static final ModConfigSpec.ConfigValue<Integer> WebbedCost;

    public static final ModConfigSpec.ConfigValue<Integer> BatBurstCapacity;
    public static final ModConfigSpec.ConfigValue<Integer> BeesCapacity;
    public static final ModConfigSpec.ConfigValue<Integer> CombustCapacity;
    public static final ModConfigSpec.ConfigValue<Integer> ExplodeCapacity;
    public static final ModConfigSpec.ConfigValue<Integer> FloodingCapacity;
    public static final ModConfigSpec.ConfigValue<Integer> PurifyDebuffsCapacity;
    public static final ModConfigSpec.ConfigValue<Integer> PurifyBuffsCapacity;
    public static final ModConfigSpec.ConfigValue<Integer> RaiseDeadCapacity;
    public static final ModConfigSpec.ConfigValue<Integer> StripArmorCapacity;
    public static final ModConfigSpec.ConfigValue<Integer> WebbedCapacity;

    public static final ModConfigSpec.ConfigValue<Integer> BottlingLevelReq;
    public static final ModConfigSpec.ConfigValue<Integer> MaxBottlingLevel;

    public static final ModConfigSpec.ConfigValue<Boolean> PressureCurable;
    public static final ModConfigSpec.ConfigValue<Boolean> NyctophobiaCurable;
    public static final ModConfigSpec.ConfigValue<Boolean> SunAllergyCurable;
    public static final ModConfigSpec.ConfigValue<Boolean> SnowSkinCurable;
    public static final ModConfigSpec.ConfigValue<Boolean> EvilEyeCurable;
