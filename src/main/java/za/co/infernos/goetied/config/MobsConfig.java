...
public class MobsConfig {
    ...
    static {
        ...
        CompatMinionHeal = BUILDER.comment("Whether mobs owned by player outside of Goetied Servants can heal while wearing appropriate robes, Default: true")
                .define("compatMinionHeal", true);
        CompatNightmareStalker = BUILDER.comment("Whether Nightmare Stalker from Born In Chaos mod no longer gain massive buffs when fighting certain Goetied mobs, Default: true")
        ...
        BUILDER.push("Illagers");
            ...
            RaidAugmentDebug = BUILDER.comment("Logs Goetied raid augmentation counts per wave to the console for debugging, Default: false")
