...
import za.co.infernos.goetied.client.render.model.HellChantModel;
...
public class HellChantRenderer<T extends HellChant> extends EntityRenderer<T> {
    private static final ResourceLocation TEXTURE = Goetied.location("textures/entity/projectiles/hell_chant.png");
    ...
    public void render(T scream, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
        ...
        poseStack.mulPose(Axis.YP.rotationDegrees(scream.getYRot()));
