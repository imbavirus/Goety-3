...
import za.co.infernos.goetied.client.render.model.SkullLordModel;
...
public class SkullLordRenderer extends MobRenderer<SkullLord, SkullLordModel<SkullLord>> {
    public static final ResourceLocation CONNECTION = Goetied.location("textures/entity/skull_lord/skull_lord_connection.png");
    private static final ResourceLocation LOCATION = Goetied.location("textures/entity/skull_lord/skull_lord.png");
    private static final ResourceLocation VULNERABLE = Goetied.location("textures/entity/skull_lord/skull_lord_vulnerable.png");
    private static final ResourceLocation CHARGE = Goetied.location("textures/entity/skull_lord/skull_lord_charging.png");
