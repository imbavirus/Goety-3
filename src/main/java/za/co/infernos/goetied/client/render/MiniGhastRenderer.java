...
import za.co.infernos.goetied.client.render.model.MiniGhastModel;
...
public class MiniGhastRenderer extends MobRenderer<MiniGhast, MiniGhastModel<MiniGhast>> {
    private static final ResourceLocation GHAST_LOCATION = Goetied.location("textures/entity/servants/mini_ghast.png");
    private static final ResourceLocation GHAST_SHOOTING_LOCATION = Goetied.location("textures/entity/servants/mini_ghast_shooting.png");
