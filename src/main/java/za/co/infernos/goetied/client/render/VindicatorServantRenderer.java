...
import za.co.infernos.goetied.client.render.model.IllagerServantModel;
...
public class VindicatorServantRenderer<T extends VindicatorServant> extends MobRenderer<T, IllagerServantModel<T>> {
    protected static final ResourceLocation TEXTURE = Goetied.location("textures/entity/servants/illager/vindicator.png");
    protected static final ResourceLocation ORIGINAL = Goetied.location("textures/entity/illager/vindicator.png");
