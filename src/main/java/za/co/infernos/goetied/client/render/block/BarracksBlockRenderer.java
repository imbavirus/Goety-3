...
import za.co.infernos.goetied.common.blocks.entities.BarracksBlockEntity;
...
public class BarracksBlockRenderer<T extends BarracksBlockEntity> implements BlockEntityRenderer<T> {
    public BarracksBlockRenderer(BlockEntityRendererProvider.Context p_i226007_1_) {
    }
