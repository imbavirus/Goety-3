...
public class DarkRobeModel extends HumanoidModel<LivingEntity> {
    ...
    public void setupAnim(LivingEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch){
        ...
        this.head.visible = za.co.infernos.goetied.utils.ConfigHelper.getBoolean(ItemConfig.ShowRobeHoods, false) && CuriosFinder.noHeadWear(entityIn) && entityIn.getItemBySlot(EquipmentSlot.HEAD).isEmpty();
    }
