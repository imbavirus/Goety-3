...
import za.co.infernos.goetied.client.render.layer.ZPiglinBandsLayer;
import za.co.infernos.goetied.client.render.model.ZPiglinModel;
...
public class ZPiglinRenderer extends HumanoidMobRenderer<ZPiglinServant, ZPiglinModel<ZPiglinServant>> {
    protected static final ResourceLocation TEXTURE = Goetied.location("textures/entity/servants/zombie/zpiglin_servant.png");
    protected static final ResourceLocation TEXTURE2 = Goetied.location("textures/entity/servants/zombie/zpiglin_brute_servant.png");
