...
public class WartlingRenderer<T extends Wartling> extends MobRenderer<T, SpiderModel<T>> {
    protected static final ResourceLocation TEXTURE = Goetied.location("textures/entity/cultist/wartling.png");
    protected static final ResourceLocation TEXTURE_MEGA = Goetied.location("textures/entity/cultist/wartling_mega.png");
