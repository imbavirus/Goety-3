...
import za.co.infernos.goetied.client.render.model.MinisterModel;
import za.co.infernos.goetied.common.entities.hostile.illagers.Minister;
...
public class MinisterRenderer<T extends Minister> extends MobRenderer<T, MinisterModel<T>> {
    private static final ResourceLocation CHRISTMAS = Goetied.location("textures/entity/illagers/minister/minister_christmas.png");
    ...
    public ResourceLocation getTextureLocation(T entity) {
        if (HolidayUtil.isChristmasMonth() && za.co.infernos.goetied.utils.ConfigHelper.getBoolean(MobsConfig.HolidaySkins, false)){
            return CHRISTMAS;
        }
