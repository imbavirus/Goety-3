...
import za.co.infernos.goetied.client.render.model.TramplerModel;
import za.co.infernos.goetied.common.entities.hostile.illagers.Trampler;
...
public class TramplerRenderer extends MobRenderer<Trampler, TramplerModel<Trampler>> {
    private static final ResourceLocation TEXTURE = Goetied.location("textures/entity/illagers/trampler/trampler.png");
    ...
    public static class TramplerArmorLayer<T extends Trampler> extends RenderLayer<T, TramplerModel<T>> {
        ...
        public void render(PoseStack p_117032_, MultiBufferSource p_117033_, int p_117034_, T p_117035_,
                float p_117036_, float p_117037_, float p_117038_, float p_117039_, float p_117040_, float p_117041_) {
            ...
            if (itemstack.getItem() instanceof TramplerArmorItem armorItem) {
                ...
                VertexConsumer vertexconsumer = p_117033_
                        .getBuffer(RenderType.entityCutoutNoCull(armorItem.getTexture()));
                this.model.renderToBuffer(p_117032_, vertexconsumer, p_117034_, OverlayTexture.NO_OVERLAY, -1);
            }
        }
    }
}