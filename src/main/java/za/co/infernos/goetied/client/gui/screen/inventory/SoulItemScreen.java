...
import za.co.infernos.goetied.client.inventory.container.SoulItemContainer;
...
public class SoulItemScreen extends AbstractContainerScreen<SoulItemContainer> {
    private static final ResourceLocation GUI_TEXTURES = ResourceLocation.fromNamespaceAndPath(Goetied.MOD_ID, "textures/gui/container/wand.png");
