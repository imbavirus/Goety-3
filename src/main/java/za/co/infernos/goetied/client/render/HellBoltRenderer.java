...
public class HellBoltRenderer extends EntityRenderer<HellBolt> {
   private final SoulBoltModel<HellBolt> model;

   public HellBoltRenderer(EntityRendererProvider.Context p_174449_) {
      super(p_174449_);
      this.model = new SoulBoltModel<>(p_174449_.bakeLayer(ModModelLayer.SOUL_BOLT));
   }

   protected int getBlockLightLevel(HellBolt p_116491_, BlockPos p_116492_) {
      return 15;
   }

   public void render(HellBolt p_116484_, float p_116485_, float p_116486_, PoseStack p_116487_, MultiBufferSource p_116488_, int p_116489_) {
      p_116487_.pushPose();
   ...
   public ResourceLocation getTextureLocation(HellBolt p_116482_) {
