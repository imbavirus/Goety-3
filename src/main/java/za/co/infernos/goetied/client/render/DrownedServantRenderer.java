...
import za.co.infernos.goetied.client.render.layer.DrownedServantOuterLayer;
...
public class DrownedServantRenderer extends AbstractZombieServantRenderer<DrownedServant, DrownedServantModel<DrownedServant>> {
   protected static final ResourceLocation TEXTURE = Goetied.location("textures/entity/servants/zombie/drowned_servant.png");
   ...
   public ResourceLocation getTextureLocation(DrownedServant p_114115_) {
      if (p_114115_.isHostile() || !za.co.infernos.goetied.utils.ConfigHelper.getBoolean(MobsConfig.DrownedServantTexture, false)){
