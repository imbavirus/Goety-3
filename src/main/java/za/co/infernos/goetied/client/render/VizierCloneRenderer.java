...
import za.co.infernos.goetied.client.render.model.VizierCloneModel;
...
public class VizierCloneRenderer extends MobRenderer<VizierClone, VizierCloneModel> {
    protected static final ResourceLocation TEXTURE = Goetied.location("textures/entity/illagers/vizier_clone.png");
