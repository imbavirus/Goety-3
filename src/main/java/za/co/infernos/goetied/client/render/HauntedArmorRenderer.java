...
import za.co.infernos.goetied.client.render.model.HauntedArmorModel;
...
public class HauntedArmorRenderer extends HumanoidMobRenderer<AbstractHauntedArmor, HauntedArmorModel> {
    private static final ResourceLocation ZOMBIE_LOCATION = ResourceLocation.fromNamespaceAndPath(Goetied.MOD_ID, "textures/entity/haunted_armor.png");
