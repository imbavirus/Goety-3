...
import za.co.infernos.goetied.client.render.model.VanguardModel;
...
public class VanguardRenderer<T extends VanguardServant> extends MobRenderer<T, VanguardModel<T>> {
   private static final ResourceLocation TEXTURE = Goetied.location("textures/entity/servants/skeleton/vanguard.png");
   private static final ResourceLocation TEXTURE_2 = Goetied.location("textures/entity/servants/skeleton/vanguard_original.png");
   ...
   public ResourceLocation getTextureLocation(T p_116410_) {
      if (!za.co.infernos.goetied.utils.ConfigHelper.getBoolean(MobsConfig.VanguardServantTexture, false)){
         return TEXTURE_2;
      }
      return TEXTURE;
   }
