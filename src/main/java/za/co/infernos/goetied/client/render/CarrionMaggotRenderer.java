...
import za.co.infernos.goetied.client.render.model.CarrionMaggotModel;
...
public class CarrionMaggotRenderer extends MobRenderer<CarrionMaggot, CarrionMaggotModel<CarrionMaggot>> {
   private static final ResourceLocation TEXTURES = Goetied.location("textures/entity/wight/carrion_maggot.png");
   private static final ResourceLocation COCOON = Goetied.location("textures/entity/wight/carrion_maggot_cocoon.png");
