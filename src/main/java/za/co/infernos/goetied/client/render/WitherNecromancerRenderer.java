...
import za.co.infernos.goetied.client.render.model.WitherNecromancerModel;
import za.co.infernos.goetied.common.entities.neutral.AbstractWitherNecromancer;
...
public class WitherNecromancerRenderer extends MobRenderer<AbstractWitherNecromancer, WitherNecromancerModel<AbstractWitherNecromancer>> {
   private static final ResourceLocation SKELETON_LOCATION = Goetied.location("textures/entity/necromancer/wither_necromancer.png");
   private static final ResourceLocation SERVANT_LOCATION = Goetied.location("textures/entity/necromancer/wither_necromancer_servant.png");
   ...
   public ResourceLocation getTextureLocation(AbstractWitherNecromancer p_115941_) {
      if (p_115941_.isHostile() || !za.co.infernos.goetied.utils.ConfigHelper.getBoolean(MobsConfig.NecromancerServantTexture, false)){
   ...
   public static class NecromancerEyesLayer<T extends AbstractWitherNecromancer, M extends WitherNecromancerModel<T>> extends EyesLayer<T, M> {
      private static final ResourceLocation GLOW = Goetied.location("textures/entity/necromancer/wither_necromancer_glow.png");
