...
import za.co.infernos.goetied.client.render.model.SnapperModel;
...
public class SnapperRenderer extends MobRenderer<Snapper, SnapperModel<Snapper>> {
    protected static final ResourceLocation TEXTURE = Goetied.location("textures/entity/servants/snapper/snapper.png");
    ...
    public static class SnapperEyesLayer<T extends Mob, M extends SnapperModel<T>> extends EyesLayer<T, M> {
        private static final RenderType EYES = RenderType.eyes(Goetied.location("textures/entity/servants/snapper/snapper_eyes.png"));
