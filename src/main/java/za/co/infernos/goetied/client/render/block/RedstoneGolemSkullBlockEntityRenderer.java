package za.co.infernos.goetied.client.render.block;

import za.co.infernos.goetied.Goetied;
import za.co.infernos.goetied.client.render.model.RedstoneGolemSkullModel;
import za.co.infernos.goetied.common.blocks.RedstoneGolemSkullBlock;
import za.co.infernos.goetied.common.blocks.WallRedstoneGolemSkullBlock;
import za.co.infernos.goetied.common.blocks.entities.RedstoneGolemSkullBlockEntity;
...
public class RedstoneGolemSkullBlockEntityRenderer implements BlockEntityRenderer<RedstoneGolemSkullBlockEntity> {
    protected static final ResourceLocation TEXTURE = Goetied.location("textures/entity/servants/redstone_golem/redstone_golem_skull.png");

    public RedstoneGolemSkullBlockEntityRenderer(BlockEntityRendererProvider.Context p_i226015_1_) {
    }

    public void render(RedstoneGolemSkullBlockEntity pBlockEntity, float pPartialTicks, PoseStack pMatrixStack, MultiBufferSource pBuffer, int pCombinedLight, int pCombinedOverlay) {
        BlockState blockstate = pBlockEntity.getBlockState();
        boolean flag = blockstate.getBlock() instanceof WallRedstoneGolemSkullBlock;
        Direction direction = flag ? blockstate.getValue(WallRedstoneGolemSkullBlock.FACING) : null;
        float f1 = 22.5F * (float)(flag ? (2 + direction.get2DDataValue()) * 4 : blockstate.getValue(RedstoneGolemSkullBlock.ROTATION));
