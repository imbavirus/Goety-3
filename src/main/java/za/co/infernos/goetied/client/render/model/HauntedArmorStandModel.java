...
public class HauntedArmorStandModel<T extends ArmorStand> extends HauntedArmorStandArmorModel<T> {
   ...
   public HauntedArmorStandModel(ModelPart p_170356_) {
      super(p_170356_);
   ...
   public void prepareMobModel(T p_102172_, float p_102173_, float p_102174_, float p_102175_) {
   ...
   public void setupAnim(T p_102177_, float p_102178_, float p_102179_, float p_102180_, float p_102181_, float p_102182_) {
