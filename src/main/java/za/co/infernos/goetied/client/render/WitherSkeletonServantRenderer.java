...
public class WitherSkeletonServantRenderer extends HumanoidMobRenderer<AbstractSkeletonServant, SkeletonModel<AbstractSkeletonServant>> {
   private static final ResourceLocation TEXTURES = Goetied.location("textures/entity/servants/skeleton/wither_skeleton_servant.png");
   ...
   public ResourceLocation getTextureLocation(AbstractSkeletonServant servant) {
      if (servant.isHostile() || !za.co.infernos.goetied.utils.ConfigHelper.getBoolean(MobsConfig.WitherSkeletonServantTexture, false)){
