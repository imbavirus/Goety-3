...
import za.co.infernos.goetied.client.render.model.ReaperModel;
...
public class ReaperRenderer<T extends AbstractReaper> extends MobRenderer<T, ReaperModel<T>> {
    protected static final ResourceLocation TEXTURE = Goetied.location("textures/entity/specter/reaper.png");
    ...
    public static class ReaperGlowLayer<T extends AbstractReaper, M extends ReaperModel<T>> extends EyesLayer<T, M> {
        private static final RenderType RENDER_TYPE = ModRenderType.wraith(Goetied.location("textures/entity/specter/reaper_glow.png"));
    ...
    public static class ReaperBandsLayer<T extends AbstractReaper> extends RenderLayer<T, ReaperModel<T>> {
        private static final ResourceLocation TEXTURES = Goetied.location("textures/entity/specter/reaper_servant_bands.png");
        ...
        public void render(PoseStack matrixStackIn, MultiBufferSource bufferIn, int packedLightIn, T wraith, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch) {
            if (za.co.infernos.goetied.utils.ConfigHelper.getBoolean(MobsConfig.ReaperServantTexture, false) && !wraith.isHostile()) {
