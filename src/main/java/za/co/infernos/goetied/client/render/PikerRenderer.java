...
import za.co.infernos.goetied.common.entities.hostile.illagers.Piker;
...
public class PikerRenderer<T extends Piker> extends MobRenderer<T, PikerModel<T>> {
    protected static final ResourceLocation TEXTURE = ResourceLocation.parse(Goetied.MOD_ID + ":textures/entity/illagers/piker.png");
