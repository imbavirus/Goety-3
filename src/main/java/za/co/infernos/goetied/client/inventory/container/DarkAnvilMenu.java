package za.co.infernos.goetied.client.inventory.container;

import za.co.infernos.goetied.common.blocks.DarkAnvilBlock;
...
public class DarkAnvilMenu extends AnvilMenu {
    ...
    protected void onTake(Player p_150474_, ItemStack p_150475_) {
        if (!p_150474_.getAbilities().instabuild) {
            if (za.co.infernos.goetied.utils.ConfigHelper.getBoolean(MainConfig.DarkAnvilTakePoints, false)) {
    ...
    public void createResult() {
        ...
        if (itemstack.isEmpty()) {
                ...
                if (itemstack1.isDamageableItem() && itemstack1.getItem().isValidRepairItem(itemstack, itemstack2)) {
                    ...
                    for (it.unimi.dsi.fastutil.objects.Object2IntMap.Entry<Holder<Enchantment>> entry : map1
                        ...
                        if (!flag1) {
                            ...
                            flag2 = true;
                            if (!za.co.infernos.goetied.utils.ConfigHelper.getBoolean(MainConfig.DarkAnvilIgnoreMaxLevels, false) && j2 > enchantment1.value().getMaxLevel()) {
                            ...
                            if (itemstack.getCount() > 1) {
                                i = za.co.infernos.goetied.utils.ConfigHelper.getInt(MainConfig.DarkAnvilRepairCost, 0);
                            }
                        }
                    }
            ...
            if (this.cost.get() > za.co.infernos.goetied.utils.ConfigHelper.getInt(MainConfig.DarkAnvilRepairCost, 0)) {
                this.cost.set(za.co.infernos.goetied.utils.ConfigHelper.getInt(MainConfig.DarkAnvilRepairCost, 0));
            }
            ...
            if (za.co.infernos.goetied.utils.ConfigHelper.getBoolean(MainConfig.DarkAnvilCap, false) && this.cost.get() >= za.co.infernos.goetied.utils.ConfigHelper.getInt(MainConfig.DarkAnvilRepairCost, 0)
