...
public class BlockRenderType extends RenderType {
    ...
    public final static ResourceLocation BEAM = Goetied.location("textures/particle/block_beam.png");
    public static final RenderType LASER_MAIN_BEAM = create(Goetied.MOD_ID + "block_beam",
     ...
     */
    public static final RenderType FAKE_BLOCK = create(Goetied.MOD_ID + ":fakeblock",
     ...
     */
    public static final RenderType TRANSPARENT_COLOUR = create(Goetied.MOD_ID + ":transparent_colour",
     ...
     */
    public static final RenderType SOLID_COLOUR = create(Goetied.MOD_ID + ":solidcolour",
     ...
     */
    public static final RenderType TOMB_LINES = create(Goetied.MOD_ID + ":tomb_lines",
