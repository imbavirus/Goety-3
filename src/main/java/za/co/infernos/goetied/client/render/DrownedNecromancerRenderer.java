...
import za.co.infernos.goetied.client.render.model.DrownedNecromancerModel;
...
public class DrownedNecromancerRenderer extends MobRenderer<DrownedNecromancer, DrownedNecromancerModel<DrownedNecromancer>> {
   private static final ResourceLocation SKELETON_LOCATION = Goetied.location("textures/entity/necromancer/drowned_necromancer.png");
   private static final ResourceLocation SERVANT_LOCATION = Goetied.location("textures/entity/necromancer/drowned_necromancer_servant.png");
   ...
   public static class NecromancerEyesLayer<T extends DrownedNecromancer, M extends DrownedNecromancerModel<T>> extends EyesLayer<T, M> {
      private static final ResourceLocation GLOW = Goetied.location("textures/entity/necromancer/drowned_necromancer_glow.png");
