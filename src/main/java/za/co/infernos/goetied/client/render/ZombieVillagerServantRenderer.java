...
import za.co.infernos.goetied.client.render.model.ZombieVillagerServantModel;
...
public class ZombieVillagerServantRenderer extends HumanoidMobRenderer<ZombieVillagerServant, ZombieVillagerServantModel<ZombieVillagerServant>> {
   private static final ResourceLocation ZOMBIE_VILLAGER_LOCATION = Goetied.location("textures/entity/servants/zombie/zombie_villager_servant.png");
