...
import za.co.infernos.goetied.client.render.model.VillagerServantModel;
...
public class ZombieVindicatorRenderer extends HumanoidMobRenderer<AbstractZombieVindicator, VillagerServantModel<AbstractZombieVindicator>> {
    protected static final ResourceLocation TEXTURE = Goetied.location("textures/entity/servants/zombie/zombie_vindicator.png");
    protected static final ResourceLocation HOSTILE = Goetied.location("textures/entity/servants/zombie/zombie_vindicator_hostile.png");
