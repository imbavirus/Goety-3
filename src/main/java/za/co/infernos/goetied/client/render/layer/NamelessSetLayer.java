...
import za.co.infernos.goetied.client.render.model.NecroCapeModel;
...
public class NamelessSetLayer<T extends Doppelganger> extends RenderLayer<T, PlayerModel<T>> {
    private static final ResourceLocation TEXTURES = Goetied.location("textures/models/curios/nameless_cape.png");
