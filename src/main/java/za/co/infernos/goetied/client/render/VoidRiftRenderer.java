...
import za.co.infernos.goetied.common.entities.util.VoidRift;
...
public class VoidRiftRenderer extends EntityRenderer<VoidRift> {
   public VoidRiftRenderer(EntityRendererProvider.Context p_173962_) {
      super(p_173962_);
   }

   protected int getBlockLightLevel(VoidRift p_114087_, BlockPos p_114088_) {
      return 15;
   }

   public void render(VoidRift voidRift, float p_114081_, float p_114082_, PoseStack p_114083_, MultiBufferSource p_114084_, int p_114085_) {
      p_114083_.pushPose();
      ...
      VertexConsumer vertexconsumer = p_114084_.getBuffer(RenderType.entityCutoutNoCull(voidRift.getResourceLocation()));
      ...
      p_114083_.popPose();
      super.render(voidRift, p_114081_, p_114082_, p_114083_, p_114084_, p_114085_);
   }
   ...
   private static void vertex(VertexConsumer p_254095_, Matrix4f p_254477_, Matrix3f p_253948_, int p_253829_, float p_253995_, int p_254031_, int p_253641_, int p_254243_) {
      p_254095_.addVertex(p_254477_, p_253995_ - 0.5F, (float)p_254031_ - 0.25F, 0.0F).setColor(255, 255, 255, 255).setUv((float)p_253641_, (float)p_254243_).setOverlay(OverlayTexture.NO_OVERLAY).setLight(p_253829_).setNormal(0.0F, 1.0F, 0.0F);
   }

   public ResourceLocation getTextureLocation(VoidRift voidRift) {
