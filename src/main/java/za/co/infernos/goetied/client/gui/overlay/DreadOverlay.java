...
public class DreadOverlay {
    ...
    public static final ResourceLocation LAYER_ID = Goetied.location("static_overlay");
        ...
        if (minecraft.player != null){
            ...
            if (wight != null) {
                ...
                overlay = switch (frame) {
                    default -> Goetied.location("textures/gui/dread/dread_overlay_0.png");
                    case 4, 5, 6, 7 -> Goetied.location("textures/gui/dread/dread_overlay_1.png");
                    case 8, 9, 10, 11 -> Goetied.location("textures/gui/dread/dread_overlay_2.png");
                    case 12, 13, 14, 15 -> Goetied.location("textures/gui/dread/dread_overlay_3.png");
                };
