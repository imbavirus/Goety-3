...
import za.co.infernos.goetied.common.entities.util.SummonApostle;
...
public class SummonApostleRenderer extends EntityRenderer<SummonApostle> {
    public static final ResourceLocation TEXTURE = Goetied.location("textures/entity/cultist/summon_apostle.png");
    public static final ResourceLocation RING = Goetied.location("textures/entity/cultist/summon_apostle_ring.png");
