...
public class BlackWolfRenderer extends MobRenderer<BlackWolf, BlackWolfModel<BlackWolf>> {
    private static final ResourceLocation TEXTURES = Goetied.location("textures/entity/servants/black_wolf/black_wolf.png");
    private static final ResourceLocation HOSTILE = Goetied.location("textures/entity/servants/black_wolf/black_wolf_hostile.png");
    ...
    public static class ChainsLayer<T extends BlackWolf, M extends BlackWolfModel<T>> extends RenderLayer<T, M> {
        private static final ResourceLocation TEXTURES = Goetied.location("textures/entity/servants/black_wolf/black_wolf_chains.png");
    ...
    public static class BigFurLayer<T extends BlackWolf, M extends BlackWolfModel<T>> extends RenderLayer<T, M> {
        private static final ResourceLocation TEXTURES = Goetied.location("textures/entity/servants/black_wolf/black_wolf_fur.png");
        private static final ResourceLocation HOSTILE = Goetied.location("textures/entity/servants/black_wolf/black_wolf_fur_hostile.png");
    ...
    public static class WolfEyesLayer<T extends BlackWolf, M extends BlackWolfModel<T>> extends EyesLayer<T, M> {
        private static final ResourceLocation TEXTURES = Goetied.location("textures/entity/servants/black_wolf/black_wolf_eyes.png");
