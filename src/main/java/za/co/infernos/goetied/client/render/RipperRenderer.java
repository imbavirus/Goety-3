...
import za.co.infernos.goetied.client.render.model.RipperModel;
...
public class RipperRenderer extends MobRenderer<Ripper, RipperModel<Ripper>> {
    private static final ResourceLocation TEXTURES = Goetied.location("textures/entity/illagers/ripper.png");
