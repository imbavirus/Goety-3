...
import za.co.infernos.goetied.client.render.model.IceChunkModel;
import za.co.infernos.goetied.common.entities.projectiles.IceChunk;
...
public class IceChunkRenderer extends EntityRenderer<IceChunk> {
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(Goetied.MOD_ID,
            "textures/entity/projectiles/ice_chunk.png");
    private static final ResourceLocation SPAWN = ResourceLocation.fromNamespaceAndPath(Goetied.MOD_ID,
