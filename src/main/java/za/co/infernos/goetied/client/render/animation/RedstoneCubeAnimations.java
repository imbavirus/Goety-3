...
public class RedstoneCubeAnimations {
	public static final AnimationDefinition IDLE = AnimationDefinition.Builder.withLength(3.9167F).looping()
		.addAnimation("bone", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			...
			new Keyframe(1.8333F, KeyframeAnimations.degreeVec(2.5385F, -9.9904F, -0.4407F), AnimationChannel.Interpolations.CATMULLROM),
			new Keyframe(2.5F, KeyframeAnimations.degreeVec(2.5385F, -9.9904F, -0.4407F), AnimationChannel.Interpolations.CATMULLROM),
	...
	public static final AnimationDefinition WALK = AnimationDefinition.Builder.withLength(2.0F).looping()
		.addAnimation("bone", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			...
			new Keyframe(1.4583F, KeyframeAnimations.degreeVec(270.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
			new Keyframe(1.5F, KeyframeAnimations.degreeVec(270.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
			new Keyframe(1.9583F, KeyframeAnimations.degreeVec(360.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
	...
	public static final AnimationDefinition ATTACK = AnimationDefinition.Builder.withLength(1.0F)
		...
		.addAnimation("bone", new AnimationChannel(AnimationChannel.Targets.POSITION, 
			...
			new Keyframe(0.4167F, KeyframeAnimations.posVec(0.0F, 6.0F, -6.0F), AnimationChannel.Interpolations.CATMULLROM),
