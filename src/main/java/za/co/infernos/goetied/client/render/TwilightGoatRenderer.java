...
import za.co.infernos.goetied.client.render.model.TwilightGoatModel;
...
public class TwilightGoatRenderer extends MobRenderer<TwilightGoat, TwilightGoatModel<TwilightGoat>> {
   private static final ResourceLocation GOAT_LOCATION = Goetied.location("textures/entity/servants/twilight_goat/twilight_goat.png");
