...
import za.co.infernos.goetied.client.render.model.ModGhastModel;
...
public class MalghastRenderer extends MobRenderer<Malghast, ModGhastModel<Malghast>> {
    private static final ResourceLocation GHAST_LOCATION = Goetied.location("textures/entity/malghast/malghast.png");
    private static final ResourceLocation GHAST_SHOOTING_LOCATION = Goetied.location("textures/entity/malghast/malghast_shooting.png");
    private static final ResourceLocation GHAST_SCREAMING_LOCATION = Goetied.location("textures/entity/malghast/malghast_scream.png");
