...
import za.co.infernos.goetied.client.render.model.ShieldDebrisModel;
...
public class ShieldDebrisRenderer extends EntityRenderer<ShieldDebris> {
   private static final ResourceLocation TEXTURE = Goetied.location("textures/entity/projectiles/shield_debris.png");
