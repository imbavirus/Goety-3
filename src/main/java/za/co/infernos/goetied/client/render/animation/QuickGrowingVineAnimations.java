...
public class QuickGrowingVineAnimations {
    public static final AnimationDefinition IDLE = AnimationDefinition.Builder.withLength(1.125F).looping()
            ...
            .addAnimation("top", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                    ...
                    new Keyframe(0.625F, KeyframeAnimations.degreeVec(12.5F, 0.5F, -2.5F), AnimationChannel.Interpolations.CATMULLROM),
    ...
    public static final AnimationDefinition BURST = AnimationDefinition.Builder.withLength(0.75F)
        ...
        public static final AnimationDefinition BURROW = AnimationDefinition.Builder.withLength(0.75F)
            ...
            .addAnimation("vine", new AnimationChannel(AnimationChannel.Targets.POSITION,
                    ...
                    new Keyframe(0.75F, KeyframeAnimations.posVec(0.0F, -32.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM)
            ))
            .addAnimation("middle", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                    new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
        ...
        public static final AnimationDefinition HOLD = AnimationDefinition.Builder.withLength(1.0F).looping()
                .addAnimation("vine", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                        new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
                ...
                .addAnimation("vine", new AnimationChannel(AnimationChannel.Targets.POSITION,
                        new Keyframe(0.0F, KeyframeAnimations.posVec(0.0F, -32.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
                        new Keyframe(1.0F, KeyframeAnimations.posVec(0.0F, -32.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM)
                ))
                .addAnimation("middle", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                        new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
                        new Keyframe(1.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM)
