...
import za.co.infernos.goetied.client.render.model.BoundIllagerModel;
...
public class BoundEvokerRenderer extends BoundIllagerRenderer<BoundEvoker>{
    protected static final ResourceLocation TEXTURE = Goetied.location("textures/entity/servants/bound_illager/bound_evoker.png");
    protected static final ResourceLocation CASTING = Goetied.location("textures/entity/servants/bound_illager/bound_evoker_casting.png");
