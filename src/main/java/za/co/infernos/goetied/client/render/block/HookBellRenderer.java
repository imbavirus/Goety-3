...
import za.co.infernos.goetied.common.blocks.entities.HookBellBlockEntity;
...
public class HookBellRenderer implements BlockEntityRenderer<HookBellBlockEntity> {
    public static ResourceLocation TEXTURE = Goetied.location("textures/entity/hook_bell/bell_body.png");
    private final ModelPart bellBody;

    public HookBellRenderer(BlockEntityRendererProvider.Context p_173554_) {
    ...
    public void render(HookBellBlockEntity p_112233_, float p_112234_, PoseStack p_112235_, MultiBufferSource p_112236_, int p_112237_, int p_112238_) {
        ...
        VertexConsumer vertexconsumer = p_112236_.getBuffer(RenderType.entitySolid(TEXTURE));
