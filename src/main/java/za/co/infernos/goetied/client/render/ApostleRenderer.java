...
import za.co.infernos.goetied.client.render.model.ApostleModel;
import za.co.infernos.goetied.client.render.model.CultistModel;
...
public class ApostleRenderer extends CultistRenderer<Apostle> {
    protected static final ResourceLocation TEXTURE = Goetied.location("textures/entity/cultist/apostle.png");
    protected static final ResourceLocation TEXTURE_2 = Goetied.location("textures/entity/cultist/apostle_second.png");
    protected static final ResourceLocation EXPLODE = Goetied.location("textures/entity/cultist/apostle_explode.png");
    ...
    public void render(Apostle pEntity, float pEntityYaw, float pPartialTicks, PoseStack pMatrixStack,
        ...
        if (pEntity.deathTime > 0) {
            ...
            float f8 = za.co.infernos.goetied.utils.ConfigHelper.getBoolean(MobsConfig.FancierApostleDeath, false) || pEntity.level().dimension() == Level.NETHER ? 300.0F
                    : 30.0F;
            ...
            if (za.co.infernos.goetied.utils.ConfigHelper.getBoolean(MobsConfig.FancierApostleDeath, false) || pEntity.level().dimension() == Level.NETHER) {
    ...
    public static class MonolithLayer<T extends Apostle, M extends CultistModel<T>> extends RenderLayer<T, M> {
        private static final ResourceLocation ARMOR = Goetied.location("textures/entity/cultist/apostle_aura.png");
