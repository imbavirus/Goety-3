...
import za.co.infernos.goetied.client.render.layer.TormentorVisageLayer;
import za.co.infernos.goetied.client.render.model.TormentorModel;
import za.co.infernos.goetied.common.entities.hostile.illagers.Tormentor;
...
public class TormentorRenderer extends HumanoidMobRenderer<Tormentor, TormentorModel<Tormentor>> {
    private static final ResourceLocation TEXTURE = Goetied.location("textures/entity/illagers/tormentor.png");
    private static final ResourceLocation TEXTURE_CHARGE = Goetied.location("textures/entity/illagers/tormentor_charge.png");
