...
import za.co.infernos.goetied.common.entities.hostile.BoneSpider;
...
public class BoneSpiderRenderer<T extends BoneSpider> extends MobRenderer<T, ModSpiderModel<T>> {
   private static final ResourceLocation BONE_SPIDER_LOCATION = Goetied.location("textures/entity/servants/spider/bone_spider_original.png");
