...
import za.co.infernos.goetied.common.entities.neutral.AbstractSkeletonPillager;
...
public class SkeletonPillagerRenderer extends HumanoidMobRenderer<AbstractSkeletonPillager, SkeletonVillagerModel<AbstractSkeletonPillager>> {
    protected static final ResourceLocation TEXTURE = Goetied.location("textures/entity/servants/skeleton/skeleton_pillager.png");
