...
import za.co.infernos.goetied.client.render.model.SpikeModel;
...
public class SpikeRenderer extends EntityRenderer<Spike> {
    private static final ResourceLocation TEXTURE_LOCATION = Goetied.location("textures/entity/projectiles/spike.png");
