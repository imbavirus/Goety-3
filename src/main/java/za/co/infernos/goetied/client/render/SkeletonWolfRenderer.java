...
import za.co.infernos.goetied.client.render.model.SkeletonWolfModel;
...
public class SkeletonWolfRenderer extends MobRenderer<SkeletonWolf, SkeletonWolfModel<SkeletonWolf>> {
    private static final ResourceLocation TEXTURES = Goetied.location("textures/entity/servants/skeleton/skeleton_wolf.png");
    private static final ResourceLocation HOSTILE = Goetied.location("textures/entity/servants/skeleton/skeleton_wolf_angry.png");
