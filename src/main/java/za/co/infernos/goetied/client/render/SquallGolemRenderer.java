...
import za.co.infernos.goetied.client.render.model.SquallGolemModel;
...
public class SquallGolemRenderer<T extends SquallGolem> extends MobRenderer<T, SquallGolemModel<T>> {
    private static final ResourceLocation TEXTURES = Goetied.location("textures/entity/servants/squall_golem/squall_golem.png");
    private static final ResourceLocation HOSTILE = Goetied.location("textures/entity/servants/squall_golem/squall_golem_hostile.png");
    ...
    public ResourceLocation getTextureLocation(T entity) {
        if (za.co.infernos.goetied.utils.ConfigHelper.getBoolean(MobsConfig.SquallGolemTexture, false) && !entity.isHostile()) {
            return TEXTURES;
        }
        return HOSTILE;
    }
    ...
    public static class SquallGolemGlowLayer<T extends SquallGolem, M extends SquallGolemModel<T>> extends EyesLayer<T, M> {
        private static final ResourceLocation GLOW = Goetied.location("textures/entity/servants/squall_golem/squall_golem_glow.png");
        private static final ResourceLocation GLOW_HOSTILE = Goetied.location("textures/entity/servants/squall_golem/squall_golem_hostile_glow.png");
        ...
        public void render(PoseStack p_116983_, MultiBufferSource p_116984_, int p_116985_, T p_116986_, float p_116987_, float p_116988_, float p_116989_, float p_116990_, float p_116991_, float p_116992_) {
            if (p_116986_.isStartingUp() || p_116986_.isActivated()){
                ...
                if (za.co.infernos.goetied.utils.ConfigHelper.getBoolean(MobsConfig.SquallGolemTexture, false) && !p_116986_.isHostile()){
