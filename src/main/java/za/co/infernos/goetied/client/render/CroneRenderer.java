...
import za.co.infernos.goetied.client.render.layer.CroneItemLayer;
import za.co.infernos.goetied.client.render.model.CroneModel;
...
public class CroneRenderer extends MobRenderer<Crone, CroneModel<Crone>> {
   private static final ResourceLocation WITCH_LOCATION = Goetied.location("textures/entity/cultist/crone.png");
