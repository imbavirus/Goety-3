...
import za.co.infernos.goetied.client.render.model.SunkenSkeletonModel;
...
public class SunkenSkeletonServantRenderer extends HumanoidMobRenderer<SunkenSkeletonServant, SunkenSkeletonModel<SunkenSkeletonServant>> {
   private static final ResourceLocation TEXTURES = Goetied.location("textures/entity/servants/skeleton/sunken_skeleton_servant.png");
   private static final ResourceLocation ORIGINAL = Goetied.location("textures/entity/servants/skeleton/sunken_skeleton.png");
   ...
   public ResourceLocation getTextureLocation(SunkenSkeletonServant servant) {
      if (za.co.infernos.goetied.utils.ConfigHelper.getBoolean(MobsConfig.SunkenSkeletonServantTexture, false) && !servant.isHostile()) {
         return TEXTURES;
      }
      return ORIGINAL;
   }
   ...
   public static class SunkenSkeletonServantLayer<T extends AbstractSkeletonServant, M extends EntityModel<T>> extends RenderLayer<T, M> {
      private static final ResourceLocation TEXTURES = Goetied.location("textures/entity/servants/skeleton/sunken_skeleton_servant_overlay.png");
      ...
      public void render(PoseStack matrixStackIn, MultiBufferSource bufferIn, int packedLightIn, T entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch) {
         if (!entitylivingbaseIn.isHostile()) {
            if (za.co.infernos.goetied.utils.ConfigHelper.getBoolean(MobsConfig.SunkenSkeletonServantTexture, false)) {
