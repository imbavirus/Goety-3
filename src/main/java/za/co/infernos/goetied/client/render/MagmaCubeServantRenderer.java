...
import za.co.infernos.goetied.client.render.model.MagmaCubeServantModel;
...
public class MagmaCubeServantRenderer extends MobRenderer<MagmaCubeServant, MagmaCubeServantModel<MagmaCubeServant>> {
   private static final ResourceLocation MAGMACUBE_LOCATION = Goetied.location("textures/entity/servants/slime/magma_cube_servant.png");
   ...
   public ResourceLocation getTextureLocation(MagmaCubeServant p_115393_) {
      if (p_115393_.isHostile() || !za.co.infernos.goetied.utils.ConfigHelper.getBoolean(MobsConfig.MagmaCubeServantTexture, false)){
         return ORIGINAL;
      }
   ...
   public class MCSecretLayer<T extends SlimeServant> extends RenderLayer<T, MagmaCubeServantModel<T>> {
      private static final ResourceLocation TEXTURES = Goetied.location("textures/entity/servants/slime/magma_cube_servant_secret.png");
