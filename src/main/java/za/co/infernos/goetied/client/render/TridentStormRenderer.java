...
import za.co.infernos.goetied.client.render.model.TridentStormModel;
...
public class TridentStormRenderer extends EntityRenderer<TridentStorm> {
    private static final ResourceLocation TEXTURES = Goetied.location("textures/entity/projectiles/trident_storm.png");
