...
import za.co.infernos.goetied.client.render.model.RedstoneCubeModel;
...
public class RedstoneCubeRenderer extends MobRenderer<RedstoneCube, RedstoneCubeModel<RedstoneCube>> {
    private static final ResourceLocation TEXTURE = Goetied.location("textures/entity/servants/redstone_monstrosity/redstone_cube.png");
    private static final ResourceLocation ACTIVE = Goetied.location("textures/entity/servants/redstone_monstrosity/redstone_cube_active.png");
    private static final ResourceLocation GLOW = Goetied.location("textures/entity/servants/redstone_monstrosity/redstone_cube_glow.png");
    ...
    public static class CubeEyesLayer<T extends RedstoneCube, M extends RedstoneCubeModel<T>> extends EyesLayer<T, M> {
        private static final RenderType EYES = RenderType.eyes(Goetied.location("textures/entity/servants/redstone_monstrosity/redstone_cube_eyes.png"));
