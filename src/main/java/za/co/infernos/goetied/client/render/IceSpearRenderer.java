...
public class IceSpearRenderer<T extends IceSpear> extends ArrowRenderer<T> {
    public static final ResourceLocation TEXTURE_LOCATION = Goetied.location("textures/entity/projectiles/ice_spike.png");

    public IceSpearRenderer(EntityRendererProvider.Context p_173917_) {
        super(p_173917_);
    }
