...
import za.co.infernos.goetied.client.render.model.EnderKeeperModel;
...
public class EnderKeeperRenderer<T extends EnderKeeper> extends MobRenderer<T, EnderKeeperModel<T>> {
    protected static final ResourceLocation TEXTURE_LOCATION = Goetied
            .location("textures/entity/enderling/keeper/keeper.png");
    protected static final ResourceLocation DEATH = Goetied.location("textures/entity/enderling/keeper/keeper_death.png");
    ...
    public static class GlowLayer<T extends EnderKeeper, M extends EnderKeeperModel<T>> extends EyesLayer<T, M> {
        private static final RenderType RENDER_TYPE = RenderType
                .eyes(Goetied.location("textures/entity/enderling/keeper/keeper_glow.png"));
