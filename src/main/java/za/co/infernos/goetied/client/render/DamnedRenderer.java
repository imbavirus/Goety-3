...
import za.co.infernos.goetied.client.render.model.DamnedModel;
...
public class DamnedRenderer<T extends Damned> extends MobRenderer<T, DamnedModel<T>> {
    protected static final ResourceLocation TEXTURE = Goetied.location("textures/entity/cultist/damned.png");
    protected static final ResourceLocation TEXTURE_2 = Goetied.location("textures/entity/cultist/damned_2.png");
    protected static final ResourceLocation SCREAM = Goetied.location("textures/entity/cultist/damned_scream.png");
    protected static final ResourceLocation SCREAM_2 = Goetied.location("textures/entity/cultist/damned_scream_2.png");
