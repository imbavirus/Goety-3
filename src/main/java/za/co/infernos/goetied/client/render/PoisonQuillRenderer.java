...
import za.co.infernos.goetied.client.render.model.PoisonQuillModel;
...
public class PoisonQuillRenderer extends EntityRenderer<PoisonQuill> {
   public static final ResourceLocation TEXTURE = Goetied.location("textures/entity/projectiles/poison_quill.png");
   public static final ResourceLocation AQUA = Goetied.location("textures/entity/projectiles/poison_quill_aqua.png");
