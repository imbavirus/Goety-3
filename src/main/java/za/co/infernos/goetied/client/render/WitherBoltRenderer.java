...
public class WitherBoltRenderer extends EntityRenderer<WitherBolt> {
   private final SoulBoltModel<WitherBolt> model;

   public WitherBoltRenderer(EntityRendererProvider.Context p_174449_) {
      super(p_174449_);
      this.model = new SoulBoltModel<>(p_174449_.bakeLayer(ModModelLayer.SOUL_BOLT));
   }

   protected int getBlockLightLevel(WitherBolt p_116491_, BlockPos p_116492_) {
      return 15;
   }

   public void render(WitherBolt p_116484_, float p_116485_, float p_116486_, PoseStack p_116487_,
   ...
   public ResourceLocation getTextureLocation(WitherBolt p_116482_) {
