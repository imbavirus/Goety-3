...
import za.co.infernos.goetied.common.entities.ally.illager.EvokerServant;
...
public class EvokerServantRenderer<T extends EvokerServant> extends MobRenderer<T, IllagerServantModel<T>> {
    protected static final ResourceLocation TEXTURE = Goetied.location("textures/entity/servants/illager/evoker.png");
    ...
    public ResourceLocation getTextureLocation(T entity) {
        if (entity.isHostile() || !za.co.infernos.goetied.utils.ConfigHelper.getBoolean(MobsConfig.EvokerServantTexture, false)){
            return ORIGINAL;
        } else {
            return TEXTURE;
        }
