...
import za.co.infernos.goetied.client.render.model.BlockModel;
...
public class BrewGasRenderer extends EntityRenderer<BrewGas> {
    private static final ResourceLocation LOCATION = Goetied.location("textures/entity/brew_gas.png");
