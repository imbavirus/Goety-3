...
import za.co.infernos.goetied.client.render.model.ZombieServantModel;
...
public abstract class AbstractZombieServantRenderer<T extends ZombieServant, M extends ZombieServantModel<T>> extends HumanoidMobRenderer<T, M> {
   protected static final ResourceLocation TEXTURE = Goetied.location("textures/entity/servants/zombie/zombie_servant.png");
   ...
   public ResourceLocation getTextureLocation(ZombieServant p_113771_) {
      if (p_113771_.isHostile() || !za.co.infernos.goetied.utils.ConfigHelper.getBoolean(MobsConfig.ZombieServantTexture, false)){
