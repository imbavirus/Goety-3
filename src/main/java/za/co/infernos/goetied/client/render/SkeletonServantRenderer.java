...
import za.co.infernos.goetied.client.render.layer.SkeletonServantClothingLayer;
import za.co.infernos.goetied.common.entities.ally.undead.skeleton.AbstractSkeletonServant;
import za.co.infernos.goetied.common.entities.ally.undead.skeleton.MossySkeletonServant;
import za.co.infernos.goetied.common.entities.ally.undead.skeleton.StrayServant;
...
public class SkeletonServantRenderer extends HumanoidMobRenderer<AbstractSkeletonServant, SkeletonModel<AbstractSkeletonServant>> {
   private static final ResourceLocation TEXTURES = Goetied.location("textures/entity/servants/skeleton/skeleton_servant.png");
   private static final ResourceLocation SKELETON_LOCATION = ResourceLocation.parse("textures/entity/skeleton/skeleton.png");
   private static final ResourceLocation STRAY = Goetied.location("textures/entity/servants/skeleton/stray_servant.png");
   private static final ResourceLocation STRAY_ORIGINAL = ResourceLocation.parse("textures/entity/skeleton/stray.png");
   private static final ResourceLocation MOSSY = Goetied.location("textures/entity/servants/skeleton/mossy_skeleton_servant.png");
   private static final ResourceLocation MOSSY_ORIGINAL = Goetied.location("textures/entity/servants/skeleton/mossy_skeleton.png");
   ...
   public ResourceLocation getTextureLocation(AbstractSkeletonServant servant) {
      if (servant instanceof MossySkeletonServant){
         if (servant.isHostile() || !za.co.infernos.goetied.utils.ConfigHelper.getBoolean(MobsConfig.MossySkeletonServantTexture, false)){
            return MOSSY_ORIGINAL;
         }
         return MOSSY;
      } else if (servant instanceof StrayServant){
         if (servant.isHostile() || !za.co.infernos.goetied.utils.ConfigHelper.getBoolean(MobsConfig.StrayServantTexture, false)){
            return STRAY_ORIGINAL;
         }
         return STRAY;
      } else if (servant.isHostile() || !za.co.infernos.goetied.utils.ConfigHelper.getBoolean(MobsConfig.SkeletonServantTexture, false)){
