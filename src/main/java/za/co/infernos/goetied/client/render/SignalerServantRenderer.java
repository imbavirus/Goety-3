...
import za.co.infernos.goetied.common.entities.ally.illager.SignalerServant;
...
public class SignalerServantRenderer<T extends SignalerServant> extends MobRenderer<T, IllagerServantModel<T>> {
    protected static final ResourceLocation TEXTURE = Goetied.location("textures/entity/servants/illager/signaler.png");
