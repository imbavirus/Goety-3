...
public class WebShotRenderer<T extends Projectile> extends EntityRenderer<T> {
    private static final ResourceLocation TEXTURE = Goetied.location("textures/entity/projectiles/web_shot.png");
    ...
    public void render(T pEntity, float pYaw, float pPartialTicks, PoseStack pPoseStack, MultiBufferSource pBuffer,
        ...
        this.model.renderToBuffer(pPoseStack, consumer, pPackedLight, OverlayTexture.NO_OVERLAY, 0x80FFFFFF);
        pPoseStack.popPose();
