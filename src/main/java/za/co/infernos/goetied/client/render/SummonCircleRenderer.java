...
import za.co.infernos.goetied.client.render.model.SummonCircleModel;
...
public class SummonCircleRenderer extends EntityRenderer<SummonCircle> {
    private static final ResourceLocation TEXTURES = Goetied.location("textures/entity/summon_circle.png");
    private static final ResourceLocation TEXTURES_SPIRIT = Goetied.location("textures/entity/summon_circle_spirit.png");
    private static final ResourceLocation TEXTURES_APOSTLE = Goetied.location("textures/entity/cultist/apostle_summon_circle.png");
