...
import za.co.infernos.goetied.client.render.layer.WraithBandsLayer;
import za.co.infernos.goetied.client.render.layer.WraithSecretLayer;
...
public class MuckWraithServantRenderer<T extends AbstractWraith> extends AbstractWraithRenderer<T> {
    protected static final ResourceLocation TEXTURE = Goetied.location("textures/entity/wraith/muck_wraith.png");

    public MuckWraithServantRenderer(EntityRendererProvider.Context renderManagerIn){
    ...
    public static class GlowLayer<T extends Mob, M extends WraithModel<T>> extends EyesLayer<T, M> {
        private static final RenderType RENDER_TYPE = ModRenderType.wraith(Goetied.location("textures/entity/wraith/muck_wraith_glow.png"));
