...
public class PillagerServantRenderer<T extends PillagerServant> extends MobRenderer<T, IllagerServantModel<T>> {
    protected static final ResourceLocation TEXTURE = Goetied.location("textures/entity/servants/illager/pillager.png");
    ...
    public ResourceLocation getTextureLocation(T entity) {
        if (entity.isHostile() || !za.co.infernos.goetied.utils.ConfigHelper.getBoolean(MobsConfig.PillagerServantTexture, false)){
            return ORIGINAL;
        } else {
            return TEXTURE;
        }
