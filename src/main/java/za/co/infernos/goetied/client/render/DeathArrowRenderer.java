...
import za.co.infernos.goetied.common.entities.projectiles.DeathArrow;
import net.minecraft.client.renderer.entity.ArrowRenderer;
import net.minecraft.client.renderer.entity.EntityRendererProvider;
import net.minecraft.resources.ResourceLocation;

public class DeathArrowRenderer extends ArrowRenderer<DeathArrow> {
    public static final ResourceLocation ARROW_LOCATION = Goetied.location("textures/entity/projectiles/death_arrow.png");
