...
import za.co.infernos.goetied.client.render.model.WightModel;
...
public class WightRenderer<T extends Wight> extends MobRenderer<T, WightModel<T>> {
    private static final ResourceLocation TEXTURES = Goetied.location("textures/entity/wight/wight.png");
    private static final ResourceLocation EASTER_EGG = Goetied.location("textures/entity/wight/waltuh.png");
    protected static final ResourceLocation DEATH = Goetied.location("textures/entity/wight/wight_death.png");
