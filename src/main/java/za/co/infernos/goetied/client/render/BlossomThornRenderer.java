...
import za.co.infernos.goetied.common.entities.projectiles.BlossomThorn;
import za.co.infernos.goetied.utils.ColorUtil;
import za.co.infernos.goetied.utils.Vec3Util;
...
public class BlossomThornRenderer extends EntityRenderer<BlossomThorn> {
    private static final ResourceLocation TEXTURE_LOCATION = Goetied.location("textures/entity/projectiles/blossom_thorn.png");
    ...
    private void renderBeam(BlossomThorn blossomThorn, float tickDelta, PoseStack poseStack, MultiBufferSource bufferSource, RenderType type){
        ...
        poseStack.mulPose(Axis.YP.rotationDegrees(((pi / 2.0F) - o) * rTD));
        poseStack.mulPose(Axis.XP.rotationDegrees(n * rTD));
        float q = 0.0F;
