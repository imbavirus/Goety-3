...
import za.co.infernos.goetied.client.render.model.MaverickModel;
...
public class MaverickRenderer extends CultistRenderer<Maverick>{
    protected static final ResourceLocation TEXTURE = Goetied.location("textures/entity/cultist/maverick.png");
