...
import za.co.infernos.goetied.client.render.model.SpiderEggModel;
import za.co.infernos.goetied.common.entities.neutral.SpiderEgg;
...
public class SpiderEggRenderer extends MobRenderer<SpiderEgg, SpiderEggModel<SpiderEgg>> {
    private static final ResourceLocation TEXTURES = Goetied.location("textures/entity/spider_egg.png");
    private static final ResourceLocation HATCH = Goetied.location("textures/entity/spider_egg_hatch.png");
