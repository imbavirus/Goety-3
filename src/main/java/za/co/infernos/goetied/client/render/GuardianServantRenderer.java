...
import za.co.infernos.goetied.client.render.model.GuardianServantModel;
...
public class GuardianServantRenderer extends MobRenderer<GuardianServant, GuardianServantModel> {
   ...
   private static final ResourceLocation SERVANT_LOCATION = Goetied.location("textures/entity/servants/guardian_servant.png");
   ...
   protected GuardianServantRenderer(EntityRendererProvider.Context p_174161_, float p_174162_, ModelLayerLocation p_174163_) {
      super(p_174161_, new GuardianServantModel(p_174161_.bakeLayer(p_174163_)), p_174162_);
   }

   public boolean shouldRender(GuardianServant p_114836_, Frustum p_114837_, double p_114838_, double p_114839_, double p_114840_) {
   ...
   public void render(GuardianServant p_114829_, float p_114830_, float p_114831_, PoseStack p_114832_, MultiBufferSource p_114833_, int p_114834_) {
   ...
   public ResourceLocation getTextureLocation(GuardianServant p_114827_) {
      if (p_114827_.isHostile() || !za.co.infernos.goetied.utils.ConfigHelper.getBoolean(MobsConfig.GuardianServantTexture, false)){
