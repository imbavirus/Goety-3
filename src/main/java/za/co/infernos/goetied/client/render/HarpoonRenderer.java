...
import za.co.infernos.goetied.client.render.model.HarpoonModel;
...
public class HarpoonRenderer extends EntityRenderer<Harpoon> {
   public static final ResourceLocation TEXTURE = Goetied.location("textures/entity/projectiles/harpoon.png");
