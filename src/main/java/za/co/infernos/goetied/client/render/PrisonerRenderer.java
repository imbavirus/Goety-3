...
import za.co.infernos.goetied.client.render.model.PrisonerModel;
...
public class PrisonerRenderer extends MobRenderer<Prisoner, PrisonerModel<Prisoner>> {
   ...
   private static final ResourceLocation CHAIN = Goetied.location("textures/entity/servants/prisoner_chain.png");
   ...
   public static class ShacklesLayer<T extends Prisoner, M extends PrisonerModel<T>> extends RenderLayer<T, M> {
      private static final ResourceLocation SHACKLES = Goetied.location("textures/entity/servants/prisoner_shackles.png");
