...
public class ArcaRenderer implements BlockEntityRenderer<ArcaBlockEntity> {
    public static final ResourceLocation GLASS_CAGE_TEXTURE = Goetied.location("textures/entity/arca/cage.png");
    public static final ResourceLocation CORE_TEXTURE = Goetied.location("textures/entity/arca/core.png");
    public static final ResourceLocation D_CORE_TEXTURE = Goetied.location("textures/entity/arca/d_core.png");
