...
public class TotemicBombRenderer<T extends AbstractMonolith> extends AbstractMonolithRenderer<T>{
    private static final ResourceLocation TEXTURE_LOCATION = Goetied.location("textures/entity/monolith/totemic_bomb.png");
    private static final RenderType RENDER_TYPE = RenderType.eyes(Goetied.location("textures/entity/monolith/totemic_bomb_glow.png"));
    private static final RenderType RENDER_TYPE_2 = RenderType.eyes(Goetied.location("textures/entity/monolith/totemic_bomb_glow2.png"));
    private static final RenderType RENDER_TYPE_3 = RenderType.eyes(Goetied.location("textures/entity/monolith/totemic_bomb_glow3.png"));
