...
import za.co.infernos.goetied.client.render.model.SoulBombModel;
...
public class SoulBombRenderer extends EntityRenderer<SoulBomb> {
    private static final ResourceLocation TEXTURE = Goetied.location("textures/entity/projectiles/soul_bomb.png");
