...
import za.co.infernos.goetied.client.render.model.RavagedModel;
import za.co.infernos.goetied.common.entities.ally.illager.Ravaged;
...
public class RavagedRenderer extends MobRenderer<Ravaged, RavagedModel<Ravaged>> {
   private static final ResourceLocation TEXTURE = Goetied.location("textures/entity/servants/ravager/ravaged.png");
