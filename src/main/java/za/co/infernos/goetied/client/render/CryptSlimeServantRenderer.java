...
public class CryptSlimeServantRenderer extends MobRenderer<CryptSlimeServant, SlimeModel<CryptSlimeServant>> {
   private static final ResourceLocation SLIME_LOCATION = Goetied.location("textures/entity/servants/slime/crypt_slime_servant.png");
   private static final ResourceLocation ORIGINAL = Goetied.location("textures/entity/crypt_slime.png");
   ...
   public ResourceLocation getTextureLocation(CryptSlimeServant p_115974_) {
      if (p_115974_.isHostile() || !za.co.infernos.goetied.utils.ConfigHelper.getBoolean(MobsConfig.CryptSlimeServantTexture, false)){
         return ORIGINAL;
      }
   ...
   public class SlimeSecretLayer<T extends CryptSlimeServant> extends RenderLayer<T, SlimeModel<T>> {
      private static final ResourceLocation TEXTURES = Goetied.location("textures/entity/servants/slime/slime_servant_secret.png");
   ...
   public static class CryptSlimeEyesLayer<T extends Entity, M extends SlimeModel<T>> extends EyesLayer<T, M> {
      private static final RenderType EYES = RenderType.eyes(Goetied.location("textures/entity/crypt_slime_eyes.png"));
