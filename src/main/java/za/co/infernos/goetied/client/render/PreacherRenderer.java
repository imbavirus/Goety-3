...
import za.co.infernos.goetied.client.render.model.PreacherModel;
import za.co.infernos.goetied.common.entities.hostile.illagers.Preacher;
...
public class PreacherRenderer<T extends Preacher> extends MobRenderer<T, PreacherModel<T>> {
    protected static final ResourceLocation TEXTURE = Goetied.location("textures/entity/illagers/preacher.png");
