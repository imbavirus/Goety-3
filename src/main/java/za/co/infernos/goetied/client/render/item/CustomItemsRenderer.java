package za.co.infernos.goetied.client.render.item;
...
import za.co.infernos.goetied.client.render.model.NamelessStaffModel;
...
public class CustomItemsRenderer extends BlockEntityWithoutLevelRenderer {
    ...
    private static final ResourceLocation NAMELESS_STAFF_TEXTURE = Goetied.location("textures/item/nameless_staff_model.png");
    private static final ResourceLocation NAMELESS_STAFF_ORB_TEXTURE = Goetied.location("textures/item/nameless_staff_orb.png");
    private static final ResourceLocation NAMELESS_STAFF_ORB_CENTER_TEXTURE = Goetied.location("textures/item/nameless_staff_orb_center.png");
