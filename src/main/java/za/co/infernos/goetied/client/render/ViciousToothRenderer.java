...
import za.co.infernos.goetied.client.render.model.ViciousToothModel;
...
public class ViciousToothRenderer extends EntityRenderer<ViciousTooth> {
    private static final ResourceLocation TEXTURE = Goetied.location("textures/entity/projectiles/vicious_tooth.png");
