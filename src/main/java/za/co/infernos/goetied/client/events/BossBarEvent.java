...
public class BossBarEvent {
    ...
    protected static final ResourceLocation TEXTURE = Goetied.location("textures/gui/boss_bar.png");
    protected static final ResourceLocation BOSS_HURT = Goetied.location("textures/gui/boss_bar_hurt.png");
    protected static final ResourceLocation BOSS_BAR_1 = Goetied.location("textures/gui/boss_bar_1.png");
    protected static final ResourceLocation MINI_BOSS_BAR = Goetied.location("textures/gui/miniboss_bar.png");
    ...
    public static void renderBossBar(CustomizeGuiOverlayEvent.BossEventProgress event){
        ...
        if (za.co.infernos.goetied.utils.ConfigHelper.getBoolean(MainConfig.SpecialBossBar, false)) {
