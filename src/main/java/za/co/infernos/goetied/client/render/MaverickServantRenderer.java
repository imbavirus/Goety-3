...
import za.co.infernos.goetied.client.render.model.MaverickServantModel;
import za.co.infernos.goetied.client.render.model.VillagerArmorModel;
import za.co.infernos.goetied.common.entities.ally.illager.MaverickServant;
...
public class MaverickServantRenderer<T extends MaverickServant> extends MobRenderer<T, MaverickServantModel<T>> {
    private static final ResourceLocation WITCH_LOCATION = Goetied.location("textures/entity/servants/maverick.png");
    private static final ResourceLocation ORIGINAL = Goetied.location("textures/entity/cultist/maverick.png");
    ...
    public ResourceLocation getTextureLocation(T entity) {
        if (entity.isHostile() || !za.co.infernos.goetied.utils.ConfigHelper.getBoolean(MobsConfig.MaverickServantTexture, false)) {
            return ORIGINAL;
        }
