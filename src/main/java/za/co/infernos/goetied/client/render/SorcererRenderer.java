...
import za.co.infernos.goetied.client.render.model.SorcererModel;
import za.co.infernos.goetied.client.render.model.VillagerArmorModel;
import za.co.infernos.goetied.common.entities.hostile.illagers.Sorcerer;
...
public class SorcererRenderer<T extends Sorcerer> extends MobRenderer<T, SorcererModel<T>> {
    protected static final ResourceLocation TEXTURE = Goetied.location("textures/entity/illagers/sorcerer/sorcerer.png");
    ...
    public static class CastLevelLayer<T extends Sorcerer, M extends SorcererModel<T>> extends RenderLayer<T, M> {
        private static final Int2ObjectMap<ResourceLocation> LEVEL_LOCATIONS = Util.make(new Int2ObjectOpenHashMap<>(), (p_117657_) -> {
            p_117657_.put(1, Goetied.location("textures/entity/illagers/sorcerer/level_1.png"));
            p_117657_.put(2, Goetied.location("textures/entity/illagers/sorcerer/level_2.png"));
            p_117657_.put(3, Goetied.location("textures/entity/illagers/sorcerer/level_3.png"));
            p_117657_.put(4, Goetied.location("textures/entity/illagers/sorcerer/level_4.png"));
            p_117657_.put(5, Goetied.location("textures/entity/illagers/sorcerer/level_5.png"));
        });
