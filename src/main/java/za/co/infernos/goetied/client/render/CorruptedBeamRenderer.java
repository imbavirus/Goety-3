...
import za.co.infernos.goetied.common.entities.projectiles.AbstractBeam;
...
public class CorruptedBeamRenderer<T extends CorruptedBeam> extends EntityRenderer<T> {
    private final static ResourceLocation beaconBeamCore = Goetied.location("textures/entity/corrupted/beacon_beam_core.png");
    private final static ResourceLocation beaconBeamMain = Goetied.location("textures/entity/corrupted/beacon_beam_main.png");
    private final static ResourceLocation beaconBeamGlow = Goetied.location("textures/entity/corrupted/beacon_beam_glow.png");
