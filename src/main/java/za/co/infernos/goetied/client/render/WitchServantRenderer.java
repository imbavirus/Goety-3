...
import za.co.infernos.goetied.client.render.model.ModWitchModel;
import za.co.infernos.goetied.client.render.model.VillagerArmorModel;
import za.co.infernos.goetied.common.entities.ally.illager.WitchServant;
...
public class WitchServantRenderer extends MobRenderer<WitchServant, ModWitchModel<WitchServant>> {
   private static final ResourceLocation WITCH_LOCATION = Goetied.location("textures/entity/servants/witch.png");
   ...
   public ResourceLocation getTextureLocation(WitchServant p_116410_) {
      if (p_116410_.isHostile() || !za.co.infernos.goetied.utils.ConfigHelper.getBoolean(MobsConfig.WitchServantTexture, false)) {
         return ORIGINAL;
      }
