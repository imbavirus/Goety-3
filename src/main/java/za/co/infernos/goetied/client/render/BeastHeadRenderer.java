...
import za.co.infernos.goetied.client.render.model.BeastHeadModel;
...
public class BeastHeadRenderer<T extends BeastHead> extends MobRenderer<T, BeastHeadModel<T>> {
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(Goetied.MOD_ID,"textures/entity/servants/black_wolf/beast_head.png");
