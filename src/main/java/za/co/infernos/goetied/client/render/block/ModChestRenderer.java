...
import za.co.infernos.goetied.common.blocks.entities.ModChestBlockEntity;
...
public class ModChestRenderer<T extends ModChestBlockEntity> extends ChestRenderer<T> {
    ...
    static {
        ...
        builder.put(ModBlocks.RAIDING_CHEST.get(), chestMaterial("raiding"));
        builder.put(ModBlocks.TRAPPED_RAIDING_CHEST.get(), trappedMaterial("raiding"));
    ...
    private static EnumMap<ChestType, Material> chestMaterial(String type) {
        ...
        map.put(ChestType.SINGLE, new Material(Sheets.CHEST_SHEET, Goetied.location("entity/chest/" + type + "/" + "normal")));
        map.put(ChestType.LEFT, new Material(Sheets.CHEST_SHEET, Goetied.location("entity/chest/" + type + "/normal_left")));
        map.put(ChestType.RIGHT, new Material(Sheets.CHEST_SHEET, Goetied.location("entity/chest/" + type + "/normal_right")));
    ...
    private static EnumMap<ChestType, Material> trappedMaterial(String type) {
        ...
        map.put(ChestType.SINGLE, new Material(Sheets.CHEST_SHEET, Goetied.location("entity/chest/" + type + "/" + "trapped")));
        map.put(ChestType.LEFT, new Material(Sheets.CHEST_SHEET, Goetied.location("entity/chest/" + type + "/trapped_left")));
        map.put(ChestType.RIGHT, new Material(Sheets.CHEST_SHEET, Goetied.location("entity/chest/" + type + "/trapped_right")));
