...
public class SpiderServantRenderer<T extends SpiderServant> extends MobRenderer<T, SpiderModel<T>> {
   private static final ResourceLocation SPIDER_LOCATION = Goetied.location("textures/entity/servants/spider/spider_servant.png");
   ...
   public ResourceLocation getTextureLocation(T p_116009_) {
      if (p_116009_.isHostile() || !za.co.infernos.goetied.utils.ConfigHelper.getBoolean(MobsConfig.SpiderServantTexture, false)){
         return ORIGINAL;
      } else {
