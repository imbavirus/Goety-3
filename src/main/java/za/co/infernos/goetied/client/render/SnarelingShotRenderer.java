...
import za.co.infernos.goetied.client.render.model.WebShotModel;
...
public class SnarelingShotRenderer<T extends SnarelingShot> extends EntityRenderer<T> {
    private static final ResourceLocation TEXTURE = Goetied.location("textures/entity/projectiles/snareling_shot.png");
    private static final ResourceLocation TRAIL = Goetied.location("textures/entity/projectiles/minor_trail.png");
