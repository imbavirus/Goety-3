...
import za.co.infernos.goetied.client.render.model.PlayerZombieModel;
...
public class FrozenZombieRenderer extends HumanoidMobRenderer<FrozenZombieServant, PlayerZombieModel<FrozenZombieServant>> {
   protected static final ResourceLocation TEXTURE = Goetied.location("textures/entity/servants/zombie/frozen_zombie_servant.png");
   private static final ResourceLocation ZOMBIE_LOCATION = Goetied.location("textures/entity/servants/zombie/frozen_zombie_original.png");
   ...
   public ResourceLocation getTextureLocation(FrozenZombieServant p_113771_) {
      if (p_113771_.isHostile() || !za.co.infernos.goetied.utils.ConfigHelper.getBoolean(MobsConfig.FrozenZombieServantTexture, false)){
