...
import za.co.infernos.goetied.client.render.model.WarlockModel;
...
public class WarlockRenderer extends MobRenderer<Warlock, WarlockModel<Warlock>> {
   private static final ResourceLocation WITCH_LOCATION = Goetied.location("textures/entity/cultist/warlock.png");
