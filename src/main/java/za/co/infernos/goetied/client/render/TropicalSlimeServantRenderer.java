...
import za.co.infernos.goetied.client.render.model.TropicalSlimeModel;
import za.co.infernos.goetied.common.entities.ally.SlimeServant;
import za.co.infernos.goetied.common.entities.ally.TropicalSlimeServant;
...
public class TropicalSlimeServantRenderer
      extends MobRenderer<TropicalSlimeServant, TropicalSlimeModel<TropicalSlimeServant>> {
   private static final ResourceLocation SLIME_LOCATION = Goetied
         .location("textures/entity/servants/slime/tropical_slime_servant.png");
   private static final ResourceLocation ORIGINAL = Goetied.location("textures/entity/servants/slime/tropical_slime.png");
   ...
   public void render(TropicalSlimeServant p_115976_, float p_115977_, float p_115978_, PoseStack p_115979_,
   ...
   public ResourceLocation getTextureLocation(TropicalSlimeServant p_115974_) {
      if (p_115974_.isHostile() || !za.co.infernos.goetied.utils.ConfigHelper.getBoolean(MobsConfig.SlimeServantTexture, false)) {
         return ORIGINAL;
      }
   ...
   public static class TropicalSlimeSecretLayer<T extends SlimeServant> extends RenderLayer<T, TropicalSlimeModel<T>> {
      private static final ResourceLocation TEXTURES = Goetied
            .location("textures/entity/servants/slime/tropical_slime_servant_secret.png");
      private final TropicalSlimeModel<T> layerModel;

      public TropicalSlimeSecretLayer(RenderLayerParent<T, TropicalSlimeModel<T>> p_i50919_1_,
   ...
   public static class TropicalSlimeFishLayer<T extends TropicalSlimeServant>
         extends RenderLayer<T, TropicalSlimeModel<T>> {
      private final TropicalSlimeModel<T> layerModel;
   ...
   public static class TropicalSlimeOuterLayer<T extends LivingEntity> extends RenderLayer<T, TropicalSlimeModel<T>> {
      ...
      public void render(PoseStack p_117470_, MultiBufferSource p_117471_, int p_117472_, T p_117473_, float p_117474_,
            float p_117475_, float p_117476_, float p_117477_, float p_117478_, float p_117479_) {
         ...
         if (!p_117473_.isInvisible() || flag) {
            ...
            this.model.renderToBuffer(p_117470_, vertexconsumer, p_117472_,
                  LivingEntityRenderer.getOverlayCoords(p_117473_, 0.0F), -1);
         }
      }
   }
}