    ...
    public void renderToBuffer(PoseStack p_102424_, VertexConsumer p_102425_, int p_102426_, int p_102427_, int pColor) {
        if (this.young) {
            ...
            this.headParts().forEach((p_102081_) -> {
                p_102081_.render(p_102424_, p_102425_, p_102426_, p_102427_, pColor);
            });
            p_102424_.popPose();
            p_102424_.pushPose();
            float f1 = 1.0F / 2.0F;
            ...
            this.bodyParts().forEach((p_102071_) -> {
                p_102071_.render(p_102424_, p_102425_, p_102426_, p_102427_, pColor);
            });
            p_102424_.popPose();
        } else {
            super.renderToBuffer(p_102424_, p_102425_, p_102426_, p_102427_, pColor);
        }
    }
}