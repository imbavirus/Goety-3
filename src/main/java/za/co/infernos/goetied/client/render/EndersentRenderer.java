...
import za.co.infernos.goetied.client.render.model.EndersentModel;
...
public class EndersentRenderer<T extends Endersent> extends MobRenderer<T, EndersentModel<T>> {
    protected static final ResourceLocation TEXTURE_LOCATION = Goetied
            .location("textures/entity/enderling/endersent.png");
    protected static final ResourceLocation DEATH = Goetied.location("textures/entity/enderling/endersent_death.png");
    ...
    public static class GlowLayer<T extends Endersent, M extends EndersentModel<T>> extends EyesLayer<T, M> {
        private static final RenderType RENDER_TYPE = RenderType
                .eyes(Goetied.location("textures/entity/enderling/endersent_glow.png"));
    ...
    public static class EnderEyeLayer<T extends Endersent, M extends EndersentModel<T>> extends EyesLayer<T, M> {
        private static final RenderType RENDER_TYPE = RenderType
                .entityCutout(Goetied.location("textures/entity/enderling/endersent_eye.png"));
    ...
    public static class EnchantedLayer<T extends Endersent, M extends EndersentModel<T>> extends RenderLayer<T, M> {
        private static final ResourceLocation ARMOR = Goetied.location("textures/entity/enderling/endersent_glint.png");
