...
import za.co.infernos.goetied.client.render.model.VolcanoModel;
...
public class VolcanoRenderer extends EntityRenderer<AbstractMonolith> {
    private static final ResourceLocation TEXTURE_LOCATION = Goetied.location("textures/entity/monolith/volcano.png");
    private static final RenderType RENDER_TYPE = RenderType
            .eyes(Goetied.location("textures/entity/monolith/volcano_active.png"));
