...
public class JungleZombieRenderer extends HumanoidMobRenderer<JungleZombieServant, PlayerZombieModel<JungleZombieServant>> {
   protected static final ResourceLocation TEXTURE = Goetied.location("textures/entity/servants/zombie/jungle_zombie_servant.png");
   private static final ResourceLocation ZOMBIE_LOCATION = Goetied.location("textures/entity/servants/zombie/jungle_zombie_original.png");
   ...
   public ResourceLocation getTextureLocation(JungleZombieServant p_113771_) {
      if (p_113771_.isHostile() || !za.co.infernos.goetied.utils.ConfigHelper.getBoolean(MobsConfig.JungleZombieServantTexture, false)){
