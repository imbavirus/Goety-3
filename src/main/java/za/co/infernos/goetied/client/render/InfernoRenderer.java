...
import za.co.infernos.goetied.client.render.model.InfernoModel;
...
public class InfernoRenderer extends MobRenderer<Inferno, InfernoModel<Inferno>> {
   private static final ResourceLocation BLAZE_LOCATION = Goetied.location("textures/entity/servants/blaze/inferno.png");
   private static final ResourceLocation GRAND = Goetied.location("textures/entity/servants/blaze/inferno_grand.png");
   ...
   public static class GlowLayer<T extends Inferno, M extends InfernoModel<T>> extends EyesLayer<T, M> {
      private static final RenderType RENDER_TYPE = RenderType.eyes(Goetied.location("textures/entity/servants/blaze/inferno_eyes.png"));
