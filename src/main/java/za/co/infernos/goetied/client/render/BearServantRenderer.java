...
import za.co.infernos.goetied.client.render.model.BearServantModel;
...
public class BearServantRenderer extends MobRenderer<BearServant, BearServantModel<BearServant>> {
   private static final ResourceLocation BEAR_LOCATION = Goetied.location("textures/entity/servants/bear_servant/bear_servant.png");
   private static final ResourceLocation CAVE_BEAR_LOCATION = Goetied.location("textures/entity/servants/bear_servant/cave_bear_servant.png");
   private static final ResourceLocation POLAR_BEAR_LOCATION = Goetied.location("textures/entity/servants/bear_servant/polar_bear_servant.png");
   ...
   public static class RuneLayer<T extends BearServant, M extends BearServantModel<T>> extends RenderLayer<T, M> {
      private static final ResourceLocation TEXTURES = Goetied.location("textures/entity/servants/bear_servant/bear_servant_runes.png");
