...
import za.co.infernos.goetied.client.render.model.GraveGolemSkullModel;
import za.co.infernos.goetied.common.blocks.GraveGolemSkullBlock;
import za.co.infernos.goetied.common.blocks.WallGraveGolemSkullBlock;
import za.co.infernos.goetied.common.blocks.entities.GraveGolemSkullBlockEntity;
...
public class GraveGolemSkullBlockEntityRenderer implements BlockEntityRenderer<GraveGolemSkullBlockEntity> {
    protected static final ResourceLocation TEXTURE = Goetied.location("textures/entity/servants/grave_golem/grave_golem_skull.png");
