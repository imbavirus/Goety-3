...
import za.co.infernos.goetied.client.render.model.ConquillagerModel;
import za.co.infernos.goetied.client.render.model.VillagerArmorModel;
import za.co.infernos.goetied.common.entities.hostile.illagers.Conquillager;
...
public class ConquillagerRenderer<T extends Conquillager> extends MobRenderer<T, ConquillagerModel<T>> {
    protected static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(Goetied.MOD_ID, "textures/entity/illagers/conquillager.png");
