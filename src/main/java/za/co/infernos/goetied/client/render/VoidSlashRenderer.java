...
public class VoidSlashRenderer extends EntityRenderer<VoidSlash> {
    private static final ResourceLocation[] TEXTURES = {
            Goetied.location("textures/entity/projectiles/slash/1.png"),
            Goetied.location("textures/entity/projectiles/slash/2.png"),
            Goetied.location("textures/entity/projectiles/slash/3.png"),
            Goetied.location("textures/entity/projectiles/slash/4.png")
    };
