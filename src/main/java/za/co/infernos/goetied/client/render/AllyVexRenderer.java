...
import za.co.infernos.goetied.client.render.model.MinionModel;
...
public class AllyVexRenderer extends MobRenderer<AllyVex, MinionModel<AllyVex>> {
    ...
    public static class AllyVexBandsLayer extends RenderLayer<AllyVex, MinionModel<AllyVex>> {
        private static final ResourceLocation TEXTURES = Goetied.location("textures/entity/servants/ally_vex_bands.png");
        ...
        public void render(PoseStack pMatrixStack, MultiBufferSource pBuffer, int pPackedLight, AllyVex pLivingEntity,
                ...
                float pHeadPitch) {
            if (za.co.infernos.goetied.utils.ConfigHelper.getBoolean(MobsConfig.VexTexture, false) && !pLivingEntity.isHostile()) {
