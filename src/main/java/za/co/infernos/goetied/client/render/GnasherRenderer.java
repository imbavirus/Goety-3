...
import za.co.infernos.goetied.client.render.model.GnasherModel;
...
public class GnasherRenderer extends MobRenderer<Gnasher, GnasherModel<Gnasher>> {
    protected static final ResourceLocation TEXTURE = Goetied.location("textures/entity/servants/gnasher/gnasher.png");
    ...
    protected void setupRotations(Gnasher p_115828_, PoseStack p_115829_, float p_115830_, float p_115831_, float p_115832_, float p_115833_) {
        super.setupRotations(p_115828_, p_115829_, p_115830_, p_115831_, p_115832_, p_115833_);
        float f = 1.0F;
        float f1 = 1.0F;
