...
import za.co.infernos.goetied.common.entities.ally.illager.GeomancerServant;
...
public class GeomancerServantRenderer<T extends GeomancerServant> extends MobRenderer<T, GeomancerModel<T>> {
    protected static final ResourceLocation TEXTURE = Goetied.location("textures/entity/servants/illager/geomancer.png");
    protected static final ResourceLocation ORIGINAL = Goetied.location("textures/entity/servants/illager/geomancer_original.png");
    ...
    public ResourceLocation getTextureLocation(T entity) {
        if (entity.isHostile() || !za.co.infernos.goetied.utils.ConfigHelper.getBoolean(MobsConfig.GeomancerServantTexture, false)){
            return ORIGINAL;
        } else {
            return TEXTURE;
        }
