...
import za.co.infernos.goetied.common.magic.spells.wild.GrappleSpell;
...
public class VineHookRenderer extends EntityRenderer<VineHook> {
    private static final ResourceLocation GRAPPLE_LOCATION = Goetied.location("textures/entity/vine_grapple.png");
    private static final ResourceLocation GRAPPLE_NETHER_LOCATION = Goetied.location("textures/entity/vine_grapple_nether.png");
    private static final ResourceLocation GRAPPLE_END_LOCATION = Goetied.location("textures/entity/vine_grapple_end.png");
    private static final ResourceLocation TEXTURE_LOCATION = Goetied.location("textures/entity/projectiles/grapple_hook.png");
