...
import za.co.infernos.goetied.client.render.model.GulfTentacleModel;
...
public class GulfTentacleRenderer<T extends GulfTentacle> extends MobRenderer<T, GulfTentacleModel<T>> {
    protected static final ResourceLocation TEXTURE = Goetied.location("textures/entity/projectiles/gulf_tentacle.png");
