...
public class GuardianLaserRenderer {
    ...
    public static void renderLaser(RenderLevelStageEvent event, Player player, float ticks) {
        ...
        render(player, event.getPartialTick().getGameTimeDeltaPartialTick(true), event.getPoseStack(), buffer);
    }
    ...
    public static void render(Player player, float partialTick, PoseStack poseStack, MultiBufferSource pBuffer) {
        ...
        if (entity instanceof LivingEntity livingentity) {
            ...
            int CastTime = player.getUseItem().getUseDuration(player) - count;
    ...
    public static float getAttackAnimationScale(float time, float p_32813_) {
        return (time + p_32813_) / (float) za.co.infernos.goetied.utils.ConfigHelper.getInt(SpellConfig.PrismaBeamDuration, 0);
    }
    ...
    private static void vertex(VertexConsumer p_253637_, Matrix4f p_253920_, Matrix3f p_253881_, float p_253994_,
            ...
            float p_253939_) {
        p_253637_.addVertex(p_253920_, p_253994_, p_254492_, p_254474_).setColor(p_254080_, p_253655_, p_254133_, 255)
                .setUv(p_254233_, p_253939_).setOverlay(OverlayTexture.NO_OVERLAY).setLight(15728880)
                .setNormal(p_253881_.m00(), p_253881_.m01(), p_253881_.m02());
    }
}
