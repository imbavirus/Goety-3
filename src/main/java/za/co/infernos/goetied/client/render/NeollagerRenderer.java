...
import za.co.infernos.goetied.common.entities.ally.illager.Neollager;
...
public class NeollagerRenderer extends MobRenderer<Neollager, IllagerServantModel<Neollager>> {
    protected static final ResourceLocation TEXTURE = Goetied.location("textures/entity/servants/illager/neollager.png");
    protected static final ResourceLocation MAGIC = Goetied.location("textures/entity/servants/illager/neollager_magic.png");
