...
import za.co.infernos.goetied.client.render.model.TallSkullModel;
import za.co.infernos.goetied.common.blocks.TallSkullBlock;
import za.co.infernos.goetied.common.blocks.WallTallSkullBlock;
import za.co.infernos.goetied.common.blocks.entities.TallSkullBlockEntity;
...
public class TallSkullBlockEntityRenderer implements BlockEntityRenderer<TallSkullBlockEntity> {
    protected static final ResourceLocation TEXTURE = Goetied.location("textures/entity/servants/skeleton/skeleton_villager_servant.png");
