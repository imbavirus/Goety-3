...
import za.co.infernos.goetied.client.render.animation.VizierAnimations;
...
public class VizierModel extends HierarchicalModel<Vizier> implements ArmedModel, HeadedModel {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition head = main.addOrReplaceChild("head",
                CubeListBuilder.create().texOffs(0, 0)
                        ...
                        .texOffs(0, 81).addBox(-5.0F, -3.0F, -4.0F, 10.0F, 4.0F, 9.0F, new CubeDeformation(0.0F)),
                PartPose.offset(0.0F, 0.0F, 0.0F));

        PartDefinition right_eyebrow = head.addOrReplaceChild("right_eyebrow",
                CubeListBuilder.create().texOffs(0, 0).mirror()
                        .addBox(-1.0F, -1.5F, -4.9F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false)
                        .texOffs(0, 2).addBox(-1.0F, -2.5F, -4.9F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
                PartPose.offset(-3.0F, -3.5F, 0.0F));

        PartDefinition left_eyebrow = head.addOrReplaceChild("left_eyebrow",
                CubeListBuilder.create().texOffs(0, 0)
                        .addBox(-2.0F, -1.5F, -4.9F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                        .texOffs(0, 2).addBox(-1.0F, -2.5F, -4.9F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
                PartPose.offset(3.0F, -3.5F, 0.0F));
        ...
        PartDefinition left_eye = head.addOrReplaceChild("left_eye", CubeListBuilder.create().texOffs(0, 4).addBox(
                -0.5F, -0.5F, 0.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(1.5F, -3.5F, -4.05F));
        ...
        PartDefinition Hat = head.addOrReplaceChild("Hat", CubeListBuilder.create().texOffs(0, 64).addBox(-5.0F, -13.0F,
                -5.0F, 10.0F, 7.0F, 10.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));

        PartDefinition mustache = head.addOrReplaceChild("mustache", CubeListBuilder.create().texOffs(35, 0).addBox(
                -6.0F, -5.0F, -4.1F, 12.0F, 6.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));
        ...
        PartDefinition arms = body.addOrReplaceChild("arms", CubeListBuilder.create().texOffs(44, 22)
        ...
        PartDefinition rightArm = body.addOrReplaceChild("rightArm", CubeListBuilder.create().texOffs(40, 46).addBox(
        ...
        PartDefinition leftArm = body.addOrReplaceChild("leftArm", CubeListBuilder.create().texOffs(40, 46).addBox(
                -1.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(5.0F, 2.0F, 0.0F));

        PartDefinition leg0 = main.addOrReplaceChild("leg0", CubeListBuilder.create().texOffs(0, 22).addBox(-2.0F, 0.0F,
                -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(-2.0F, 12.0F, 0.0F));

        PartDefinition leg1 = main.addOrReplaceChild("leg1", CubeListBuilder.create().texOffs(0, 22).addBox(-2.0F, 0.0F,
                -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(2.0F, 12.0F, 0.0F));

        PartDefinition cape = partdefinition.addOrReplaceChild("cape", CubeListBuilder.create().texOffs(44, 62).addBox(
                -4.0F, 0.0F, -0.5F, 8.0F, 20.0F, 1.0F, new CubeDeformation(0.5F)), PartPose.offset(0.0F, 0.0F, 3.5F));

        return LayerDefinition.create(meshdefinition, 64, 128);
    }

    @Override
    public void setupAnim(Vizier entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw,
            float headPitch) {
    ...
    public void renderCape(PoseStack pMatrixStack, VertexConsumer pBuffer, int pPackedLight, int pPackedOverlay) {
        this.cape.render(pMatrixStack, pBuffer, pPackedLight, pPackedOverlay, -1);
    }
