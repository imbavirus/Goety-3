...
import za.co.infernos.goetied.client.render.model.SpecterModel;
import za.co.infernos.goetied.common.entities.neutral.Specter;
...
public class SpecterRenderer<T extends Specter> extends MobRenderer<T, SpecterModel<T>> {
    protected static final ResourceLocation TEXTURE = Goetied.location("textures/entity/specter/specter.png");
