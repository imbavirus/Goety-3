...
import za.co.infernos.goetied.client.render.model.CycloneModel;
...
public class FireTornadoRenderer extends EntityRenderer<FireTornado> {
    private static final ResourceLocation TEXTURES = ResourceLocation.fromNamespaceAndPath(Goetied.MOD_ID, "textures/entity/servants/fire_tornado.png");
