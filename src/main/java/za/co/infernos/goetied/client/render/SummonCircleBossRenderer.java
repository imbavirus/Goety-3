...
import za.co.infernos.goetied.client.render.model.SummonCircleBossModel;
...
public class SummonCircleBossRenderer extends EntityRenderer<SummonCircleBoss> {
    private static final ResourceLocation TEXTURES = Goetied.location("textures/entity/boss_summon.png");
