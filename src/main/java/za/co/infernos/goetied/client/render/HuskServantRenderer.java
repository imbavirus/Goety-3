...
public class HuskServantRenderer extends ZombieServantRenderer {
   protected static final ResourceLocation TEXTURE = Goetied.location("textures/entity/servants/zombie/husk_servant.png");
   ...
   public ResourceLocation getTextureLocation(ZombieServant p_114905_) {
      if (p_114905_.isHostile() || !za.co.infernos.goetied.utils.ConfigHelper.getBoolean(MobsConfig.HuskServantTexture, false)){
