...
import za.co.infernos.goetied.client.render.model.PhantomServantModel;
...
public class PhantomServantRenderer extends MobRenderer<PhantomServant, PhantomServantModel<PhantomServant>> {
    protected static final ResourceLocation TEXTURE = Goetied.location("textures/entity/servants/phantom_servant.png");
    ...
    public ResourceLocation getTextureLocation(PhantomServant p_114482_) {
        if (p_114482_.isHostile() || !za.co.infernos.goetied.utils.ConfigHelper.getBoolean(MobsConfig.PhantomServantTexture, false)){
