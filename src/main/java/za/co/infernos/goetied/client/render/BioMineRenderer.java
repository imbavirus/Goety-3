...
import za.co.infernos.goetied.client.render.model.BioMineModel;
import za.co.infernos.goetied.common.entities.projectiles.BioMine;
...
public class BioMineRenderer<T extends BioMine> extends LayeredEntityRenderer<T, BioMineModel<T>> {
    ...
    public ResourceLocation getTextureLocation(T entity) {
        return Goetied.location("textures/entity/projectiles/biomine/" + entity.level().getGameTime() % 19 + ".png");
    }

    public static class GlowLayer<T extends BioMine, M extends BioMineModel<T>> extends RenderLayer<T, M> {
        private static final ResourceLocation TEXTURE = Goetied.location("textures/entity/projectiles/biomine/glow.png");
        protected M model;
        ...
        public void render(PoseStack p_116970_, MultiBufferSource p_116971_, int p_116972_, T pEntity, float p_116974_,
                float p_116975_, float pPartialTicks, float p_116977_, float p_116978_, float p_116979_) {
            p_116970_.pushPose();
