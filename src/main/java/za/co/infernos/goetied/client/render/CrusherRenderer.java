...
import za.co.infernos.goetied.common.entities.hostile.illagers.Crusher;
...
public class CrusherRenderer<T extends Crusher> extends MobRenderer<T, CrusherModel<T>> {
    protected static final ResourceLocation TEXTURE = Goetied.location("textures/entity/illagers/crusher.png");
    protected static final ResourceLocation STORM = Goetied.location("textures/entity/illagers/crusher_storm.png");
