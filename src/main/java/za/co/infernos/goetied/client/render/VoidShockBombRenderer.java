...
import za.co.infernos.goetied.client.render.model.VoidShockBombModel;
...
public class VoidShockBombRenderer extends EntityRenderer<VoidShockBomb> {
    ...
    private static final ResourceLocation TRAIL_TEXTURE = Goetied.location("textures/entity/projectiles/trail.png");
