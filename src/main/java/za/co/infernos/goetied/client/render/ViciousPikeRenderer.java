...
import za.co.infernos.goetied.client.render.model.ViciousPikeModel;
import za.co.infernos.goetied.common.entities.projectiles.ViciousPike;
...
public class ViciousPikeRenderer extends EntityRenderer<ViciousPike> {
    private static final ResourceLocation TEXTURE = Goetied.location("textures/entity/projectiles/vicious_pike.png");
    ...
    public void render(ViciousPike pEntity, float entityYaw, float pPartialTicks, PoseStack pMatrixStack,
