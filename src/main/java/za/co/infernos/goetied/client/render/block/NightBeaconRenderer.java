...
import za.co.infernos.goetied.common.blocks.entities.NightBeaconBlockEntity;
...
public class NightBeaconRenderer implements BlockEntityRenderer<NightBeaconBlockEntity> {
    public static final ResourceLocation BEAM_LOCATION = Goetied.location("textures/entity/night_beacon_beam.png");
