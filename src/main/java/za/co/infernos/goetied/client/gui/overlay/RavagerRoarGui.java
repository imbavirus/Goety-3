...
public class RavagerRoarGui {
    ...
    public static final ResourceLocation LAYER_ID = Goetied.location("ravager_roar_hud");
    ...
    public static void drawHUD(GuiGraphics guiGraphics, DeltaTracker partialTick, int screenWidth, int screenHeight) {
        ...
        int height = screenHeight + (za.co.infernos.goetied.utils.ConfigHelper.getInt(MainConfig.SoulGuiVertical, 0) - 20);
        guiGraphics.blit(Goetied.location("textures/gui/ravager_roar_bar.png"), i, height - 9, 0, 0, 96,16, 96, 32);
        guiGraphics.blit(Goetied.location("textures/gui/ravager_roar_bar.png"), i + 16, height - 9, 16, 16, roarLength,16, 96, 32);
    }
}