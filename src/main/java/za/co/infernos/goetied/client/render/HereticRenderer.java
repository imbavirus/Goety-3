...
import za.co.infernos.goetied.client.render.model.HereticModel;
...
public class HereticRenderer extends MobRenderer<Heretic, HereticModel<Heretic>> {
   private static final ResourceLocation WITCH_LOCATION = Goetied.location("textures/entity/cultist/heretic.png");
