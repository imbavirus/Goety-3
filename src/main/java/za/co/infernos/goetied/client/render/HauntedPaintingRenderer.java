...
import za.co.infernos.goetied.client.render.model.HauntedPaintingModel;
...
public class HauntedPaintingRenderer extends EntityRenderer<HauntedPainting> {
   public static final ResourceLocation SMALL_FRAME_TEXTURE = Goetied.location("textures/painting/frame/small.png");
   public static final ResourceLocation MEDIUM_FRAME_TEXTURE = Goetied.location("textures/painting/frame/medium.png");
   public static final ResourceLocation LARGE_FRAME_TEXTURE = Goetied.location("textures/painting/frame/large.png");
   public static final ResourceLocation WIDE_FRAME_TEXTURE = Goetied.location("textures/painting/frame/wide.png");
   public static final ResourceLocation TALL_FRAME_TEXTURE = Goetied.location("textures/painting/frame/tall.png");
   ...
   public ResourceLocation getTextureLocation(HauntedPainting entity) {
      return Goetied.location("textures/painting/" + entity.getVariant().unwrapKey().get().location().getPath() + ".png");
   }
