...
import za.co.infernos.goetied.client.render.model.CarrionFlyModel;
...
public class CarrionFlyRenderer extends MobRenderer<CarrionFly, CarrionFlyModel<CarrionFly>> {
   private static final ResourceLocation TEXTURES = Goetied.location("textures/entity/wight/carrion_fly.png");
   ...
   public static class FlyEyesLayer<T extends CarrionFly, M extends CarrionFlyModel<T>> extends EyesLayer<T, M> {
      private static final RenderType EYES = RenderType.eyes(Goetied.location("textures/entity/wight/carrion_fly_eyes.png"));
