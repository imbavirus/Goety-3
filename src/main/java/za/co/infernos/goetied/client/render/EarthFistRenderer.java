...
import za.co.infernos.goetied.client.render.model.EarthFistModel;
...
public class EarthFistRenderer extends EntityRenderer<EarthFist> {
    private static final ResourceLocation TEXTURE = Goetied.location("textures/entity/projectiles/earth_fist.png");
