...
public class BorderWraithServantRenderer<T extends AbstractWraith> extends AbstractWraithRenderer<T> {
    protected static final ResourceLocation TEXTURE = Goetied.location("textures/entity/wraith/border_wraith.png");
    ...
    public static class GlowLayer<T extends Mob, M extends WraithModel<T>> extends EyesLayer<T, M> {
        private static final RenderType RENDER_TYPE = ModRenderType.wraith(Goetied.location("textures/entity/wraith/border_wraith_glow.png"));
