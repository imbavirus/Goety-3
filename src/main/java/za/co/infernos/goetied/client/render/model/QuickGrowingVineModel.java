...
import za.co.infernos.goetied.client.render.animation.QuickGrowingVineAnimations;
...
public class QuickGrowingVineModel<T extends QuickGrowingVine> extends HierarchicalModel<T> {
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int color) {
		this.vine.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
	}
