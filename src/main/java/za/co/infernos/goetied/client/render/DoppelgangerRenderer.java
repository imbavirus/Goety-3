...
import za.co.infernos.goetied.client.render.layer.IllusionCapeLayer;
import za.co.infernos.goetied.client.render.layer.NamelessSetLayer;
...
public class DoppelgangerRenderer extends HumanoidMobRenderer<Doppelganger, PlayerModel<Doppelganger>> {
    ...
    private static final ResourceLocation TEXTURE = Goetied.location("textures/entity/lich.png");
