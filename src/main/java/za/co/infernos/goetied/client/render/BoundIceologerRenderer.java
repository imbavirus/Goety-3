...
public class BoundIceologerRenderer<T extends BoundIceologer> extends MobRenderer<T, IceologerModel<T>> {
    protected static final ResourceLocation TEXTURE = Goetied.location("textures/entity/servants/bound_illager/bound_iceologer.png");
    protected static final ResourceLocation CASTING = Goetied.location("textures/entity/servants/bound_illager/bound_iceologer_casting.png");
