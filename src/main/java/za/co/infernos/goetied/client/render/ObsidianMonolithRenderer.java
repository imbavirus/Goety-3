...
import za.co.infernos.goetied.client.render.model.MonolithModel;
...
public class ObsidianMonolithRenderer<T extends AbstractMonolith> extends AbstractMonolithRenderer<T> implements RenderLayerParent<T, MonolithModel<T>>{
    private static final ResourceLocation TEXTURE_LOCATION = Goetied.location("textures/entity/monolith/obsidian_monolith.png");
    private static final RenderType RENDER_TYPE = RenderType.eyes(Goetied.location("textures/entity/monolith/obsidian_monolith_glow.png"));
    private static final Map<AbstractMonolith.Crackiness, ResourceLocation> resourceLocations = ImmutableMap.of(AbstractMonolith.Crackiness.LOW, Goetied.location("textures/entity/monolith/obsidian_monolith_crack_1.png"), AbstractMonolith.Crackiness.MEDIUM, Goetied.location("textures/entity/monolith/obsidian_monolith_crack_2.png"), AbstractMonolith.Crackiness.HIGH, Goetied.location("textures/entity/monolith/obsidian_monolith_crack_3.png"));
    private static final ResourceLocation RESOURCE_LOCATION = Goetied.location("textures/entity/monolith/obsidian_monolith_beam.png");
    ...
    public static class OMShieldLayer<T extends AbstractMonolith> extends RenderLayer<T, MonolithModel<T>> {
        private static final ResourceLocation TEXTURE = Goetied.location("textures/entity/monolith/obsidian_monolith_shield.png");
