...
import za.co.infernos.goetied.client.render.model.ScatterMineModel;
...
public class ScatterMineRenderer<T extends ScatterMine> extends EntityRenderer<T> {
    private static final ResourceLocation TEXTURE = Goetied.location("textures/entity/projectiles/scatter_mine.png");
    private static final ResourceLocation GLOW = Goetied.location("textures/entity/projectiles/scatter_mine_glow.png");
    private static final ResourceLocation GLOW_SPELL = Goetied
            .location("textures/entity/projectiles/scatter_mine_glow_spell.png");
    private static final ResourceLocation EXPLODE = Goetied
