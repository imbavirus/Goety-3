...
import za.co.infernos.goetied.common.entities.ally.spider.IcySpiderServant;
...
public class IcySpiderServantRenderer<T extends IcySpiderServant> extends MobRenderer<T, ModSpiderModel<T>> {
   private static final ResourceLocation HOSTILE_LOCATION = Goetied.location("textures/entity/servants/spider/icy_spider.png");
   private static final ResourceLocation SPIDER_LOCATION = Goetied.location("textures/entity/servants/spider/icy_spider_servant.png");
   ...
   public ResourceLocation getTextureLocation(IcySpiderServant p_113972_) {
      if (p_113972_.isHostile() || !za.co.infernos.goetied.utils.ConfigHelper.getBoolean(MobsConfig.IcySpiderServantTexture, false)){
   ...
   public static class SpiderEyesLayer<T extends Entity, M extends ModSpiderModel<T>> extends EyesLayer<T, M> {
      private static final RenderType SPIDER_EYES = RenderType.eyes(Goetied.location("textures/entity/servants/spider/icy_spider_servant_eyes.png"));
