...
import za.co.infernos.goetied.client.render.model.VindicatorChefModel;
import za.co.infernos.goetied.common.entities.ally.illager.VindicatorChefServant;
...
public class VindicatorChefServantRenderer<T extends VindicatorChefServant> extends MobRenderer<T, VindicatorChefModel<T>> {
    protected static final ResourceLocation TEXTURE = Goetied.location("textures/entity/servants/illager/vindicator_chef.png");
    protected static final ResourceLocation ORIGINAL = Goetied.location("textures/entity/servants/illager/vindicator_chef_original.png");
    ...
    public ResourceLocation getTextureLocation(T entity) {
        if (entity.isHostile() || !za.co.infernos.goetied.utils.ConfigHelper.getBoolean(MobsConfig.VindicatorServantTexture, false)){
            return ORIGINAL;
        } else {
            return TEXTURE;
        }
