...
import za.co.infernos.goetied.client.render.*;
import za.co.infernos.goetied.client.render.block.ArcaRenderer;
import za.co.infernos.goetied.client.render.block.CursedInfuserRenderer;
import za.co.infernos.goetied.common.blocks.entities.ModBlockEntities;
import za.co.infernos.goetied.common.items.FlameCaptureItem;
import za.co.infernos.goetied.common.items.ModItems;
import za.co.infernos.goetied.common.items.magic.InfernalTome;
import za.co.infernos.goetied.client.render.block.BlackCrystalRenderer;
import za.co.infernos.goetied.client.render.block.CryptChestRenderer;
import za.co.infernos.goetied.client.render.block.LoftyChestRenderer;
import za.co.infernos.goetied.client.render.block.ModBlockLayer;
...
import za.co.infernos.goetied.client.gui.overlay.CurrentFocusGui;
import za.co.infernos.goetied.client.gui.screen.inventory.BrewBagScreen;
import za.co.infernos.goetied.client.gui.screen.inventory.DarkAnvilScreen;
import za.co.infernos.goetied.client.gui.screen.inventory.FocusBagScreen;
import za.co.infernos.goetied.client.gui.screen.inventory.FocusPackScreen;
import za.co.infernos.goetied.client.gui.screen.inventory.SoulItemScreen;
import za.co.infernos.goetied.client.inventory.container.ModContainerType;

@EventBusSubscriber(modid = Goetied.MOD_ID, bus = EventBusSubscriber.Bus.MOD, value = Dist.CLIENT)
public class ClientInitEvents {
    ...
    public static void clientInit(FMLClientSetupEvent event) {
        event.enqueueWork(() -> {
            ...
            ItemProperties.register(
                    ...
                    ResourceLocation.fromNamespaceAndPath(Goetied.MOD_ID, "capture"),
    ...
    public static void registerLayerDefinitions(EntityRenderersEvent.RegisterLayerDefinitions event) {
        ...
        event.registerLayerDefinition(ModModelLayer.createBoatModelName(za.co.infernos.goetied.common.entities.vehicle.ModBoat.Type.HAUNTED), net.minecraft.client.model.BoatModel::createBodyModel);
        event.registerLayerDefinition(ModModelLayer.createBoatModelName(za.co.infernos.goetied.common.entities.vehicle.ModBoat.Type.ROTTEN), net.minecraft.client.model.BoatModel::createBodyModel);
        event.registerLayerDefinition(ModModelLayer.createBoatModelName(za.co.infernos.goetied.common.entities.vehicle.ModBoat.Type.WINDSWEPT), net.minecraft.client.model.BoatModel::createBodyModel);
        event.registerLayerDefinition(ModModelLayer.createBoatModelName(za.co.infernos.goetied.common.entities.vehicle.ModBoat.Type.PINE), net.minecraft.client.model.BoatModel::createBodyModel);
        event.registerLayerDefinition(ModModelLayer.createBoatModelName(za.co.infernos.goetied.common.entities.vehicle.ModBoat.Type.CHORUS), net.minecraft.client.model.BoatModel::createBodyModel);
        event.registerLayerDefinition(ModModelLayer.createBoatModelName(za.co.infernos.goetied.common.entities.vehicle.ModBoat.Type.CORRUPT_CHORUS), net.minecraft.client.model.BoatModel::createBodyModel);
        
        // Register chest boat model layers for all boat types
        event.registerLayerDefinition(ModModelLayer.createChestBoatModelName(za.co.infernos.goetied.common.entities.vehicle.ModBoat.Type.HAUNTED), net.minecraft.client.model.ChestBoatModel::createBodyModel);
        event.registerLayerDefinition(ModModelLayer.createChestBoatModelName(za.co.infernos.goetied.common.entities.vehicle.ModBoat.Type.ROTTEN), net.minecraft.client.model.ChestBoatModel::createBodyModel);
        event.registerLayerDefinition(ModModelLayer.createChestBoatModelName(za.co.infernos.goetied.common.entities.vehicle.ModBoat.Type.WINDSWEPT), net.minecraft.client.model.ChestBoatModel::createBodyModel);
        event.registerLayerDefinition(ModModelLayer.createChestBoatModelName(za.co.infernos.goetied.common.entities.vehicle.ModBoat.Type.PINE), net.minecraft.client.model.ChestBoatModel::createBodyModel);
        event.registerLayerDefinition(ModModelLayer.createChestBoatModelName(za.co.infernos.goetied.common.entities.vehicle.ModBoat.Type.CHORUS), net.minecraft.client.model.ChestBoatModel::createBodyModel);
        event.registerLayerDefinition(ModModelLayer.createChestBoatModelName(za.co.infernos.goetied.common.entities.vehicle.ModBoat.Type.CORRUPT_CHORUS), net.minecraft.client.model.ChestBoatModel::createBodyModel);
    ...
    public static void registerRenderers(EntityRenderersEvent.RegisterRenderers event) {
        ...
        try {
            ...
            Goetied.LOGGER.error("Failed to register Wraith renderer", e);
        }
        try {
            event.registerEntityRenderer(ModEntityType.ICE_BOUQUET.get(), IceBouquetRenderer::new);
        } catch (Exception e) {
            Goetied.LOGGER.error("Failed to register IceBouquet renderer", e);
        }
        ...
        try {
            ...
            Goetied.LOGGER.error("Failed to register Apostle renderer", e);
        }
        try {
            event.registerEntityRenderer(ModEntityType.VIZIER.get(), VizierRenderer::new);
        } catch (Exception e) {
            Goetied.LOGGER.error("Failed to register Vizier renderer", e);
        }
        try {
            event.registerEntityRenderer(ModEntityType.ENDER_KEEPER.get(), EnderKeeperRenderer::new);
        } catch (Exception e) {
            Goetied.LOGGER.error("Failed to register EnderKeeper renderer", e);
        }
        ...
        try {
            ...
            Goetied.LOGGER.error("Failed to register BorderWraith renderer", e);
        }
        try {
            event.registerEntityRenderer(ModEntityType.MUCK_WRAITH.get(), MuckWraithRenderer::new);
        } catch (Exception e) {
            Goetied.LOGGER.error("Failed to register MuckWraith renderer", e);
        }
        try {
            event.registerEntityRenderer(ModEntityType.REAPER.get(), ReaperRenderer::new);
        } catch (Exception e) {
            Goetied.LOGGER.error("Failed to register Reaper renderer", e);
        }
        ...
        try {
            ...
            Goetied.LOGGER.error("Failed to register Warlock renderer", e);
        }
        try {
            event.registerEntityRenderer(ModEntityType.HERETIC.get(), HereticRenderer::new);
        } catch (Exception e) {
            Goetied.LOGGER.error("Failed to register Heretic renderer", e);
        }
        try {
            event.registerEntityRenderer(ModEntityType.MAVERICK.get(), MaverickRenderer::new);
        } catch (Exception e) {
            Goetied.LOGGER.error("Failed to register Maverick renderer", e);
        }
        try {
            event.registerEntityRenderer(ModEntityType.CRONE.get(), CroneRenderer::new);
        } catch (Exception e) {
            Goetied.LOGGER.error("Failed to register Crone renderer", e);
        }
        ...
        try {
            ...
            Goetied.LOGGER.error("Failed to register WebSpider renderer", e);
        }
        try {
            event.registerEntityRenderer(ModEntityType.ICY_SPIDER.get(), IcySpiderRenderer::new);
        } catch (Exception e) {
            Goetied.LOGGER.error("Failed to register IcySpider renderer", e);
        }
        try {
            event.registerEntityRenderer(ModEntityType.BONE_SPIDER.get(), BoneSpiderRenderer::new);
        } catch (Exception e) {
            Goetied.LOGGER.error("Failed to register BoneSpider renderer", e);
        }
        try {
            event.registerEntityRenderer(ModEntityType.BROOD_MOTHER.get(), BroodMotherRenderer::new);
        } catch (Exception e) {
            Goetied.LOGGER.error("Failed to register BroodMother renderer", e);
        }
        ...
        try {
            ...
            Goetied.LOGGER.error("Failed to register Watchling renderer", e);
        }
        try {
            event.registerEntityRenderer(ModEntityType.BLASTLING.get(), BlastlingRenderer::new);
        } catch (Exception e) {
            Goetied.LOGGER.error("Failed to register Blastling renderer", e);
        }
        try {
            event.registerEntityRenderer(ModEntityType.SNARELING.get(), SnarelingRenderer::new);
        } catch (Exception e) {
            Goetied.LOGGER.error("Failed to register Snareling renderer", e);
        }
        try {
            event.registerEntityRenderer(ModEntityType.ENDERSENT.get(), EndersentRenderer::new);
        } catch (Exception e) {
            Goetied.LOGGER.error("Failed to register Endersent renderer", e);
        }
        ...
        try {
            ...
            Goetied.LOGGER.error("Failed to register NecromancerServant renderer", e);
        }
        try {
            event.registerEntityRenderer(ModEntityType.CAIRN_NECROMANCER_SERVANT.get(), AbstractCairnNecromancerRenderer::new);
        } catch (Exception e) {
            Goetied.LOGGER.error("Failed to register CairnNecromancerServant renderer", e);
        }
        try {
            event.registerEntityRenderer(ModEntityType.MOSSY_NECROMANCER_SERVANT.get(), MossyNecromancerRenderer::new);
        } catch (Exception e) {
            Goetied.LOGGER.error("Failed to register MossyNecromancerServant renderer", e);
        }
        ...
        try {
            ...
            Goetied.LOGGER.error("Failed to register ModPainting renderer", e);
        }
        try {
            event.registerEntityRenderer(ModEntityType.HAUNTED_ARMOR_STAND.get(), HauntedArmorStandRenderer::new);
        } catch (Exception e) {
            Goetied.LOGGER.error("Failed to register HauntedArmorStand renderer", e);
        }
        try {
            event.registerEntityRenderer(ModEntityType.FALLING_BLOCK.get(), ModFallingBlockRenderer::new);
        } catch (Exception e) {
            Goetied.LOGGER.error("Failed to register FallingBlock renderer", e);
        }
        ...
        try {
            ...
            Goetied.LOGGER.error("Failed to register ModBoat renderer", e);
        }
        try {
            event.registerEntityRenderer(ModEntityType.MOD_CHEST_BOAT.get(), (ctx) -> new ModBoatRenderer(ctx, true));
        } catch (Exception e) {
            Goetied.LOGGER.error("Failed to register ModChestBoat renderer", e);
        }
        ...
        try {
            ...
            Goetied.LOGGER.error("Failed to register MiniGhast renderer", e);
        }
        ...
        try {
            ...
            Goetied.LOGGER.error("Failed to register LightningTrap renderer", e);
        }
        try {
            event.registerEntityRenderer(ModEntityType.MAGIC_LIGHTNING_TRAP.get(), TrapRenderer::new);
        } catch (Exception e) {
            Goetied.LOGGER.error("Failed to register MagicLightningTrap renderer", e);
        }
        try {
            event.registerEntityRenderer(ModEntityType.VOID_LIGHTNING_TRAP.get(), TrapRenderer::new);
        } catch (Exception e) {
            Goetied.LOGGER.error("Failed to register VoidLightningTrap renderer", e);
        }
        try {
            event.registerEntityRenderer(ModEntityType.FIRE_RAIN_TRAP.get(), TrapRenderer::new);
        } catch (Exception e) {
            Goetied.LOGGER.error("Failed to register FireRainTrap renderer", e);
        }
