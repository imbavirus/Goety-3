...
/**
 * Registers every painting referenced by {@code goetied:placeable} (and other painting tags).
 * Missing registrations caused TagLoader errors for goetied:apostle, goetied:movie, etc.
 */
public class ModPaintings {
    public static final DeferredRegister<PaintingVariant> PAINTING_VARIANTS =
            DeferredRegister.create(Registries.PAINTING_VARIANT, Goetied.MOD_ID);
    ...
    private static DeferredHolder<PaintingVariant, PaintingVariant> register(String name, int width, int height) {
        return PAINTING_VARIANTS.register(name, () -> new PaintingVariant(width, height, Goetied.location(name)));
    }
