...
import za.co.infernos.goetied.common.entities.ai.attributes.SpellAttribute;
...
public class ModAttributes {
    private static final DeferredRegister<Attribute> ATTRIBUTES = DeferredRegister.create(Registries.ATTRIBUTE, Goetied.MOD_ID);

    public static void init(){
        ATTRIBUTES.register(FMLJavaModLoadingContext.get().getModEventBus());
    }

    public static final DeferredHolder<Attribute, Attribute> SPELL_POTENCY = ATTRIBUTES.register("spell_potency", () -> (new RangedAttribute("attribute.name.goetied.spell_potency", 0.0D, 0.0D, 2048.0D).setSyncable(true)));
    public static final DeferredHolder<Attribute, Attribute> SPELL_DURATION = ATTRIBUTES.register("spell_duration", () -> (new RangedAttribute("attribute.name.goetied.spell_duration", 0.0D, 0.0D, 2048.0D).setSyncable(true)));
    public static final DeferredHolder<Attribute, Attribute> SPELL_RANGE = ATTRIBUTES.register("spell_range", () -> (new RangedAttribute("attribute.name.goetied.spell_range", 0.0D, 0.0D, 2048.0D).setSyncable(true)));
    public static final DeferredHolder<Attribute, Attribute> SPELL_RADIUS = ATTRIBUTES.register("spell_radius", () -> (new RangedAttribute("attribute.name.goetied.spell_radius", 0.0D, 0.0D, 2048.0D).setSyncable(true)));
    public static final DeferredHolder<Attribute, Attribute> SPELL_BURNING = ATTRIBUTES.register("spell_burning", () -> (new RangedAttribute("attribute.name.goetied.spell_burning", 0.0D, 0.0D, 2048.0D).setSyncable(true)));
    public static final DeferredHolder<Attribute, Attribute> SPELL_VELOCITY = ATTRIBUTES.register("spell_velocity", () -> (new RangedAttribute("attribute.name.goetied.spell_velocity", 0.0D, 0.0D, 2048.0D).setSyncable(true)));
    public static final DeferredHolder<Attribute, Attribute> CASTING_SPEED = ATTRIBUTES.register("casting_speed", () -> (new RangedAttribute("attribute.name.goetied.casting_speed", 0.0D, -1.0D, 1.0D).setSyncable(true)));
    public static final DeferredHolder<Attribute, Attribute> COOLDOWN_DISCOUNT = ATTRIBUTES.register("cooldown_discount", () -> (new RangedAttribute("attribute.name.goetied.cooldown_discount", 0.0D, -1.0D, 1.0D).setSyncable(true)));
    public static final DeferredHolder<Attribute, Attribute> SOUL_DISCOUNT = ATTRIBUTES.register("soul_discount", () -> (new RangedAttribute("attribute.name.goetied.soul_discount", 0.0D, -1.0D, 1.0D).setSyncable(true)));
