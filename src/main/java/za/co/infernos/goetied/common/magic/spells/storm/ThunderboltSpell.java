...
public class ThunderboltSpell extends Spell {
    ...
    public int defaultSoulCost() {
        return za.co.infernos.goetied.utils.ConfigHelper.getInt(SpellConfig.ThunderboltCost, 0);
    }

    @Override
    public int defaultCastDuration() {
        return za.co.infernos.goetied.utils.ConfigHelper.getInt(SpellConfig.ThunderboltDuration, 0);
    }
    ...
    public int defaultSpellCooldown() {
        return za.co.infernos.goetied.utils.ConfigHelper.getInt(SpellConfig.ThunderboltCoolDown, 0);
    }
    ...
    public void SpellResult(ServerLevel worldIn, LivingEntity caster, ItemStack staff, SpellStat spellStat) {
        ...
        float damage = za.co.infernos.goetied.utils.ConfigHelper.getFloat(SpellConfig.ThunderboltDamage, 1.0F) * WandUtil.damageMultiply();
            ...
            if (livingEntity != null) {
                ...
                if (livingEntity.hurt(ModDamageSource.directShock(caster), damage)){
                    ...
                    if (worldIn.random.nextFloat() <= chance){
                        livingEntity.addEffect(new MobEffectInstance(GoetiedEffects.SPASMS, MathHelper.secondsToTicks(5)));
                    }
                    if (rightStaff(staff)){
