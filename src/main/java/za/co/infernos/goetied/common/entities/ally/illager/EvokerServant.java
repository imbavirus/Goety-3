...
import za.co.infernos.goetied.common.entities.ally.undead.bound.BoundEvoker;
...
public class EvokerServant extends SpellcasterIllagerServant{
    ...
    public static AttributeSupplier.Builder setCustomAttributes() {
        return Monster.createMonsterAttributes()
                ...
                .add(Attributes.FOLLOW_RANGE, za.co.infernos.goetied.utils.ConfigHelper.getDouble(AttributesConfig.EvokerServantFollowRange, 20.0D))
                .add(Attributes.ARMOR, za.co.infernos.goetied.utils.ConfigHelper.getDouble(AttributesConfig.EvokerServantArmor, 20.0D))
                .add(Attributes.MAX_HEALTH, za.co.infernos.goetied.utils.ConfigHelper.getDouble(AttributesConfig.EvokerServantHealth, 20.0D));
    }

    public void setConfigurableAttributes(){
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.MAX_HEALTH), za.co.infernos.goetied.utils.ConfigHelper.getDouble(AttributesConfig.EvokerServantHealth, 20.0D));
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.ARMOR), za.co.infernos.goetied.utils.ConfigHelper.getDouble(AttributesConfig.EvokerServantArmor, 20.0D));
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.FOLLOW_RANGE), za.co.infernos.goetied.utils.ConfigHelper.getDouble(AttributesConfig.EvokerServantFollowRange, 20.0D));
    }
    ...
    class EvokerSummonSpellGoal extends SpellcasterUseSpellGoal {
        private static final ResourceLocation TEXTURE_LOCATION = ResourceLocation.fromNamespaceAndPath("goetied", "textures/entity/projectiles/fangs.png");
        ...
        protected void performSpellCasting() {
            ...
            for(int i = 0; i < 3; ++i) {
                ...
                if (vex != null) {
                    ...
                    vex.finalizeSpawn(serverlevel, EvokerServant.this.level().getCurrentDifficultyAt(blockpos), MobSpawnType.MOB_SUMMONED, null);
    ...
    public class EvokerWololoSpellGoal extends SpellcasterUseSpellGoal {
        ...
        public boolean canUse() {
            if (EvokerServant.this.getTarget() != null) {
                ...
                return false;
            } else if (!EvokerServant.this.level().getGameRules().getBoolean(GameRules.RULE_MOBGRIEFING)) {
                return false;
            } else {
    ...
    public class EvokerRavagingSpellGoal extends SpellcasterUseSpellGoal {
        ...
        protected void performSpellCasting() {
            ...
            if (victim != null && victim.isAlive()) {
                ...
                EvokerServant.this.ravageCool = MathHelper.secondsToTicks(za.co.infernos.goetied.utils.ConfigHelper.getInt(MobsConfig.EvokerServantRavagedCooldown, 1200));
                for (EvokerServant evokerServant : this.otherEvokers()) {
                    evokerServant.ravageCool = MathHelper.secondsToTicks(za.co.infernos.goetied.utils.ConfigHelper.getInt(MobsConfig.EvokerServantRavagedCooldown, 1200));
                }
            }
