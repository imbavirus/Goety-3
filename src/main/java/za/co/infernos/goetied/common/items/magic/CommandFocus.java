...
import za.co.infernos.goetied.common.magic.spells.utility.CommandSpell;
...
public class CommandFocus extends MagicFocus {
    ...
    public static void addCommandText(Level level, ItemStack stack, List<Component> tooltip) {
        ...
        if (servant != null) {
            tooltip.add(Component.translatable("info.goetied.focus.target").append(": ").append(servant.getDisplayName()));
        }
    }
}
