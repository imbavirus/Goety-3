...
public class EndGrowthFeature extends Feature<NetherForestVegetationConfig> {
    public EndGrowthFeature(Codec<NetherForestVegetationConfig> p_66361_) {
        super(p_66361_);
    }
    ...
    public boolean place(FeaturePlaceContext<NetherForestVegetationConfig> p_160068_) {
        ...
        if (!blockstate.is(ModTags.Blocks.END_GROWTH_BLOCKS)) {
            return false;
        } else {
            int i = blockpos.getY();
