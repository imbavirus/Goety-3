...
public class SummonCircleVariant extends Entity {
    ...
    public static final Map<Integer, ResourceLocation> TEXTURE_BY_TYPE = Util.make(Maps.newHashMap(), (map) -> {
        map.put(0, Goetied.location("textures/entity/summon_earth/1.png"));
        map.put(1, Goetied.location("textures/entity/summon_earth/2.png"));
        map.put(2, Goetied.location("textures/entity/summon_earth/3.png"));
        map.put(3, Goetied.location("textures/entity/summon_earth/4.png"));
        map.put(4, Goetied.location("textures/entity/summon_earth/5.png"));
        map.put(5, Goetied.location("textures/entity/summon_earth/6.png"));
        map.put(6, Goetied.location("textures/entity/summon_earth/7.png"));
        map.put(7, Goetied.location("textures/entity/summon_earth/8.png"));
        map.put(8, Goetied.location("textures/entity/summon_earth/9.png"));
        map.put(9, Goetied.location("textures/entity/summon_earth/10.png"));
    });
