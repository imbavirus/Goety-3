package za.co.infernos.goetied.common.entities;
...
import za.co.infernos.goetied.common.entities.deco.HauntedPainting;
...
import za.co.infernos.goetied.common.entities.vehicle.ModBoat;
import za.co.infernos.goetied.common.entities.vehicle.ModChestBoat;
...
public class ModEntityType {
    public static final DeferredRegister<EntityType<?>> ENTITY_TYPE = DeferredRegister.create(net.minecraft.core.registries.Registries.ENTITY_TYPE, Goetied.MOD_ID);
    ...
    public static final RegistryObject<EntityType<ZombieVindicatorServant>> ZOMBIE_VINDICATOR_SERVANT = register("zombie_vindicator",
    ...
    private static <T extends Entity> RegistryObject<EntityType<T>> register(String p_20635_, EntityType.Builder<T> p_20636_) {
        return RegistryObject.of(ENTITY_TYPE.register(p_20635_, () -> p_20636_.build(Goetied.location(p_20635_).toString())));
    }
}