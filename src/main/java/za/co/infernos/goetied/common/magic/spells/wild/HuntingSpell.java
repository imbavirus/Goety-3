...
import za.co.infernos.goetied.common.entities.ally.Snapper;
import za.co.infernos.goetied.common.entities.ally.Summoned;
import za.co.infernos.goetied.common.entities.ally.TwilightGoat;
import za.co.infernos.goetied.common.entities.ally.undead.skeleton.SkeletonWolf;
...
public class HuntingSpell extends SummonSpell {
    ...
    public int defaultSoulCost() {
        return za.co.infernos.goetied.utils.ConfigHelper.getInt(SpellConfig.HuntingCost, 0);
    }

    @Override
    public int defaultCastDuration() {
        return za.co.infernos.goetied.utils.ConfigHelper.getInt(SpellConfig.HuntingDuration, 0);
    }
    ...
    public int defaultSpellCooldown() {
        return za.co.infernos.goetied.utils.ConfigHelper.getInt(SpellConfig.HuntingCoolDown, 0);
    }

    @Override
    public int SummonDownDuration() {
        return za.co.infernos.goetied.utils.ConfigHelper.getInt(SpellConfig.HuntingSummonDown, 0);
    }
    ...
    public int summonLimit() {
        return za.co.infernos.goetied.utils.ConfigHelper.getInt(SpellConfig.HuntingLimit, 0);
    }
