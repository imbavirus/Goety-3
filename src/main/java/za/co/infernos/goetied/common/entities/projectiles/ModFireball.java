    ...
    protected void onHitEntity(EntityHitResult pResult) {
        if (!this.level().isClientSide) {
            ...
            if (entity1 instanceof Player) {
                damage = za.co.infernos.goetied.utils.ConfigHelper.getFloat(SpellConfig.FireballDamage, 1.0F) * WandUtil.damageMultiply();
        ...
        if (!this.level().isClientSide) {
            ...
            if (this.isDangerous()) {
                ...
                if (entity instanceof Player
                    ...
                    flag = za.co.infernos.goetied.utils.ConfigHelper.getBoolean(SpellConfig.FireballGriefing, false);
                }
                if (flag) {
