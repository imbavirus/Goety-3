...
public class VoidSlash extends SlashProjectile{
    ...
    public void damageEntity(Entity entity) {
        ...
        if (entity.hurt(damageSource, this.getDamage())) {
            if (entity instanceof LivingEntity livingEntity && !livingEntity.hasEffect(net.minecraft.core.Holder.direct(GoetiedEffects.VOID_TOUCHED.get()))) {
                livingEntity.addEffect(new MobEffectInstance(net.minecraft.core.Holder.direct(GoetiedEffects.VOID_TOUCHED.get()), MathHelper.secondsToTicks(3), this.getVoidLevel() - 1, false, true));
            }
        }
    }
}