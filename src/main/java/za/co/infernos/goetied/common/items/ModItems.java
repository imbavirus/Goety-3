...
import za.co.infernos.goetied.api.items.magic.ITotem;
...
import za.co.infernos.goetied.common.items.armor.BlackIronArmor;
import za.co.infernos.goetied.common.items.armor.CursedKnightArmor;
import za.co.infernos.goetied.common.items.armor.CursedPaladinArmor;
import za.co.infernos.goetied.common.items.armor.DarkArmor;
import za.co.infernos.goetied.common.items.block.HauntedArmorStandItem;
import za.co.infernos.goetied.common.items.block.HauntedPaintingItem;
import za.co.infernos.goetied.common.items.brew.BrewBag;
import za.co.infernos.goetied.common.items.brew.BrewItem;
import za.co.infernos.goetied.common.items.brew.LingeringBrewItem;
import za.co.infernos.goetied.common.items.brew.SplashBrewItem;
import za.co.infernos.goetied.common.items.curios.*;
import za.co.infernos.goetied.common.items.equipment.*;
import za.co.infernos.goetied.common.items.magic.*;
import za.co.infernos.goetied.common.items.research.ExtraScroll;
import za.co.infernos.goetied.common.items.research.ForbiddenScroll;
import za.co.infernos.goetied.common.items.research.ResearchScroll;
import za.co.infernos.goetied.common.items.research.Scroll;
import za.co.infernos.goetied.common.items.revive.BlazingHelm;
import za.co.infernos.goetied.common.items.revive.HowlingSoul;
import za.co.infernos.goetied.common.items.revive.SoulJar;
import za.co.infernos.goetied.common.magic.spells.*;
import za.co.infernos.goetied.common.magic.spells.abyss.*;
import za.co.infernos.goetied.common.magic.spells.frost.*;
import za.co.infernos.goetied.common.magic.spells.geomancy.*;
import za.co.infernos.goetied.common.magic.spells.necromancy.*;
import za.co.infernos.goetied.common.magic.spells.nether.*;
import za.co.infernos.goetied.common.magic.spells.storm.*;
import za.co.infernos.goetied.common.magic.spells.utility.CraftingSpell;
import za.co.infernos.goetied.common.magic.spells.utility.GlowLightSpell;
import za.co.infernos.goetied.common.magic.spells.utility.IlluminateSpell;
import za.co.infernos.goetied.common.magic.spells.utility.SoulLightSpell;
import za.co.infernos.goetied.common.magic.spells.void_spells.*;
import za.co.infernos.goetied.common.magic.spells.wild.*;
import za.co.infernos.goetied.common.magic.spells.wind.*;
...
public class ModItems {
        public static DeferredRegister<Item> ITEMS = DeferredRegister.create(Registries.ITEM, Goetied.MOD_ID);
