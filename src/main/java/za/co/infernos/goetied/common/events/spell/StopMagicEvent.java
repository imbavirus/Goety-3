...
/**
 * CastingMagicEvent is fired when stopped using {@link za.co.infernos.goetied.common.items.magic.DarkWand} to cast a spell. <br>
 * <br>
 * This event is fired via the {@link GoetiedEventFactory#onStopSpell(LivingEntity, ItemStack, ISpell, int, int)}.<br>
 * <br>
