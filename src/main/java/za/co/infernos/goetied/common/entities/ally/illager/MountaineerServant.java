...
import za.co.infernos.goetied.common.entities.ai.path.ModClimberNavigation;
...
public class MountaineerServant extends AbstractIllagerServant {
    ...
    public static AttributeSupplier.Builder setCustomAttributes() {
        return Monster.createMonsterAttributes()
                ...
                .add(Attributes.MAX_HEALTH, za.co.infernos.goetied.utils.ConfigHelper.getDouble(AttributesConfig.MountaineerServantHealth, 20.0D))
                .add(Attributes.ARMOR, za.co.infernos.goetied.utils.ConfigHelper.getDouble(AttributesConfig.MountaineerServantArmor, 20.0D))
                .add(Attributes.ATTACK_DAMAGE, za.co.infernos.goetied.utils.ConfigHelper.getDouble(AttributesConfig.MountaineerServantDamage, 20.0D));
    }

    public void setConfigurableAttributes() {
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.MAX_HEALTH), za.co.infernos.goetied.utils.ConfigHelper.getDouble(AttributesConfig.MountaineerServantHealth, 20.0D));
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.ARMOR), za.co.infernos.goetied.utils.ConfigHelper.getDouble(AttributesConfig.MountaineerServantArmor, 20.0D));
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.ATTACK_DAMAGE), za.co.infernos.goetied.utils.ConfigHelper.getDouble(AttributesConfig.MountaineerServantDamage, 20.0D));
    }
    ...
    protected PathNavigation createNavigation(Level level) {
        if (za.co.infernos.goetied.utils.ConfigHelper.getBoolean(MobsConfig.MountaineerClimb, true)) {
    ...
    public void tick() {
        ...
        if (!this.level().isClientSide) {
            boolean shouldClimb = this.horizontalCollision
                    ...
                    && za.co.infernos.goetied.utils.ConfigHelper.getBoolean(MobsConfig.MountaineerClimb, true);
