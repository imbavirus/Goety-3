...
public class PendantOfHungerItem extends SingleStackItem {
    ...
    public void inventoryTick(ItemStack stack, Level worldIn, Entity entityIn, int itemSlot, boolean isSelected) {
        if (entityIn instanceof Player player) {
            if (!stack.has(DataComponents.CUSTOM_DATA)) {
                ...
                if (getRottenFleshAmount(stack) < za.co.infernos.goetied.utils.ConfigHelper.getInt(ItemConfig.PendantOfHungerLimit, 0)) {
    ...
    public double amountColor(ItemStack stack){
        ...
        return 1.0D - (i / (double) za.co.infernos.goetied.utils.ConfigHelper.getInt(ItemConfig.PendantOfHungerLimit, 0));
    }
    ...
    public int getBarWidth(ItemStack stack){
        ...
        return Math.round((power * 13.0F / za.co.infernos.goetied.utils.ConfigHelper.getInt(ItemConfig.PendantOfHungerLimit, 0)));
    }
    ...
    public void appendHoverText(ItemStack stack, Item.TooltipContext context, List<Component> tooltip, TooltipFlag flagIn) {
        ...
        tooltip.add(Component.translatable("info.goetied.hunger_pendent.amount", rottenFlesh));
    }
