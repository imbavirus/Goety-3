...
import za.co.infernos.goetied.common.network.server.STentacleRangePacket;
...
public class GulfTentacle extends Owned {
    ...
    public static AttributeSupplier.Builder setCustomAttributes(){
        return Mob.createMobAttributes()
                .add(Attributes.ATTACK_DAMAGE, za.co.infernos.goetied.utils.ConfigHelper.getDouble(SpellConfig.WaterWhipDamage, 20.0D) * WandUtil.damageMultiply());
    }

    @Override
    public void setConfigurableAttributes() {
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.ATTACK_DAMAGE), za.co.infernos.goetied.utils.ConfigHelper.getDouble(SpellConfig.WaterWhipDamage, 20.0D) * WandUtil.damageMultiply());
    }
        ...
        for (LivingEntity entity : entities) {
            ...
            if (flag) {
                ...
                if (this.isStaff) {
                    ...
                    if (this.hasEffect(GoetiedEffects.BUFF)) {
                        gulfTentacle.addEffect(new MobEffectInstance(GoetiedEffects.BUFF, EffectsUtil.infiniteEffect(), EffectsUtil.getAmplifier(this, GoetiedEffects.BUFF.value()), false, false));
                    }
