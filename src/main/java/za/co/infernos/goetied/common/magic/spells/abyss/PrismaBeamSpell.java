...
public class PrismaBeamSpell extends Spell {
    ...
    public int defaultSoulCost() {
        return za.co.infernos.goetied.utils.ConfigHelper.getInt(SpellConfig.PrismaBeamCost, 0);
    }

    @Override
    public int defaultCastDuration() {
        return za.co.infernos.goetied.utils.ConfigHelper.getInt(SpellConfig.PrismaBeamDuration, 0);
    }
    ...
    public int defaultSpellCooldown() {
        return za.co.infernos.goetied.utils.ConfigHelper.getInt(SpellConfig.PrismaBeamCoolDown, 0);
    }
    ...
    public void SpellResult(ServerLevel worldIn, LivingEntity caster, ItemStack staff, SpellStat spellStat) {
        ...
        LivingEntity target = this.getTarget(caster);
        if (target != null) {
            float damage = za.co.infernos.goetied.utils.ConfigHelper.getFloat(SpellConfig.PrismaBeamDamage, 1.0F) * WandUtil.damageMultiply();
            float f = 1.0F;
