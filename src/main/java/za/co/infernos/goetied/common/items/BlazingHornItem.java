...
public class BlazingHornItem extends Item {
        ...
        if (worldIn instanceof ServerLevel serverWorld) {
            ...
            if (flag) {
                ...
                if (entityLiving instanceof Player player) {
                    player.displayClientMessage(Component.translatable("info.goetied.items.blaze_horn.failure"), true);
                }
    ...
    public void appendHoverText(ItemStack stack, Item.TooltipContext context, List<Component> tooltip, TooltipFlag flagIn) {
        ...
        tooltip.add(Component.translatable("info.goetied.items.blaze_horn.desc").withStyle(ChatFormatting.DARK_PURPLE));
    }
}
