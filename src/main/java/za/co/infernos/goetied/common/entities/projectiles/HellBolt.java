...
public class HellBolt extends WaterHurtingProjectile {
    ...
    public static final Map<Integer, ResourceLocation> TEXTURE_BY_TYPE = Util.make(Maps.newHashMap(), (map) -> {
        map.put(0, Goetied.location("textures/entity/projectiles/hell_bolt/bolt_1.png"));
        map.put(1, Goetied.location("textures/entity/projectiles/hell_bolt/bolt_2.png"));
        map.put(2, Goetied.location("textures/entity/projectiles/hell_bolt/bolt_3.png"));
    });
    ...
    public HellBolt(LivingEntity p_i1771_2_, double p_i1771_3_, double p_i1771_5_, double p_i1771_7_,
            Level p_i1771_1_) {
        super(ModEntityType.HELL_BOLT.get(), p_i1771_2_.getX(), p_i1771_2_.getEyeY(), p_i1771_2_.getZ(), p_i1771_3_, p_i1771_5_, p_i1771_7_, p_i1771_1_);
