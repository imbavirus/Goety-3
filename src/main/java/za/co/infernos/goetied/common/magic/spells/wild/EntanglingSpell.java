...
public class EntanglingSpell extends Spell {
    ...
    public int defaultSoulCost() {
        return za.co.infernos.goetied.utils.ConfigHelper.getInt(SpellConfig.EntanglingCost, 0);
    }

    @Override
    public int defaultCastDuration() {
        return za.co.infernos.goetied.utils.ConfigHelper.getInt(SpellConfig.EntanglingDuration, 0);
    }
    ...
    public int defaultSpellCooldown() {
        return za.co.infernos.goetied.utils.ConfigHelper.getInt(SpellConfig.EntanglingCoolDown, 0);
    }
        ...
        if (rightStaff(staff)){
            ...
            if (!list.isEmpty()) {
                for (LivingEntity entity : list) {
                    if (amount < za.co.infernos.goetied.utils.ConfigHelper.getInt(SpellConfig.EntanglingStaffAmount, 0)) {
