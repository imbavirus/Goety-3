...
import za.co.infernos.goetied.common.entities.ally.undead.PhantomServant;
...
public class PhantomSpell extends SummonSpell {
    ...
    public int defaultSoulCost() {
        return za.co.infernos.goetied.utils.ConfigHelper.getInt(SpellConfig.PhantomCost, 0);
    }

    @Override
    public int defaultCastDuration() {
        return za.co.infernos.goetied.utils.ConfigHelper.getInt(SpellConfig.PhantomDuration, 0);
    }
    ...
    public int defaultSpellCooldown() {
        return za.co.infernos.goetied.utils.ConfigHelper.getInt(SpellConfig.PhantomCoolDown, 0);
    }

    @Override
    public int SummonDownDuration() {
        return za.co.infernos.goetied.utils.ConfigHelper.getInt(SpellConfig.PhantomSummonDown, 0);
    }
    ...
    public int summonLimit() {
        return za.co.infernos.goetied.utils.ConfigHelper.getInt(SpellConfig.PhantomLimit, 0);
    }
