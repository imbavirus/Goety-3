...
public class Preacher extends HuntingIllagerEntity{
    ...
    public static AttributeSupplier.Builder setCustomAttributes() {
        return Mob.createMobAttributes()
                .add(Attributes.MAX_HEALTH, za.co.infernos.goetied.utils.ConfigHelper.getDouble(AttributesConfig.PreacherHealth, 20.0D))
                .add(Attributes.ARMOR, za.co.infernos.goetied.utils.ConfigHelper.getDouble(AttributesConfig.PreacherArmor, 20.0D))
                .add(Attributes.FOLLOW_RANGE, 16.0D)
                .add(Attributes.MOVEMENT_SPEED, 0.35D);
    }

    public void setConfigurableAttributes(){
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.MAX_HEALTH), za.co.infernos.goetied.utils.ConfigHelper.getDouble(AttributesConfig.PreacherHealth, 20.0D));
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.ARMOR), za.co.infernos.goetied.utils.ConfigHelper.getDouble(AttributesConfig.PreacherArmor, 20.0D));
    }
        ...
        public void tick() {
            ...
            if (this.target != null && !this.target.isDeadOrDying()){
                ...
                if (this.preacher.healTick == 10){
                    this.target.heal((float)za.co.infernos.goetied.utils.ConfigHelper.getDouble(AttributesConfig.PreacherHeal, 20.0D));
