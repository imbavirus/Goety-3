...
public class MagicFocus extends Item implements IFocus {
    ...
    public void appendHoverText(ItemStack stack, Item.TooltipContext context, List<Component> tooltip, TooltipFlag flagIn) {
        ...
        tooltip.add(Component.translatable("info.goetied.focus.cost", cost));
        tooltip.add(Component.translatable("info.goetied.focus.spellType", spell.getSpellType().getName()));
        tooltip.add(Component.translatable("item.goetied.focus.info").withStyle(ChatFormatting.BLUE).withStyle(ChatFormatting.UNDERLINE));
