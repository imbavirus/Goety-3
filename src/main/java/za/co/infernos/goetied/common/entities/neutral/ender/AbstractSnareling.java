package za.co.infernos.goetied.common.entities.neutral.ender;

import za.co.infernos.goetied.common.effects.GoetiedEffects;
import za.co.infernos.goetied.common.entities.neutral.Owned;
import za.co.infernos.goetied.common.entities.projectiles.SnarelingShot;
...
public class AbstractSnareling extends AbstractEnderling implements RangedAttackMob {
    ...
    public static AttributeSupplier.Builder setCustomAttributes() {
        return Mob.createMobAttributes()
                .add(Attributes.MAX_HEALTH, za.co.infernos.goetied.utils.ConfigHelper.getDouble(AttributesConfig.SnarelingHealth, 20.0D))
                .add(Attributes.ARMOR, za.co.infernos.goetied.utils.ConfigHelper.getDouble(AttributesConfig.SnarelingArmor, 20.0D))
                .add(Attributes.FOLLOW_RANGE, 16.0D)
                .add(Attributes.ATTACK_DAMAGE, za.co.infernos.goetied.utils.ConfigHelper.getDouble(AttributesConfig.SnarelingDamage, 20.0D))
                .add(Attributes.MOVEMENT_SPEED, 0.25D);
    }

    public void setConfigurableAttributes() {
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.MAX_HEALTH), za.co.infernos.goetied.utils.ConfigHelper.getDouble(AttributesConfig.SnarelingHealth, 20.0D));
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.ARMOR), za.co.infernos.goetied.utils.ConfigHelper.getDouble(AttributesConfig.SnarelingArmor, 20.0D));
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.ATTACK_DAMAGE), za.co.infernos.goetied.utils.ConfigHelper.getDouble(AttributesConfig.SnarelingDamage, 20.0D));
    }
    ...
    public int getSummonLimit(LivingEntity owner) {
        return za.co.infernos.goetied.utils.ConfigHelper.getInt(SpellConfig.SnarelingLimit, 8);
    }
    ...
    public static class ShootGoal<T extends AbstractSnareling> extends Goal {
        ...
        public boolean canUse() {
            ...
            if (livingentity != null
                ...
                return !livingentity.hasEffect(GoetiedEffects.TANGLED)
    ...
    public class AttackGoal extends MeleeAttackGoal {
        ...
        public boolean canUse() {
            return AbstractSnareling.this.getTarget() != null
                    ...
                    && AbstractSnareling.this.getTarget().hasEffect(GoetiedEffects.TANGLED);
        }

        @Override
        public boolean canContinueToUse() {
            if (AbstractSnareling.this.getTarget() == null || AbstractSnareling.this.getTarget().isDeadOrDying() || !AbstractSnareling.this.getTarget().hasEffect(GoetiedEffects.TANGLED)) {
                return false;
            }
            return super.canContinueToUse();
        }
