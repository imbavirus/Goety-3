package za.co.infernos.goetied.common.world.features;

import za.co.infernos.goetied.Goetied;
import za.co.infernos.goetied.common.blocks.ModBlocks;
import za.co.infernos.goetied.common.world.features.configs.ModTreeFeatureConfig;
import za.co.infernos.goetied.common.world.features.trees.trunkplacers.ChorusTrunkPlacer;
...
public class ConfiguredFeatures {
    ...
    public static final ResourceKey<ConfiguredFeature<?, ?>> SAPLING_HAUNTED_TREE = ResourceKey.create(net.minecraft.core.registries.Registries.CONFIGURED_FEATURE, Goetied.location("haunted_tree_sapling"));
    public static final ResourceKey<ConfiguredFeature<?, ?>> SAPLING_ROTTEN_TREE = ResourceKey.create(net.minecraft.core.registries.Registries.CONFIGURED_FEATURE, Goetied.location("rotten_tree_sapling"));
    public static final ResourceKey<ConfiguredFeature<?, ?>> SAPLING_FANCY_ROTTEN_TREE = ResourceKey.create(net.minecraft.core.registries.Registries.CONFIGURED_FEATURE, Goetied.location("fancy_rotten_tree_sapling"));
    public static final ResourceKey<ConfiguredFeature<?, ?>> WINDSWEPT_TREE = ResourceKey.create(net.minecraft.core.registries.Registries.CONFIGURED_FEATURE, Goetied.location("windswept_tree"));
    public static final ResourceKey<ConfiguredFeature<?, ?>> WINDSWEPT_TREE_2 = ResourceKey.create(net.minecraft.core.registries.Registries.CONFIGURED_FEATURE, Goetied.location("second_windswept_tree"));
    public static final ResourceKey<ConfiguredFeature<?, ?>> PINE_TREE = ResourceKey.create(net.minecraft.core.registries.Registries.CONFIGURED_FEATURE, Goetied.location("pine_tree"));
    public static final ResourceKey<ConfiguredFeature<?, ?>> MEGA_PINE_TREE = ResourceKey.create(net.minecraft.core.registries.Registries.CONFIGURED_FEATURE, Goetied.location("mega_pine_tree"));
    public static final ResourceKey<ConfiguredFeature<?, ?>> CHORUS_TREE = ResourceKey.create(net.minecraft.core.registries.Registries.CONFIGURED_FEATURE, Goetied.location("chorus_tree"));
    public static final ResourceKey<ConfiguredFeature<?, ?>> MEGA_CHORUS_TREE = ResourceKey.create(net.minecraft.core.registries.Registries.CONFIGURED_FEATURE, Goetied.location("mega_chorus_tree"));
    public static final ResourceKey<ConfiguredFeature<?, ?>> CHORUS_BLOSSOM_TREE = ResourceKey.create(net.minecraft.core.registries.Registries.CONFIGURED_FEATURE, Goetied.location("chorus_blossom_tree"));
    public static final ResourceKey<ConfiguredFeature<?, ?>> MEGA_CHORUS_BLOSSOM_TREE = ResourceKey.create(net.minecraft.core.registries.Registries.CONFIGURED_FEATURE, Goetied.location("mega_chorus_blossom_tree"));
    public static final ResourceKey<ConfiguredFeature<?, ?>> MEGA_CHORUS_VOID_TREE = ResourceKey.create(net.minecraft.core.registries.Registries.CONFIGURED_FEATURE, Goetied.location("mega_chorus_void_tree"));
    public static final ResourceKey<ConfiguredFeature<?, ?>> MEGA_CHORUS_BLOSSOM_VOID_TREE = ResourceKey.create(net.minecraft.core.registries.Registries.CONFIGURED_FEATURE, Goetied.location("mega_chorus_blossom_void_tree"));
    public static final ResourceKey<ConfiguredFeature<?, ?>> CHORUS_GRASS_BLOCK_BONEMEAL = ResourceKey.create(net.minecraft.core.registries.Registries.CONFIGURED_FEATURE, Goetied.location("chorus_grass_block_bonemeal"));
    public static final ResourceKey<ConfiguredFeature<?, ?>> END_GROWTH_BLOCK_BONEMEAL = ResourceKey.create(net.minecraft.core.registries.Registries.CONFIGURED_FEATURE, Goetied.location("end_growth_block_bonemeal"));
    public static final ResourceKey<ConfiguredFeature<?, ?>> END_VEGETATION_BONEMEAL = ResourceKey.create(net.minecraft.core.registries.Registries.CONFIGURED_FEATURE, Goetied.location("end_vegetation_bonemeal"));
    public static final ResourceKey<ConfiguredFeature<?, ?>> END_SOIL_BONEMEAL = ResourceKey.create(net.minecraft.core.registries.Registries.CONFIGURED_FEATURE, Goetied.location("end_soil_bonemeal"));
