...
public class EndWalkSpell extends Spell {
    ...
    public int defaultSoulCost() {
        return za.co.infernos.goetied.utils.ConfigHelper.getInt(SpellConfig.EndWalkCost, 0);
    }

    @Override
    public int defaultCastDuration() {
        return za.co.infernos.goetied.utils.ConfigHelper.getInt(SpellConfig.EndWalkDuration, 0);
    }
    ...
    public int defaultSpellCooldown() {
        return za.co.infernos.goetied.utils.ConfigHelper.getInt(SpellConfig.EndWalkCoolDown, 0);
    }
    ...
    public void SpellResult(ServerLevel worldIn, LivingEntity caster, ItemStack staff, SpellStat spellStat) {
        ...
        if (caster instanceof Player player){
            player.addEffect(new MobEffectInstance(GoetiedEffects.SHADOW_WALK, za.co.infernos.goetied.utils.ConfigHelper.getInt(SpellConfig.EndWalkEffectDuration, 0) + duration, potency, false, false, true));
            for(int i = 0; i < 16; ++i) {
