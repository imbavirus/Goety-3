...
import za.co.infernos.goetied.common.entities.projectiles.RazorWind;
import za.co.infernos.goetied.common.entities.projectiles.SlashProjectile;
...
public class RazorWindSpell extends Spell {
    ...
    public int defaultSoulCost() {
        return za.co.infernos.goetied.utils.ConfigHelper.getInt(SpellConfig.RazorWindCost, 0);
    }

    @Override
    public int defaultCastDuration() {
        return za.co.infernos.goetied.utils.ConfigHelper.getInt(SpellConfig.RazorWindDuration, 0);
    }

    @Override
    public int defaultSpellCooldown() {
        return za.co.infernos.goetied.utils.ConfigHelper.getInt(SpellConfig.RazorWindCoolDown, 0);
    }
    ...
    public void SpellResult(ServerLevel worldIn, LivingEntity caster, ItemStack staff, SpellStat spellStat){
        ...
        float damage = za.co.infernos.goetied.utils.ConfigHelper.getFloat(SpellConfig.RazorWindDamage, 1.0F) * WandUtil.damageMultiply();
        if (rightStaff(staff)){
            radius += 0.5F;
        }
