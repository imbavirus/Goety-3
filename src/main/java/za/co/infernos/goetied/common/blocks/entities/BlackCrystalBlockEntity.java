...
import za.co.infernos.goetied.api.blocks.IEnchantedBlock;
...
import za.co.infernos.goetied.client.particles.SpirallingParticleOption;
                ...
                if (this.target == null) {
                    ...
                    if (!this.target.isAlive() || this.target.getHealth() < this.target.getMaxHealth() * 0.25F || this.target.distanceToSqr(this.getBlockPos().getCenter()) > Mth.square(radius)) {
                        ...
                        if (this.attackTick % 20 == 0) {
                            ...
                            this.target.addEffect(new MobEffectInstance(GoetiedEffects.CURSED, 5, 0, false, false));
