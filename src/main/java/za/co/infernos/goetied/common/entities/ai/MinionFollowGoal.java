...
public class MinionFollowGoal extends Goal {
    ...
    public void tick() {
        ...
        if (--this.timeToRecalcPath <= 0) {
            ...
            if (this.summonedEntity.distanceToSqr(this.owner) > 144.0 && za.co.infernos.goetied.utils.ConfigHelper.getBoolean(MobsConfig.VexTeleport, false)){
    ...
    private boolean isTeleportFriendlyBlock(BlockPos pos) {
        PathType pathnodetype = WalkNodeEvaluator.getPathTypeStatic(this.summonedEntity, pos.mutable());
