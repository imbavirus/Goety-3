...
public class TotemOfSouls extends Item implements ITotem, ICurioItem {
    ...
    public ItemStack getCraftingRemainingItem(ItemStack itemStack) {
        ...
        if (ITotem.currentSouls(container) > za.co.infernos.goetied.utils.ConfigHelper.getPositiveInt(ItemConfig.CraftingSouls, 1)) {
            ITotem.decreaseSouls(container, za.co.infernos.goetied.utils.ConfigHelper.getPositiveInt(ItemConfig.CraftingSouls, 1));
            return container;
        }
    ...
    public void appendHoverText(ItemStack stack, Item.TooltipContext context, List<Component> tooltip, TooltipFlag flagIn) {
        ...
        tooltip.add(Component.translatable("info.goetied.totem_of_souls.souls", ITotem.currentSouls(stack), ITotem.maximumSouls(stack)));
    }
