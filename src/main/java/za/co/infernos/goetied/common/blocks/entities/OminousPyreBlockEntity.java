...
import za.co.infernos.goetied.api.entities.ally.illager.ITrainIllager;
import za.co.infernos.goetied.api.entities.ally.illager.IllagerType;
...
public class OminousPyreBlockEntity extends BarracksBlockEntity {
    ...
    public boolean autoMode() {
        return za.co.infernos.goetied.utils.ConfigHelper.getBoolean(MobsConfig.IllagerServantAutoTrain, false);
    }
