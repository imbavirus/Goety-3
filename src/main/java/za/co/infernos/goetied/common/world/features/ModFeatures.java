...
import za.co.infernos.goetied.common.world.features.trees.features.ChorusTreeFeature;
...
public class ModFeatures {
    public static final DeferredRegister<Feature<?>> FEATURES = DeferredRegister.create(Registries.FEATURE, Goetied.MOD_ID);
