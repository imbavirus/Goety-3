...
public class GhastServant extends Malghast {
    ...
    public static AttributeSupplier.Builder setCustomAttributes() {
        return Mob.createMobAttributes()
                .add(Attributes.MAX_HEALTH, za.co.infernos.goetied.utils.ConfigHelper.getDouble(AttributesConfig.GhastServantHealth, 20.0D))
                .add(Attributes.FOLLOW_RANGE, 32.0D);
    }

    public void setConfigurableAttributes(){
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.MAX_HEALTH), za.co.infernos.goetied.utils.ConfigHelper.getDouble(AttributesConfig.GhastServantHealth, 20.0D));
    }
        ...
        public void tick() {
            ...
            if (livingentity != null && livingentity.distanceToSqr(this.ghast) < Mth.square(d0) && this.ghast.hasLineOfSight(livingentity)) {
                ...
                if (this.chargeTime == 20) {
                    ...
                    largefireball.setDamage((float)za.co.infernos.goetied.utils.ConfigHelper.getDouble(AttributesConfig.GhastServantDamage, 20.0D) + this.ghast.getFireBallDamage());
