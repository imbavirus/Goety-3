...
import za.co.infernos.goetied.client.particles.SoulShockwaveParticleOption;
...
public class SoulHealSpell extends Spell {
    ...
    public int defaultSoulCost() {
        return za.co.infernos.goetied.utils.ConfigHelper.getInt(SpellConfig.SoulHealCost, 0);
    }

    @Override
    public int defaultCastDuration() {
        return za.co.infernos.goetied.utils.ConfigHelper.getInt(SpellConfig.SoulHealDuration, 0);
    }

    @Override
    public int defaultSpellCooldown() {
        return za.co.infernos.goetied.utils.ConfigHelper.getInt(SpellConfig.SoulHealCoolDown, 0);
    }
    ...
    public void SpellResult(ServerLevel worldIn, LivingEntity caster, ItemStack staff, SpellStat spellStat){
        ...
        float heal = RandomUtil.nextInt(worldIn.getRandom(), za.co.infernos.goetied.utils.ConfigHelper.getInt(SpellConfig.SoulHealAmount, 0) * Math.max(1, potency)) + 1.0F;
        caster.heal(heal);
        if (radius > 0) {
