...
public class BubbleStreamSpell extends BreathingSpell {
    ...
    public int defaultSoulCost() {
        return za.co.infernos.goetied.utils.ConfigHelper.getInt(SpellConfig.BubbleStreamCost, 0);
    }

    @Override
    public int defaultCastUp() {
        return za.co.infernos.goetied.utils.ConfigHelper.getInt(SpellConfig.BubbleStreamChargeUp, 0);
    }

    @Override
    public int shotsNumber() {
        return za.co.infernos.goetied.utils.ConfigHelper.getInt(SpellConfig.BubbleStreamDuration, 0);
    }

    @Override
    public int defaultSpellCooldown() {
        return za.co.infernos.goetied.utils.ConfigHelper.getInt(SpellConfig.BubbleStreamCoolDown, 0);
    }
    ...
    public void SpellResult(ServerLevel worldIn, LivingEntity caster, ItemStack staff, SpellStat spellStat){
        ...
        float damage = za.co.infernos.goetied.utils.ConfigHelper.getFloat(SpellConfig.BubbleStreamDamage, 1.0F) * WandUtil.damageMultiply();
        damage += potency;
