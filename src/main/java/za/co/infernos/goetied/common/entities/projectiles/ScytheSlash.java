...
public class ScytheSlash extends AbstractHurtingProjectile {
    ...
    public static final Map<Integer, ResourceLocation> TEXTURE_BY_TYPE = Util.make(Maps.newHashMap(), (map) -> {
        map.put(0, Goetied.location("textures/entity/projectiles/scythe/scythe_0.png"));
        map.put(1, Goetied.location("textures/entity/projectiles/scythe/scythe_1.png"));
        map.put(2, Goetied.location("textures/entity/projectiles/scythe/scythe_2.png"));
        map.put(3, Goetied.location("textures/entity/projectiles/scythe/scythe_3.png"));
        map.put(4, Goetied.location("textures/entity/projectiles/scythe/scythe_4.png"));
        map.put(5, Goetied.location("textures/entity/projectiles/scythe/scythe_5.png"));
        map.put(6, Goetied.location("textures/entity/projectiles/scythe/scythe_6.png"));
        map.put(7, Goetied.location("textures/entity/projectiles/scythe/scythe_7.png"));
    });
    ...
    public void tick() {
        ...
        if (za.co.infernos.goetied.utils.ConfigHelper.getBoolean(ItemConfig.ScytheSlashBreaks, false)) {
                        ...
                        if (this.getOwner() != null) {
                            ...
                            if (this.getOwner() instanceof Player player) {
                                ...
                                if (attack && entity instanceof LivingEntity) {
                                    ...
                                    SEHelper.increaseSouls(player, za.co.infernos.goetied.utils.ConfigHelper.getInt(ItemConfig.DarkScytheSouls, 1) * soulEater);
                                }
                            } else {
