...
import za.co.infernos.goetied.common.entities.projectiles.AbstractCyclone;
import za.co.infernos.goetied.common.entities.projectiles.Cyclone;
import za.co.infernos.goetied.common.entities.projectiles.FireTornado;
...
public class CycloneSpell extends Spell {
    ...
    public int defaultSoulCost() {
        return za.co.infernos.goetied.utils.ConfigHelper.getInt(SpellConfig.CycloneCost, 0);
    }

    @Override
    public int defaultCastDuration() {
        return za.co.infernos.goetied.utils.ConfigHelper.getInt(SpellConfig.CycloneDuration, 0);
    }
    ...
    public int defaultSpellCooldown() {
        return za.co.infernos.goetied.utils.ConfigHelper.getInt(SpellConfig.CycloneCoolDown, 0);
    }
