...
public class WatchlingSpell extends SummonSpell {
    ...
    public int defaultSoulCost() {
        return za.co.infernos.goetied.utils.ConfigHelper.getInt(SpellConfig.WatchlingCost, 0);
    }

    public int defaultCastDuration() {
        return za.co.infernos.goetied.utils.ConfigHelper.getInt(SpellConfig.WatchlingDuration, 0);
    }

    public int SummonDownDuration() {
        return za.co.infernos.goetied.utils.ConfigHelper.getInt(SpellConfig.WatchlingSummonDown, 0);
    }
    ...
    public int defaultSpellCooldown() {
        return za.co.infernos.goetied.utils.ConfigHelper.getInt(SpellConfig.WatchlingCoolDown, 0);
    }
    ...
    public Predicate<LivingEntity> summonPredicate() {
        return livingEntity -> livingEntity instanceof WatchlingServant;
    }

    @Override
    public int summonLimit() {
        return za.co.infernos.goetied.utils.ConfigHelper.getInt(SpellConfig.WatchlingLimit, 0);
    }
    ...
    public void SpellResult(ServerLevel worldIn, LivingEntity caster, ItemStack staff, SpellStat spellStat) {
        ...
        if (!isShifting(caster)) {
            ...
            for (int i1 = 0; i1 < i; ++i1) {
                Summoned summonedentity = new WatchlingServant(ModEntityType.WATCHLING_SERVANT.get(), worldIn);
