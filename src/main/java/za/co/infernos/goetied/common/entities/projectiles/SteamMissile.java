...
public class SteamMissile extends SpellHurtingProjectile {
    ...
    public static final Map<Integer, ResourceLocation> TEXTURE_BY_TYPE = Util.make(Maps.newHashMap(), (map) -> {
        map.put(0, Goetied.location("textures/entity/projectiles/soul_bolt/steam_missile_1.png"));
        map.put(1, Goetied.location("textures/entity/projectiles/soul_bolt/steam_missile_2.png"));
        map.put(2, Goetied.location("textures/entity/projectiles/soul_bolt/steam_missile_3.png"));
    });
    ...
    protected void onHitEntity(EntityHitResult p_37626_) {
        ...
        if (!this.level().isClientSide) {
            float baseDamage = za.co.infernos.goetied.utils.ConfigHelper.getFloat(SpellConfig.SteamingDamage, 1.0F) * WandUtil.damageMultiply();
