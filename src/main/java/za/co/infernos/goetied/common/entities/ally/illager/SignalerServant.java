...
import za.co.infernos.goetied.client.particles.ModShriekParticleOption;
...
public class SignalerServant extends AbstractIllagerServant{
    ...
    public static AttributeSupplier.Builder setCustomAttributes() {
        return Mob.createMobAttributes()
                ...
                .add(Attributes.MAX_HEALTH, za.co.infernos.goetied.utils.ConfigHelper.getDouble(AttributesConfig.SignalerServantHealth, 20.0D))
                .add(Attributes.ARMOR, za.co.infernos.goetied.utils.ConfigHelper.getDouble(AttributesConfig.SignalerServantArmor, 20.0D))
                .add(Attributes.ATTACK_DAMAGE, 5.0F)
                .add(Attributes.FOLLOW_RANGE, za.co.infernos.goetied.utils.ConfigHelper.getDouble(AttributesConfig.SignalerServantFollowRange, 20.0D));
    }

    public void setConfigurableAttributes(){
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.MAX_HEALTH), za.co.infernos.goetied.utils.ConfigHelper.getDouble(AttributesConfig.SignalerServantHealth, 20.0D));
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.ARMOR), za.co.infernos.goetied.utils.ConfigHelper.getDouble(AttributesConfig.SignalerServantArmor, 20.0D));
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.FOLLOW_RANGE), za.co.infernos.goetied.utils.ConfigHelper.getDouble(AttributesConfig.SignalerServantFollowRange, 20.0D));
    }
    ...
    public double getAttributeValue(net.minecraft.core.Holder<Attribute> attribute) {
        ...
        if (attribute == Attributes.FOLLOW_RANGE) {
            if (this.getAttribute(Attributes.FOLLOW_RANGE) == null) {
                original = za.co.infernos.goetied.utils.ConfigHelper.getDouble(AttributesConfig.SignalerServantFollowRange, 20.0D);
            }
