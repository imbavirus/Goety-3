...
public class GrowTreeBlockEffect extends BrewEffect {
    ...
    public GrowTreeBlockEffect(Block block, TreeGrower treeGrower) {
        super(block.getDescriptionId(), za.co.infernos.goetied.utils.ConfigHelper.getInt(BrewConfig.GrowTreeCost, 0), 0, MobEffectCategory.NEUTRAL, 0x5a3f1e, true);
        this.block = block;
    ...
    public String getDescriptionId() {
        return "effect.goetied.grow_tree";
    }
