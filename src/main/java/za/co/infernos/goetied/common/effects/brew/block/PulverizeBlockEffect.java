...
import za.co.infernos.goetied.common.magic.spells.geomancy.PulverizeSpell;
...
public class PulverizeBlockEffect extends BrewEffect {
    public PulverizeBlockEffect() {
        super("pulverize", za.co.infernos.goetied.utils.ConfigHelper.getInt(BrewConfig.PulverizeCost, 0), 2, MobEffectCategory.NEUTRAL, 0xbae633);
    }
