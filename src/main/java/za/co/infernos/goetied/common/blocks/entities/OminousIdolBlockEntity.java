...
import za.co.infernos.goetied.common.blocks.OminousIdolBlock;
import za.co.infernos.goetied.common.entities.ally.illager.RaiderServant;
import za.co.infernos.goetied.common.items.block.OminousIdolBlockItem;
...
public class OminousIdolBlockEntity extends OwnedBlockEntity {
    ...
    public boolean hasSpace() {
        return this.getIllagers().size() < za.co.infernos.goetied.utils.ConfigHelper.getInt(MainConfig.OminousIdolLimit, 0);
    }
