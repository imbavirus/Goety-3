...
import za.co.infernos.goetied.common.entities.projectiles.HellBlast;
import za.co.infernos.goetied.common.entities.projectiles.Lavaball;
...
public class MeteorShowerSpell extends EverChargeSpell {
    ...
    public int defaultSoulCost() {
        return za.co.infernos.goetied.utils.ConfigHelper.getInt(SpellConfig.MeteorShowerCost, 0);
    }

    @Override
    public int defaultCastUp() {
        return za.co.infernos.goetied.utils.ConfigHelper.getInt(SpellConfig.MeteorShowerChargeUp, 0);
    }

    @Override
    public int Cooldown() {
        return za.co.infernos.goetied.utils.ConfigHelper.getInt(SpellConfig.MeteorShowerDuration, 0);
    }
    ...
    public int shotsNumber(LivingEntity caster, ItemStack staff) {
        ...
        return za.co.infernos.goetied.utils.ConfigHelper.getInt(SpellConfig.MeteorShowerShots, 0) + (i * 2);
    }

    @Override
    public int defaultSpellCooldown() {
        return za.co.infernos.goetied.utils.ConfigHelper.getInt(SpellConfig.MeteorShowerCoolDown, 0);
    }
