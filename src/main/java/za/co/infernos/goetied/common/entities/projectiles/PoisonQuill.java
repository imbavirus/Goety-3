...
import za.co.infernos.goetied.api.entities.ISpellEntity;
...
public class PoisonQuill extends Arrow implements ISpellEntity {
    ...
    protected void onHitEntity(EntityHitResult pResult) {
        if (!this.level().isClientSide) {
            ...
            boolean flag;
            float damage = entity1 instanceof Mob mob && mob.getAttribute(Attributes.ATTACK_DAMAGE) != null ? (float) mob.getAttributeValue(Attributes.ATTACK_DAMAGE) : za.co.infernos.goetied.utils.ConfigHelper.getFloat(SpellConfig.PoisonDartDamage, 1.0F);
            ...
            if (flag && entity.getType() != EntityType.ENDERMAN && entity instanceof LivingEntity livingEntity) {
                ...
                if ((entity1 instanceof IOwned owned && CuriosFinder.hasWildRobe(owned.getMasterOwner()))
                    ...
                    mobEffect = GoetiedEffects.ACID_VENOM.get();
                }
