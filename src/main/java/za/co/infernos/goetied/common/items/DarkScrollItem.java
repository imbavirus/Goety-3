...
public class DarkScrollItem extends Item {
    ...
    public ItemStack finishUsingItem(ItemStack stack, Level worldIn, LivingEntity entityLiving) {
        ...
        if (flag) {
            ...
            if (entityLiving instanceof Player player) {
                player.displayClientMessage(Component.translatable("info.goetied.items.dark_scroll.failure"), true);
            }
            worldIn.playSound(null, entityLiving.getX(), entityLiving.getY(), entityLiving.getZ(),
    ...
    public void appendHoverText(ItemStack stack, Item.TooltipContext context, List<Component> tooltip, TooltipFlag flagIn) {
        ...
        tooltip.add(Component.translatable("info.goetied.items.dark_scroll.desc").withStyle(ChatFormatting.DARK_PURPLE));
    }
}
