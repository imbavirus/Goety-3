...
import za.co.infernos.goetied.common.entities.neutral.GulfTentacle;
...
public class GulfTentacleSpell extends Spell {
    ...
    public int defaultSoulCost() {
        return za.co.infernos.goetied.utils.ConfigHelper.getInt(SpellConfig.WaterWhipCost, 0);
    }

    @Override
    public int defaultCastDuration() {
        return za.co.infernos.goetied.utils.ConfigHelper.getInt(SpellConfig.WaterWhipDuration, 0);
    }

    @Override
    public int defaultSpellCooldown() {
        return za.co.infernos.goetied.utils.ConfigHelper.getInt(SpellConfig.WaterWhipCoolDown, 0);
    }
    ...
    public void SpellResult(ServerLevel worldIn, LivingEntity caster, ItemStack staff, SpellStat spellStat) {
        ...
        if (potency > 0){
            ...
            gulfTentacle.addEffect(new MobEffectInstance(GoetiedEffects.BUFF, EffectsUtil.infiniteEffect(), boost, false, false));
        }
