package za.co.infernos.goetied.common.entities.ai.attributes;
...
public class SpellAttribute extends RangedAttribute {
    ...
    public static SpellAttribute potency(SpellType spellType, double p_22311_, double p_22312_, double p_22313_){
        return new SpellAttribute(spellType, "attribute.name.goetied." + spellType.getBaseName() + "_potency", p_22311_, p_22312_, p_22313_);
    }
