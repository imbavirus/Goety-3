...
public class WitherBolt extends SpellHurtingProjectile {
    ...
    public static final Map<Integer, ResourceLocation> TEXTURE_BY_TYPE = Util.make(Maps.newHashMap(), (map) -> {
        map.put(0, Goetied.location("textures/entity/projectiles/soul_bolt/wither_bolt_1.png"));
        map.put(1, Goetied.location("textures/entity/projectiles/soul_bolt/wither_bolt_2.png"));
        map.put(2, Goetied.location("textures/entity/projectiles/soul_bolt/wither_bolt_3.png"));
    });
