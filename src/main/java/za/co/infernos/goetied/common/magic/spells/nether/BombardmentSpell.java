...
import za.co.infernos.goetied.common.magic.EverChargeSpell;
...
public class BombardmentSpell extends EverChargeSpell {
    ...
    public int defaultSoulCost() {
        return za.co.infernos.goetied.utils.ConfigHelper.getInt(SpellConfig.BombardmentCost, 0);
    }

    @Override
    public int defaultCastUp() {
        return za.co.infernos.goetied.utils.ConfigHelper.getInt(SpellConfig.BombardmentChargeUp, 0);
    }

    @Override
    public int Cooldown() {
        return za.co.infernos.goetied.utils.ConfigHelper.getInt(SpellConfig.BombardmentDuration, 0);
    }
    ...
    public int shotsNumber(LivingEntity caster, ItemStack staff) {
        ...
        return za.co.infernos.goetied.utils.ConfigHelper.getInt(SpellConfig.BombardmentShots, 0) + (i * 3);
    }

    @Override
    public int defaultSpellCooldown() {
        return za.co.infernos.goetied.utils.ConfigHelper.getInt(SpellConfig.BombardmentCoolDown, 0);
    }
    ...
    public void SpellResult(ServerLevel worldIn, LivingEntity caster, ItemStack staff, SpellStat spellStat) {
        float damage = za.co.infernos.goetied.utils.ConfigHelper.getFloat(SpellConfig.FireballDamage, 1.0F) * WandUtil.damageMultiply();
