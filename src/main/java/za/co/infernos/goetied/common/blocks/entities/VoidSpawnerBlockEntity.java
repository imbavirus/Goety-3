...
import za.co.infernos.goetied.common.blocks.VoidSpawnerBlock;
import za.co.infernos.goetied.common.blocks.entities.void_spawner.VoidSpawner;
...
import za.co.infernos.goetied.utils.PlayerDetector;
...
public class VoidSpawnerBlockEntity extends BlockEntity implements VoidSpawner.StateAccessor{
    ...
    public void loadAdditional(CompoundTag compoundTag, net.minecraft.core.HolderLookup.Provider pRegistries) {
        ...
        this.voidSpawner
                ...
                .resultOrPartial(Goetied.LOGGER::error)
