...
/**
 * CastingMagicEvent is fired when started to use {@link za.co.infernos.goetied.common.items.magic.DarkWand} with a spell. <br>
 * <br>
 * This event is fired via the {@link GoetiedEventFactory#onStartSpell(LivingEntity, ItemStack, ISpell)}.<br>
 * <br>
