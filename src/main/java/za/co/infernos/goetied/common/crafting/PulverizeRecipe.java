...
public class PulverizeRecipe implements Recipe<RecipeInput> {
            ...
            StreamCodec.of(
                    (buf, stack) -> {
                        ...
                        ItemStack toEncode = stack.isEmpty() 
                                ? za.co.infernos.goetied.common.items.ModItems.JEI_DUMMY_NONE.get().getDefaultInstance() 
                                : stack;
                    ...
                    buf -> {
                        ...
                        if (decoded.getItem() == za.co.infernos.goetied.common.items.ModItems.JEI_DUMMY_NONE.get()) {
    ...
    public ItemStack getResultItem(net.minecraft.core.HolderLookup.Provider p_267052_) {
        ...
        if (this.itemResult.isEmpty()) {
            return za.co.infernos.goetied.common.items.ModItems.JEI_DUMMY_NONE.get().getDefaultInstance();
        }
