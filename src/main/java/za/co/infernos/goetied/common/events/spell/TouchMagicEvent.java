...
/**
 * CastMagicEvent is fired when right-clicking on a target {@link za.co.infernos.goetied.common.items.magic.DarkWand} with a spell. <br>
 * <br>
 * This event is fired via the {@link GoetiedEventFactory#onTouchBasedSpell(LivingEntity, ItemStack, ISpell)}.<br>
 * <br>
