...
import za.co.infernos.goetied.client.render.model.DarkArmorModel;
    ...
    public DarkArmor(ArmorItem.Type p_40387_) {
        super(ModArmorMaterials.getDARK(), p_40387_,
                ModItems.baseProperties().durability(p_40387_.getDurability(
                        Math.max(1, za.co.infernos.goetied.utils.ConfigHelper.getInt(
                                za.co.infernos.goetied.config.ItemConfig.DarkArmorDurability, 15)))));
    }
           ...
           public HumanoidModel<?> getHumanoidArmorModel(LivingEntity livingEntity, ItemStack itemStack, EquipmentSlot equipmentSlot, HumanoidModel<?> original) {
            ...
            public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String layer) {
               if (slot == EquipmentSlot.LEGS) {
                   return Goetied.location("textures/models/armor/dark_armor_layer.png").toString();
               } else {
                   return Goetied.location("textures/models/armor/dark_armor.png").toString();
               }
           }
