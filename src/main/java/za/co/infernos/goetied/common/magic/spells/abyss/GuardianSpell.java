package za.co.infernos.goetied.common.magic.spells.abyss;
...
public class GuardianSpell extends SummonSpell {
    ...
    public int defaultSoulCost() {
        return za.co.infernos.goetied.utils.ConfigHelper.getInt(SpellConfig.GuardianCost, 0);
    }

    @Override
    public int defaultCastDuration() {
        return za.co.infernos.goetied.utils.ConfigHelper.getInt(SpellConfig.GuardianDuration, 0);
    }
    ...
    public int defaultSpellCooldown() {
        return za.co.infernos.goetied.utils.ConfigHelper.getInt(SpellConfig.GuardianCoolDown, 0);
    }

    @Override
    public int SummonDownDuration() {
        return za.co.infernos.goetied.utils.ConfigHelper.getInt(SpellConfig.GuardianSummonDown, 0);
    }
    ...
    public int summonLimit() {
        return za.co.infernos.goetied.utils.ConfigHelper.getInt(SpellConfig.GuardianLimit, 0);
    }
