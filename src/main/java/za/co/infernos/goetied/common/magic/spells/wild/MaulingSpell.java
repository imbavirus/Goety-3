...
import za.co.infernos.goetied.common.entities.ally.BearServant;
import za.co.infernos.goetied.common.entities.ally.Gnasher;
import za.co.infernos.goetied.common.entities.ally.HoglinServant;
...
public class MaulingSpell extends SummonSpell {
    ...
    public int defaultSoulCost() {
        return za.co.infernos.goetied.utils.ConfigHelper.getInt(SpellConfig.MaulingCost, 0);
    }

    @Override
    public int defaultCastDuration() {
        return za.co.infernos.goetied.utils.ConfigHelper.getInt(SpellConfig.MaulingDuration, 0);
    }
    ...
    public int defaultSpellCooldown() {
        return za.co.infernos.goetied.utils.ConfigHelper.getInt(SpellConfig.MaulingCoolDown, 0);
    }

    @Override
    public int SummonDownDuration() {
        return za.co.infernos.goetied.utils.ConfigHelper.getInt(SpellConfig.MaulingSummonDown, 0);
    }
    ...
    public int summonLimit() {
        return za.co.infernos.goetied.utils.ConfigHelper.getInt(SpellConfig.MaulingLimit, 0);
    }
