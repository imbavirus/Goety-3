...
import za.co.infernos.goetied.api.magic.GolemType;
import za.co.infernos.goetied.common.blocks.AnimatorBlock;
import za.co.infernos.goetied.common.blocks.ModBlocks;
import za.co.infernos.goetied.common.entities.ModEntityType;
import za.co.infernos.goetied.common.entities.ally.undead.HauntedArmorServant;
...
import za.co.infernos.goetied.common.magic.construct.SpawnFromBlock;
...
public class AnimatorBlockEntity extends BlockEntity implements IWaystoneBlock, Clearable {
    ...
    public int getSoulCost(){
        if (this.getPosition() != null){
            ...
            return (int) (za.co.infernos.goetied.utils.ConfigHelper.getInt(MainConfig.AnimatorCost, 0) * distance);
        }
        return 0;
    }
