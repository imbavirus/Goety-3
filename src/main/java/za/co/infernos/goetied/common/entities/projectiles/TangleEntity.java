...
public abstract class TangleEntity extends Entity {
    ...
    public void tangleTarget(){
        if (this.getTarget() != null
                ...
                && this.getTarget().canBeAffected(new MobEffectInstance(GoetiedEffects.TANGLED, 100))){
            ...
            this.getTarget().addEffect(new MobEffectInstance(GoetiedEffects.TANGLED, 2, 0, false, false, false));
        }
    }
