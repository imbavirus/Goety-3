...
import za.co.infernos.goetied.common.entities.projectiles.BouncyBubble;
...
public class BouncyBubbleSpell extends Spell {
    ...
    public int defaultSoulCost() {
        return za.co.infernos.goetied.utils.ConfigHelper.getInt(SpellConfig.BouncyBubbleCost, 0);
    }

    @Override
    public int defaultCastDuration() {
        return za.co.infernos.goetied.utils.ConfigHelper.getInt(SpellConfig.BouncyBubbleDuration, 0);
    }
    ...
    public int defaultSpellCooldown() {
        return za.co.infernos.goetied.utils.ConfigHelper.getInt(SpellConfig.BouncyBubbleCoolDown, 0);
    }
