...
import za.co.infernos.goetied.common.network.client.CBeamPacket;
...
public abstract class AbstractBeam extends Entity implements ISpellEntity {
    ...
    public void tick() {
        ...
        if (owner != null && owner.isAlive() && za.co.infernos.goetied.utils.ConfigHelper.getBoolean(SpellConfig.CorruptionImmobile, false)){
