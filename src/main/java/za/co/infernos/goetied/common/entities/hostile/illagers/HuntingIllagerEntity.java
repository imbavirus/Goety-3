...
import za.co.infernos.goetied.common.entities.ai.StealTotemGoal;
        ...
        if (!this.inventory.isEmpty()){
            for(int i = 0; i < this.inventory.getContainerSize(); ++i) {
                ...
                if (itemstack != ItemStack.EMPTY){
                    if (itemstack.getItem() instanceof ITotem){
                        ITotem.increaseSouls(itemstack, za.co.infernos.goetied.utils.ConfigHelper.getInt(MainConfig.IllagerSouls, 0));
                    }
