...
/**
 * Registered Goetied armor materials. Must not fall back to vanilla leather — that made
...
public final class ModArmorMaterials {
    ...
    public static final DeferredRegister<ArmorMaterial> ARMOR_MATERIALS =
            DeferredRegister.create(Registries.ARMOR_MATERIAL, Goetied.MOD_ID);
    ...
    private static ArmorMaterial create(
        ...
        return new ArmorMaterial(
                ...
                equipSound,
                repair,
                List.of(new ArmorMaterial.Layer(Goetied.location(name))),
