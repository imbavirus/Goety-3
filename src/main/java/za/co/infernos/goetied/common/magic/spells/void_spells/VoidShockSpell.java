...
public class VoidShockSpell extends Spell {
    ...
    public int defaultSoulCost() {
        return za.co.infernos.goetied.utils.ConfigHelper.getInt(SpellConfig.VoidShockCost, 0);
    }

    @Override
    public int defaultCastDuration() {
        return za.co.infernos.goetied.utils.ConfigHelper.getInt(SpellConfig.VoidShockDuration, 0);
    }
    ...
    public int castDuration(LivingEntity caster, ItemStack staff) {
        ...
        return za.co.infernos.goetied.utils.ConfigHelper.getInt(SpellConfig.VoidShockDuration, 0) * (i + 1);
    }
    ...
    public int defaultSpellCooldown() {
        return za.co.infernos.goetied.utils.ConfigHelper.getInt(SpellConfig.VoidShockCoolDown, 0);
    }
