...
public class GhostArrow extends AbstractArrow {
    public GhostArrow(EntityType<? extends AbstractArrow> p_36858_, Level p_36859_) {
        super(p_36858_, p_36859_);
    }

    public GhostArrow(Level p_36861_, double p_36862_, double p_36863_, double p_36864_) {
        super(ModEntityType.GHOST_ARROW.get(), p_36862_, p_36863_, p_36864_, p_36861_, ItemStack.EMPTY, ItemStack.EMPTY);
    }

    public GhostArrow(Level p_36866_, LivingEntity p_36867_) {
        super(ModEntityType.GHOST_ARROW.get(), p_36867_, p_36866_, ItemStack.EMPTY, ItemStack.EMPTY);
    }
