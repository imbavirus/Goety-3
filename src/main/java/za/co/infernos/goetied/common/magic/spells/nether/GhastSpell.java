package za.co.infernos.goetied.common.magic.spells.nether;
...
import za.co.infernos.goetied.common.entities.ally.GhastServant;
import za.co.infernos.goetied.common.entities.ally.MiniGhast;
...
public class GhastSpell extends SummonSpell {
    ...
    public int defaultSoulCost() {
        return za.co.infernos.goetied.utils.ConfigHelper.getInt(SpellConfig.GhastCost, 0);
    }

    public int defaultCastDuration() {
        return za.co.infernos.goetied.utils.ConfigHelper.getInt(SpellConfig.GhastDuration, 0);
    }

    public int SummonDownDuration() {
        return za.co.infernos.goetied.utils.ConfigHelper.getInt(SpellConfig.GhastSummonDown, 0);
    }

    @Override
    public int defaultSpellCooldown() {
        return za.co.infernos.goetied.utils.ConfigHelper.getInt(SpellConfig.GhastCoolDown, 0);
    }
    ...
    public int summonLimit() {
        return za.co.infernos.goetied.utils.ConfigHelper.getInt(SpellConfig.GhastLimit, 0);
    }
    ...
    public void SpellResult(ServerLevel worldIn, LivingEntity caster, ItemStack staff, SpellStat spellStat) {
        ...
        if (!isShifting(caster)) {
            ...
            for (int i1 = 0; i1 < i; ++i1) {
                ...
                float extraBlast = Mth.clamp(potency, 0, za.co.infernos.goetied.utils.ConfigHelper.getInt(SpellConfig.MaxRadiusLevel, 0)) / 2.5F;
