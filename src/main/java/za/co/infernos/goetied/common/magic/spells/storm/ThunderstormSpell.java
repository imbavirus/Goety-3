...
import za.co.infernos.goetied.common.entities.util.MagicLightningTrap;
...
public class ThunderstormSpell extends Spell {
    ...
    public int defaultSoulCost() {
        return za.co.infernos.goetied.utils.ConfigHelper.getInt(SpellConfig.ThunderstormCost, 0);
    }

    @Override
    public int defaultCastDuration() {
        return za.co.infernos.goetied.utils.ConfigHelper.getInt(SpellConfig.ThunderstormDuration, 0);
    }
    ...
    public int castDuration(LivingEntity caster, ItemStack staff) {
        ...
        return za.co.infernos.goetied.utils.ConfigHelper.getInt(SpellConfig.ThunderstormDuration, 0) * (i + 1);
    }

    @Override
    public int defaultSpellCooldown() {
        return za.co.infernos.goetied.utils.ConfigHelper.getInt(SpellConfig.ThunderstormCoolDown, 0);
    }
