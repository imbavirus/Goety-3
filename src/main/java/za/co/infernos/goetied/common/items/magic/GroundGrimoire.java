        ...
        if (!level.isClientSide) {
            if (MobUtil.isShifting(player)) {
                if (SEHelper.getGroundedEntityTypes(player).isEmpty()){
                    player.displayClientMessage(Component.translatable("info.goetied.ground.emptyTypes"), false);
                } else {
                    player.displayClientMessage(Component.translatable("info.goetied.ground.type"), false);
                }
                ...
                if (SEHelper.getGroundedEntities(player).isEmpty()){
                    player.displayClientMessage(Component.translatable("info.goetied.ground.empty"), false);
                } else {
                    player.displayClientMessage(Component.translatable("info.goetied.grimoire.ground"), false);
                }
