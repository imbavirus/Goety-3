...
import za.co.infernos.goetied.common.blocks.entities.HoleBlockEntity;
...
public class TunnelSpell extends BlockSpell {
    ...
    public SpellStat defaultStats() {
        return super.defaultStats().setRange(za.co.infernos.goetied.utils.ConfigHelper.getInt(SpellConfig.TunnelDefaultDistance, 0));
    }

    @Override
    public int defaultSoulCost() {
        return za.co.infernos.goetied.utils.ConfigHelper.getInt(SpellConfig.TunnelCost, 0);
    }
    ...
    public int defaultSpellCooldown() {
        return za.co.infernos.goetied.utils.ConfigHelper.getInt(SpellConfig.TunnelCoolDown, 0);
    }
    ...
    public void blockResult(ServerLevel worldIn, LivingEntity caster, ItemStack staff, BlockPos target, Direction direction, SpellStat spellStat) {
        ...
        createHole(worldIn, blockHitResult.getBlockPos(), direction, (byte)Math.round((float)(totalDistance + 1)), this.rightStaff(staff), za.co.infernos.goetied.utils.ConfigHelper.getInt(SpellConfig.TunnelDefaultLifespan, 0) + (extraLife * 20));
