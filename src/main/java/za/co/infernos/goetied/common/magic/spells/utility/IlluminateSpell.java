package za.co.infernos.goetied.common.magic.spells.utility;
...
public class IlluminateSpell extends Spell {
    ...
    public int defaultSoulCost() {
        return za.co.infernos.goetied.utils.ConfigHelper.getInt(SpellConfig.IlluminateCost, 0);
    }
    ...
    public void useSpell(ServerLevel worldIn, LivingEntity caster, ItemStack staff, int castTime, SpellStat spellStat) {
        if (castTime >= za.co.infernos.goetied.utils.ConfigHelper.getInt(SpellConfig.IlluminateChargeUp, 0)) {
            ...
            if (castTime % za.co.infernos.goetied.utils.ConfigHelper.getInt(SpellConfig.IlluminateDuration, 0) == 0) {
    ...
    public boolean tryToPlaceAtPos(ServerLevel world, LivingEntity caster, BlockPos pos) {
        ...
        if (lightLevel > za.co.infernos.goetied.utils.ConfigHelper.getInt(SpellConfig.IlluminateMinLightLevel, 0)) {
            return false;
        }
