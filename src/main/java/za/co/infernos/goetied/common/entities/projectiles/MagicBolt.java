...
import za.co.infernos.goetied.common.entities.util.MagicGround;
...
public class MagicBolt extends SpellHurtingProjectile {
    ...
    protected void onHitEntity(EntityHitResult pResult) {
        ...
        float damage = za.co.infernos.goetied.utils.ConfigHelper.getFloat(SpellConfig.MagicBoltDamage, 1.0F) * WandUtil.damageMultiply();
        boolean flag;
        ...
        if (flag){
            if (target instanceof LivingEntity livingTarget){
                ...
                livingTarget.addEffect(new MobEffectInstance(GoetiedEffects.CURSED, duration));
            }
        }
    }
