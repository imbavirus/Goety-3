...
public class RedstoneMonstrosityHeadBlockEntity extends SkullBlockEntity {
    private UUID ownerUUID;
    private String customName;

    public RedstoneMonstrosityHeadBlockEntity(BlockPos p_155731_, BlockState p_155732_) {
        super(p_155731_, p_155732_);
    }

    @Override
    public BlockEntityType<?> getType() {
        return ModBlockEntities.REDSTONE_MONSTROSITY_HEAD.get();
    }
    ...
    public ResourceLocation getNoteBlockSound() {
        return ModSounds.REDSTONE_MONSTROSITY_AMBIENT.get().getLocation();
    }
