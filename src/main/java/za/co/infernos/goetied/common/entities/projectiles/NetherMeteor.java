...
import za.co.infernos.goetied.utils.ExplosionUtil;
import za.co.infernos.goetied.utils.LootingExplosion;
...
public class NetherMeteor extends ExplosiveProjectile {
    ...
    protected void onHit(HitResult result) {
        ...
        if (!this.level().isClientSide) {
            ...
            if (za.co.infernos.goetied.utils.ConfigHelper.getBoolean(MobsConfig.ApocalypseMode, false) && flag){
