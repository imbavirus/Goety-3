package za.co.infernos.goetied.common.world.features.trees.trunkplacers;
...
public class ModTrunkPlacerTypes {
    public static final DeferredRegister<TrunkPlacerType<?>> TRUNK_PLACER_TYPES = DeferredRegister.create(Registries.TRUNK_PLACER_TYPE, Goetied.MOD_ID);
