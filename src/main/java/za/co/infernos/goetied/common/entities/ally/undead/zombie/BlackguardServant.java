...
public class BlackguardServant extends ZombieServant{
    ...
    public static AttributeSupplier.Builder setCustomAttributes() {
        return Mob.createMobAttributes()
                .add(Attributes.MAX_HEALTH, za.co.infernos.goetied.utils.ConfigHelper.getDouble(AttributesConfig.BlackguardServantHealth, 20.0D))
                .add(Attributes.FOLLOW_RANGE, 35.0D)
                .add(Attributes.MOVEMENT_SPEED, 0.23F)
                .add(Attributes.KNOCKBACK_RESISTANCE, 1.0F)
                .add(Attributes.ATTACK_DAMAGE, za.co.infernos.goetied.utils.ConfigHelper.getDouble(AttributesConfig.BlackguardServantDamage, 20.0D))
                .add(Attributes.ATTACK_KNOCKBACK, 1.0F)
                .add(Attributes.ARMOR, za.co.infernos.goetied.utils.ConfigHelper.getDouble(AttributesConfig.BlackguardServantArmor, 20.0D))
                .add(Attributes.ARMOR_TOUGHNESS, za.co.infernos.goetied.utils.ConfigHelper.getDouble(AttributesConfig.BlackguardServantToughness, 20.0D));
    }

    public void setConfigurableAttributes(){
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.MAX_HEALTH), za.co.infernos.goetied.utils.ConfigHelper.getDouble(AttributesConfig.BlackguardServantHealth, 20.0D));
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.ATTACK_DAMAGE), za.co.infernos.goetied.utils.ConfigHelper.getDouble(AttributesConfig.BlackguardServantDamage, 20.0D));
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.ARMOR), za.co.infernos.goetied.utils.ConfigHelper.getDouble(AttributesConfig.BlackguardServantArmor, 20.0D));
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.ARMOR_TOUGHNESS), za.co.infernos.goetied.utils.ConfigHelper.getDouble(AttributesConfig.BlackguardServantToughness, 20.0D));
    }
    ...
    public int getSummonLimit(LivingEntity owner) {
        return za.co.infernos.goetied.utils.ConfigHelper.getInt(SpellConfig.BlackguardLimit, 16);
    }
