...
public class BulwarkSpell extends Spell {
    ...
    public int defaultSoulCost() {
        return za.co.infernos.goetied.utils.ConfigHelper.getInt(SpellConfig.BulwarkCost, 0);
    }

    @Override
    public int defaultCastDuration() {
        return za.co.infernos.goetied.utils.ConfigHelper.getInt(SpellConfig.BulwarkDuration, 0);
    }
    ...
    public int defaultSpellCooldown() {
        return za.co.infernos.goetied.utils.ConfigHelper.getInt(SpellConfig.BulwarkCoolDown, 0);
    }
    ...
    public void SpellResult(ServerLevel worldIn, LivingEntity caster, ItemStack staff, SpellStat spellStat) {
        int amount = za.co.infernos.goetied.utils.ConfigHelper.getInt(SpellConfig.BulwarkShieldAmount, 0);
        int duration = za.co.infernos.goetied.utils.ConfigHelper.getInt(SpellConfig.BulwarkShieldTime, 0);
