...
/**
 * CastMagicEvent is fired when right-clicking on a block {@link za.co.infernos.goetied.common.items.magic.DarkWand} with a spell. <br>
 * <br>
 * This event is fired via the {@link GoetiedEventFactory#onBlockBasedSpell(LevelAccessor, BlockPos, BlockState, ISpell, Direction, LivingEntity)}.<br>
 * <br>
