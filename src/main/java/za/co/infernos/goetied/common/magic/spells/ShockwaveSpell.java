...
import za.co.infernos.goetied.common.network.server.SSoulExplodePacket;
...
public class ShockwaveSpell extends Spell {
    ...
    public int defaultSoulCost() {
        return za.co.infernos.goetied.utils.ConfigHelper.getInt(SpellConfig.ShockwaveCost, 0);
    }

    @Override
    public int defaultCastDuration() {
        return za.co.infernos.goetied.utils.ConfigHelper.getInt(SpellConfig.ShockwaveDuration, 0);
    }

    @Override
    public int defaultSpellCooldown() {
        return za.co.infernos.goetied.utils.ConfigHelper.getInt(SpellConfig.ShockwaveCoolDown, 0);
    }
    ...
    public void SpellResult(ServerLevel worldIn, LivingEntity caster, ItemStack staff, SpellStat spellStat){
        ...
        float damage = za.co.infernos.goetied.utils.ConfigHelper.getFloat(SpellConfig.ShockwaveDamage, 1.0F) * WandUtil.damageMultiply();
        float maxDamage = za.co.infernos.goetied.utils.ConfigHelper.getFloat(SpellConfig.ShockwaveMaxDamage, 1.0F) * WandUtil.damageMultiply();
