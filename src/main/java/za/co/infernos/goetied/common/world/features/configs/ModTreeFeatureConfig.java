package za.co.infernos.goetied.common.world.features.configs;
...
/**
 * Stolen from @TeamTwilight: <a href="https://github.com/TeamTwilight/twilightforest/blob/1.20.1/src/main/java/twilightforest/world/components/feature/config/TFTreeFeatureConfig.java">...</a>
 */
public class ModTreeFeatureConfig implements FeatureConfiguration {
	public static final Codec<ModTreeFeatureConfig> CODEC = RecordCodecBuilder.create(instance -> instance.group(
	...
	).apply(instance, ModTreeFeatureConfig::new));
	...
	public ModTreeFeatureConfig(BlockStateProvider trunk, BlockStateProvider leaves, BlockStateProvider branch, BlockStateProvider roots, int height, int chanceFiveFirst, int chanceFiveSecond, boolean hasLeaves, boolean checkWater, List<TreeDecorator> decorators) {
	...
	public static class Builder {
		...
		public ModTreeFeatureConfig build() {
			return new ModTreeFeatureConfig(trunkProvider, leavesProvider, branchProvider, rootsProvider, baseHeight, chanceFirstFive, chanceSecondFive, hasLeaves, checkWater, decorators);
		}
	}
}