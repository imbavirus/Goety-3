...
import za.co.infernos.goetied.common.entities.projectiles.IceSpike;
        ...
        protected void castSpell(){
            if (AbstractCairnNecromancer.this.level() instanceof ServerLevel serverLevel) {
                for (int i1 = 0; i1 < 2; ++i1) {
                    ...
                    if (za.co.infernos.goetied.utils.ConfigHelper.getBoolean(MobsConfig.NecromancerSummonsLife, false)) {
