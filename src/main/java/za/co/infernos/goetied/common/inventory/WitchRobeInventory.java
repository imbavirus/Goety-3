package za.co.infernos.goetied.common.inventory;
...
public class WitchRobeInventory extends SimpleContainer implements MenuProvider {
    ...
    public void tick() {
        ...
        for (int a = 0; a < time; ++a) {
            ...
            if (this.fuel <= 0 && itemstack.isStackable() && !itemstack.isEmpty()) {
                this.fuel = 20;
                itemstack.shrink(1);
                this.setChanged();
            }
    ...
    public Component getDisplayName() {
        return Component.translatable("item.goetied.witch_robe.brew");
    }
