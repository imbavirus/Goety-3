...
import za.co.infernos.goetied.client.particles.ReverseShockwaveParticleOption;
import za.co.infernos.goetied.common.entities.ModEntityType;
import za.co.infernos.goetied.common.entities.ally.Doppelganger;
...
import za.co.infernos.goetied.common.network.server.SSetPlayerOwnerPacket;
...
public class IllusionSpell extends Spell {
    public int defaultSoulCost() {
        return za.co.infernos.goetied.utils.ConfigHelper.getInt(SpellConfig.IllusionCost, 0);
    }

    public int defaultCastDuration() {
        return za.co.infernos.goetied.utils.ConfigHelper.getInt(SpellConfig.IllusionDuration, 0);
    }
    ...
    public int defaultSpellCooldown() {
        return za.co.infernos.goetied.utils.ConfigHelper.getInt(SpellConfig.IllusionCoolDown, 0);
    }
