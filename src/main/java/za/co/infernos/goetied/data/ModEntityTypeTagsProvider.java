...
public class ModEntityTypeTagsProvider extends IntrinsicHolderTagsProvider<EntityType<?>> {
    ...
    public ModEntityTypeTagsProvider(PackOutput p_256095_, CompletableFuture<HolderLookup.Provider> p_256572_, @Nullable ExistingFileHelper existingFileHelper) {
        ...
        }, Goetied.MOD_ID, existingFileHelper);
    }
    ...
    protected void addTags(HolderLookup.Provider p_255894_) {
        this.tag(EntityTypeTags.FREEZE_IMMUNE_ENTITY_TYPES).add(
                ...
                ModEntityType.MUCK_WRAITH.get(),
                ModEntityType.MUCK_WRAITH_SERVANT.get(),
        ...
        this.tag(EntityTypeTags.FALL_DAMAGE_IMMUNE).add(
                ...
                ModEntityType.WIND_CALLER_SERVANT.get(),
                ModEntityType.BOUND_EVOKER.get(),
                ModEntityType.BOUND_GEOMANCER.get(),
                ModEntityType.BOUND_ICEOLOGER.get(),
                ModEntityType.BOUND_CRYOLOGER.get(),
                ModEntityType.BOUND_WIND_CALLER.get(),
                ModEntityType.BOUND_STORM_CASTER.get(),
