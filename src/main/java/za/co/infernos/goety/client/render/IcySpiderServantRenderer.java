...
import za.co.infernos.goety.common.entities.ally.spider.IcySpiderServant;
...
public class IcySpiderServantRenderer<T extends IcySpiderServant> extends MobRenderer<T, ModSpiderModel<T>> {
   ...
   public ResourceLocation getTextureLocation(IcySpiderServant p_113972_) {
      if (p_113972_.isHostile() || !za.co.infernos.goety.utils.ConfigHelper.getBoolean(MobsConfig.IcySpiderServantTexture, false)){
