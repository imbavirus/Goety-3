...
public class SwordProjectileRenderer<T extends AbstractArrow & ItemSupplier> extends EntityRenderer<T> {
    ...
    public SwordProjectileRenderer(EntityRendererProvider.Context p_i226035_1_, ItemRenderer p_i226035_2_,
    ...
    public void render(T pEntity, float pEntityYaw, float pPartialTicks, PoseStack pMatrixStack,
        ...
        if (pEntity.tickCount >= 2) {
            ...
            pMatrixStack.mulPose(
                    Axis.ZP.rotationDegrees(Mth.lerp(pPartialTicks, pEntity.xRotO, pEntity.getXRot()) - 45.0F));
            ...
            this.itemRenderer.renderStatic(pEntity.getItem(), ItemDisplayContext.GROUND, pPackedLight,
                    OverlayTexture.NO_OVERLAY, pMatrixStack, pBuffer, pEntity.level(), 0);
