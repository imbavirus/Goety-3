...
import za.co.infernos.goety.client.render.model.MinisterModel;
import za.co.infernos.goety.common.entities.hostile.illagers.Minister;
...
public class MinisterRenderer<T extends Minister> extends MobRenderer<T, MinisterModel<T>> {
    ...
    public ResourceLocation getTextureLocation(T entity) {
        if (HolidayUtil.isChristmasMonth() && za.co.infernos.goety.utils.ConfigHelper.getBoolean(MobsConfig.HolidaySkins, false)){
            return CHRISTMAS;
        }
