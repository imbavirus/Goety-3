...
import za.co.infernos.goety.client.render.model.BlastlingModel;
...
public class BlastlingRenderer<T extends AbstractBlastling> extends MobRenderer<T, BlastlingModel<T>> {
    ...
    public ResourceLocation getTextureLocation(T pEntity) {
        if (pEntity.isHostile() || !za.co.infernos.goety.utils.ConfigHelper.getBoolean(MobsConfig.BlastlingServantTexture, false)) {
