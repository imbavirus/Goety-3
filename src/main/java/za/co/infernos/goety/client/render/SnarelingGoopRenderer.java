...
import za.co.infernos.goety.client.render.model.EntangleVinesModel;
import za.co.infernos.goety.common.entities.projectiles.SnarelingGoop;
...
public class SnarelingGoopRenderer<T extends SnarelingGoop> extends EntityRenderer<T> {
    private static final ResourceLocation TEXTURE_LOCATION = Goety.location("textures/entity/projectiles/snareling_goop.png");
