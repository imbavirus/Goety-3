...
import za.co.infernos.goety.client.render.model.WebSpiderModel;
import za.co.infernos.goety.common.entities.ally.spider.WebSpiderServant;
...
public class WebSpiderServantRenderer<T extends WebSpiderServant> extends MobRenderer<T, WebSpiderModel<T>> {
   ...
   public ResourceLocation getTextureLocation(WebSpiderServant p_113972_) {
      if (p_113972_.isHostile() || !za.co.infernos.goety.utils.ConfigHelper.getBoolean(MobsConfig.WebSpiderServantTexture, false)){
         return ORIGINAL;
      } else {
