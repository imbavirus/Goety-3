...
import za.co.infernos.goety.common.entities.hostile.BoneSpider;
...
public class BoneSpiderRenderer<T extends BoneSpider> extends MobRenderer<T, ModSpiderModel<T>> {
   private static final ResourceLocation BONE_SPIDER_LOCATION = Goety.location("textures/entity/servants/spider/bone_spider_original.png");

   public BoneSpiderRenderer(EntityRendererProvider.Context p_173946_) {
   ...
   public ResourceLocation getTextureLocation(BoneSpider p_113972_) {
