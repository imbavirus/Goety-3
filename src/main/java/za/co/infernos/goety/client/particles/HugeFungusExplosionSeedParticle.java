...
public class HugeFungusExplosionSeedParticle extends NoRenderParticle {
   ...
   HugeFungusExplosionSeedParticle(ClientLevel p_106947_, double p_106948_, double p_106949_, double p_106950_) {
   ...
   public void tick() {
      for(int i = 0; i < 6; ++i) {
         ...
         this.level.addParticle(ModParticleTypes.FUNGUS_EXPLOSION.get(), d0, d1, d2, (double)((float)this.life / (float)this.lifeTime), 0.0D, 0.0D);
      }
