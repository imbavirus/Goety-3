...
import za.co.infernos.goety.client.render.model.GuardianServantModel;
...
public class GuardianServantRenderer extends MobRenderer<GuardianServant, GuardianServantModel> {
   ...
   public ResourceLocation getTextureLocation(GuardianServant p_114827_) {
      if (p_114827_.isHostile() || !za.co.infernos.goety.utils.ConfigHelper.getBoolean(MobsConfig.GuardianServantTexture, false)){
