...
import za.co.infernos.goety.client.render.model.TropicalSlimeModel;
...
public class TropicalSlimeServantRenderer
   ...
   public ResourceLocation getTextureLocation(TropicalSlimeServant p_115974_) {
      if (p_115974_.isHostile() || !za.co.infernos.goety.utils.ConfigHelper.getBoolean(MobsConfig.SlimeServantTexture, false)) {
         return ORIGINAL;
      }
