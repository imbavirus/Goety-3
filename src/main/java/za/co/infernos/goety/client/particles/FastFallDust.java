...
public class FastFallDust extends TextureSheetParticle {
    private final float rotSpeed;
    private final SpriteSet sprites;

    public FastFallDust(ClientLevel p_106610_, double p_106611_, double p_106612_, double p_106613_, float p_106614_, float p_106615_, float p_106616_, SpriteSet p_106617_) {
    ...
    public static class Provider implements ParticleProvider<BlockParticleOption> {
        ...
        public Particle createParticle(BlockParticleOption p_106636_, ClientLevel p_106637_, double p_106638_, double p_106639_, double p_106640_, double p_106641_, double p_106642_, double p_106643_) {
            ...
            if (!blockstate.isAir() && blockstate.getRenderShape() == RenderShape.INVISIBLE) {
                ...
                return new FastFallDust(p_106637_, p_106638_, p_106639_, p_106640_, f, f1, f2, this.sprite);
            }
        }
    }
}