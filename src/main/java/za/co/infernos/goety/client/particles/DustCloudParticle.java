...
public class DustCloudParticle extends TextureSheetParticle {
   ...
   DustCloudParticle(ClientLevel p_105856_, double p_105857_, double p_105858_, double p_105859_, double p_105860_,
         double p_105861_, double p_105862_, SpriteSet spriteSet) {
   ...
   public static class Provider implements ParticleProvider<DustCloudParticleOption> {
      ...
      public Particle createParticle(DustCloudParticleOption p_105889_, ClientLevel p_105890_, double p_105891_,
