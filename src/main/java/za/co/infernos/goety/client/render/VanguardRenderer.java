...
import za.co.infernos.goety.client.render.model.VanguardModel;
...
public class VanguardRenderer<T extends VanguardServant> extends MobRenderer<T, VanguardModel<T>> {
   ...
   public ResourceLocation getTextureLocation(T p_116410_) {
      if (!za.co.infernos.goety.utils.ConfigHelper.getBoolean(MobsConfig.VanguardServantTexture, false)){
         return TEXTURE_2;
      }
      return TEXTURE;
   }
