...
import za.co.infernos.goety.client.render.model.WatchlingModel;
...
public class WatchlingRenderer<T extends AbstractWatchling> extends MobRenderer<T, WatchlingModel<T>> {
    ...
    public ResourceLocation getTextureLocation(T pEntity) {
        if (pEntity.isHostile() || !za.co.infernos.goety.utils.ConfigHelper.getBoolean(MobsConfig.WatchlingServantTexture, false)) {
    ...
    public static class GlowLayer<T extends AbstractWatchling, M extends WatchlingModel<T>> extends EyesLayer<T, M> {
        private static final RenderType RENDER_TYPE = ModRenderType
                .eyes(Goety.location("textures/entity/enderling/watchling_glow.png"));
        private static final RenderType SERVANT_TYPE = ModRenderType
                .eyes(Goety.location("textures/entity/enderling/servants/watchling_glow.png"));
