...
public abstract class GroundCircleParticle extends TextureSheetParticle {
    ...
    protected GroundCircleParticle(ClientLevel p_108328_, double p_108329_, double p_108330_, double p_108331_,
            double p_108332_, double p_108333_, double p_108334_) {
    ...
    public void makeCornerVertex(VertexConsumer p_233994_, Vector3f p_233995_, float p_233996_, float p_233997_,
            int p_233998_) {
        p_233994_.addVertex(p_233995_.x(), p_233995_.y(), p_233995_.z())
