...
import za.co.infernos.goety.client.render.model.WarlockServantModel;
import za.co.infernos.goety.common.entities.ally.illager.WarlockServant;
...
public class WarlockServantRenderer extends MobRenderer<WarlockServant, WarlockServantModel<WarlockServant>> {
   ...
   public ResourceLocation getTextureLocation(WarlockServant p_116410_) {
      if (p_116410_.isHostile() || !za.co.infernos.goety.utils.ConfigHelper.getBoolean(MobsConfig.WarlockServantTexture, false)) {
         return ORIGINAL;
      }
