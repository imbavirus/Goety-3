...
import za.co.infernos.goety.client.render.model.BlackBeastModel;
...
public class BlackBeastRenderer<T extends BlackBeast> extends MobRenderer<T, BlackBeastModel<T>> {
    ...
    private static final ResourceLocation PRINCESS = Goety
            .location("textures/entity/servants/black_wolf/black_beast_princess.png");
    protected static final ResourceLocation DEATH = Goety
