...
import za.co.infernos.goety.client.render.model.PoisonQuillVineModel;
import za.co.infernos.goety.common.entities.neutral.PoisonAnemone;
import za.co.infernos.goety.common.entities.neutral.PoisonQuillVine;
...
public class PoisonQuillVineRenderer<T extends PoisonQuillVine> extends MobRenderer<T, PoisonQuillVineModel<T>> {
    ...
    public ResourceLocation getTextureLocation(T pEntity) {
        if (pEntity instanceof PoisonAnemone){
            return ANEMONE;
        } else if (pEntity.isHostile() || !za.co.infernos.goety.utils.ConfigHelper.getBoolean(MobsConfig.PoisonQuillVineTexture, false)){
            return ORIGINAL;
        } else {
    ...
    public static class GlowLayer<T extends PoisonQuillVine, M extends PoisonQuillVineModel<T>> extends EyesLayer<T, M> {
        ...
        public void render(PoseStack p_116983_, MultiBufferSource p_116984_, int p_116985_, T p_116986_, float p_116987_, float p_116988_, float p_116989_, float p_116990_, float p_116991_, float p_116992_) {
            if (!p_116986_.isInvisible()) {
                ...
                } else if (p_116986_.isHostile() || !za.co.infernos.goety.utils.ConfigHelper.getBoolean(MobsConfig.PoisonQuillVineTexture, false)) {
