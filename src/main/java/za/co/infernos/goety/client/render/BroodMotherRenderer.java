...
import za.co.infernos.goety.client.render.model.BroodMotherModel;
...
public class BroodMotherRenderer<T extends AbstractBroodMother> extends MobRenderer<T, BroodMotherModel<T>> {
   ...
   public ResourceLocation getTextureLocation(T p_116009_) {
      boolean old = za.co.infernos.goety.utils.ConfigHelper.getBoolean(MobsConfig.BroodMotherOldTexture, false);
