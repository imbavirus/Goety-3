...
import za.co.infernos.goety.client.render.model.ModWitchModel;
...
public class WitchServantRenderer extends MobRenderer<WitchServant, ModWitchModel<WitchServant>> {
   ...
   public ResourceLocation getTextureLocation(WitchServant p_116410_) {
      if (p_116410_.isHostile() || !za.co.infernos.goety.utils.ConfigHelper.getBoolean(MobsConfig.WitchServantTexture, false)) {
         return ORIGINAL;
      }
