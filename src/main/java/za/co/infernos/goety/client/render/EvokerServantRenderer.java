...
import za.co.infernos.goety.common.entities.ally.illager.EvokerServant;
...
public class EvokerServantRenderer<T extends EvokerServant> extends MobRenderer<T, IllagerServantModel<T>> {
    ...
    public ResourceLocation getTextureLocation(T entity) {
        if (entity.isHostile() || !za.co.infernos.goety.utils.ConfigHelper.getBoolean(MobsConfig.EvokerServantTexture, false)){
            return ORIGINAL;
        } else {
            return TEXTURE;
        }
