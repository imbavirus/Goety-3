...
import za.co.infernos.goety.client.render.model.WhispererModel;
...
public class WhispererRenderer<T extends Whisperer> extends MobRenderer<T, WhispererModel<T>> {
    ...
    private static final ResourceLocation ORIGINAL = Goety
    ...
    public ResourceLocation getTextureLocation(T pEntity) {
        if (pEntity instanceof Wavewhisperer) {
            return WAVE;
        } else if (pEntity.isHostile() || !za.co.infernos.goety.utils.ConfigHelper.getBoolean(MobsConfig.WhispererTexture, false)) {
            return ORIGINAL;
        } else {
    ...
    public static class GlowLayer<T extends Whisperer, M extends WhispererModel<T>> extends EyesLayer<T, M> {
        private static final RenderType RENDER_TYPE = RenderType
                .eyes(Goety.location("textures/entity/servants/whisperer/whisperer_glow.png"));
        private static final RenderType ORIGINAL = RenderType
                .eyes(Goety.location("textures/entity/servants/whisperer/whisperer_original_glow.png"));
        private static final RenderType WAVE = RenderType
                .eyes(Goety.location("textures/entity/servants/whisperer/wavewhisperer_glow.png"));
        ...
        public void render(PoseStack p_116983_, MultiBufferSource p_116984_, int p_116985_, T p_116986_,
            ...
            if (!p_116986_.isInvisible()) {
                ...
                } else if (p_116986_.isHostile() || !za.co.infernos.goety.utils.ConfigHelper.getBoolean(MobsConfig.WhispererTexture, false)) {
