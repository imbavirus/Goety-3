...
import za.co.infernos.goety.client.render.model.MinionModel;
...
public class AllyVexRenderer extends MobRenderer<AllyVex, MinionModel<AllyVex>> {
    ...
    public static class AllyVexBandsLayer extends RenderLayer<AllyVex, MinionModel<AllyVex>> {
        ...
        public void render(PoseStack pMatrixStack, MultiBufferSource pBuffer, int pPackedLight, AllyVex pLivingEntity,
                ...
                float pHeadPitch) {
            if (za.co.infernos.goety.utils.ConfigHelper.getBoolean(MobsConfig.VexTexture, false) && !pLivingEntity.isHostile()) {
