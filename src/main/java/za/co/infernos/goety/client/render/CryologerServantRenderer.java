...
import za.co.infernos.goety.client.render.model.CryologerModel;
...
public class CryologerServantRenderer<T extends CryologerServant> extends MobRenderer<T, CryologerModel<T>> {
    ...
    public ResourceLocation getTextureLocation(T entity) {
        if (entity.isHostile() || !za.co.infernos.goety.utils.ConfigHelper.getBoolean(MobsConfig.CryologerServantTexture, false)){
            return ORIGINAL;
        } else {
            return TEXTURE;
        }
