...
import za.co.infernos.goety.client.render.model.LeapleafModel;
...
public class LeapleafRenderer<T extends Leapleaf> extends MobRenderer<T, LeapleafModel<T>> {
    ...
    public ResourceLocation getTextureLocation(T pEntity) {
        if (pEntity.isHostile() || !za.co.infernos.goety.utils.ConfigHelper.getBoolean(MobsConfig.LeapleafTexture, false)) {
            return ORIGINAL;
        }
    ...
    public static class GlowLayer<T extends Leapleaf, M extends LeapleafModel<T>> extends EyesLayer<T, M> {
        private static final RenderType RENDER_TYPE = RenderType
                .eyes(Goety.location("textures/entity/servants/leapleaf/leapleaf_glow.png"));
        private static final RenderType ORIGINAL = RenderType
                .eyes(Goety.location("textures/entity/servants/leapleaf/leapleaf_original_glow.png"));
        ...
        public void render(PoseStack p_116983_, MultiBufferSource p_116984_, int p_116985_, T p_116986_,
            ...
            if (!p_116986_.isInvisible()) {
                ...
                if (p_116986_.isHostile() || !za.co.infernos.goety.utils.ConfigHelper.getBoolean(MobsConfig.LeapleafTexture, false)) {
