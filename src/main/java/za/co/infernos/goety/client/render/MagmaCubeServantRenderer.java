...
import za.co.infernos.goety.client.render.model.MagmaCubeServantModel;
...
public class MagmaCubeServantRenderer extends MobRenderer<MagmaCubeServant, MagmaCubeServantModel<MagmaCubeServant>> {
   ...
   public ResourceLocation getTextureLocation(MagmaCubeServant p_115393_) {
      if (p_115393_.isHostile() || !za.co.infernos.goety.utils.ConfigHelper.getBoolean(MobsConfig.MagmaCubeServantTexture, false)){
         return ORIGINAL;
      }
