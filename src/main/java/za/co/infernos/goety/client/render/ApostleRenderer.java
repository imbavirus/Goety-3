...
import za.co.infernos.goety.client.render.model.ApostleModel;
import za.co.infernos.goety.client.render.model.CultistModel;
...
public class ApostleRenderer extends CultistRenderer<Apostle> {
    ...
    public void render(Apostle pEntity, float pEntityYaw, float pPartialTicks, PoseStack pMatrixStack,
        ...
        if (pEntity.deathTime > 0) {
            ...
            float f8 = za.co.infernos.goety.utils.ConfigHelper.getBoolean(MobsConfig.FancierApostleDeath, false) || pEntity.level().dimension() == Level.NETHER ? 300.0F
                    : 30.0F;
            ...
            if (za.co.infernos.goety.utils.ConfigHelper.getBoolean(MobsConfig.FancierApostleDeath, false) || pEntity.level().dimension() == Level.NETHER) {
