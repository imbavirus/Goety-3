...
import za.co.infernos.goety.common.entities.neutral.TotemicBomb;
...
import za.co.infernos.goety.common.entities.util.TridentStorm;
...
import za.co.infernos.goety.init.ModAttributes;
...
public class WandUtil {
    ...
    public static float damageMultiply() {
        return (float) (za.co.infernos.goety.utils.ConfigHelper.getInt(SpellConfig.SpellDamageMultiplier, 1) * za.co.infernos.goety.utils.ConfigHelper.getDouble(SpellConfig.SpellDamageMultiplierDecimal, 1.0D));
    }
