...
import za.co.infernos.goety.client.render.IceBouquetTextures;
    ...
    public void handleEntityEvent(byte pId) {
        ...
        if (pId == 8){
            if (!this.isSilent()) {
                ...
                this.level().addParticle(za.co.infernos.goety.client.particles.ModParticleTypes.ELECTRIC.get(), this.getRandomX(0.5D), this.getRandomY(), this.getRandomZ(0.5D), 0.0D, 0.0D, 0.0D);
                this.level().playLocalSound(this.getX(), this.getY(), this.getZ(), ModSounds.FIRE_PROJECTILE_FLY.get(), this.getSoundSource(), 0.3F, 1.3F, false);
            }
        }
