...
import za.co.infernos.goety.client.render.HauntedSkullTextures;
import za.co.infernos.goety.common.enchantments.ModEnchantments;
import za.co.infernos.goety.common.entities.ModEntityType;
import za.co.infernos.goety.common.entities.hostile.BoneLord;
import za.co.infernos.goety.common.entities.hostile.SkullLord;
...
public class HauntedSkullProjectile extends ExplosiveProjectile {
    ...
    public float damage = za.co.infernos.goety.utils.ConfigHelper.getFloat(SpellConfig.HauntedSkullDamage, 1.0F) * WandUtil.damageMultiply();
    ...
    public void explode() {
        if (!this.level().isClientSide) {
            ...
            if (this.getOwner() instanceof Player) {
                damaging = za.co.infernos.goety.utils.ConfigHelper.getBoolean(SpellConfig.HauntedSkullGriefing, false);
            } else {
