...
import za.co.infernos.goety.api.entities.ITrainable;
import za.co.infernos.goety.api.entities.ally.illager.ILooter;
import za.co.infernos.goety.client.particles.ModParticleTypes;
import za.co.infernos.goety.common.blocks.entities.OminousPyreBlockEntity;
...
import za.co.infernos.goety.common.entities.ai.IllagerLootFoodChestGoal;
import za.co.infernos.goety.common.entities.ai.IllagerPutFoodChestGoal;
import za.co.infernos.goety.common.entities.ai.IllagerPutLootChestGoal;
...
public abstract class AbstractIllagerServant extends RaiderServant implements ITrainable, ILooter {
    ...
    public int getTotalTrainTime() {
        return MathHelper.secondsToTicks(za.co.infernos.goety.utils.ConfigHelper.getInt(MobsConfig.IllagerServantTrainTime, 0));
    }
    ...
    public boolean canTrain(Level level, BlockPos blockPos, EntityType<? extends Mob> entityType) {
        boolean flag = true;
        if (!za.co.infernos.goety.utils.ConfigHelper.getBoolean(MobsConfig.IllagerServantAutoTrain, false)) {
    ...
    public boolean canOpenDoors() {
        return za.co.infernos.goety.utils.ConfigHelper.getBoolean(MobsConfig.IllagerServantAllOpenDoors, false);
    }
    ...
    public boolean canBreed() {
        boolean flag = true;
        if (!za.co.infernos.goety.utils.ConfigHelper.getBoolean(MobsConfig.IllagerServantAllBreed, false)) {
    ...
    public boolean canPickUpLoot() {
        return za.co.infernos.goety.utils.ConfigHelper.getBoolean(MobsConfig.IllagerServantPickUpDrops, false);
    }
    ...
    public int trainSpeed(EntityType<? extends Mob> entityType) {
        ...
        i += Mth.clamp(list.size(), 0, za.co.infernos.goety.utils.ConfigHelper.getInt(MobsConfig.IllagerServantMaxMentors, 0));
        return i;
    }
