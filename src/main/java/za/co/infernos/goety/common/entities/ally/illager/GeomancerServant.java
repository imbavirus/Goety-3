...
import za.co.infernos.goety.common.entities.ally.undead.bound.BoundGeomancer;
...
public class GeomancerServant extends SpellcasterIllagerServant{
    private static final EntityDataAccessor<Integer> ANIM_STATE = SynchedEntityData.defineId(GeomancerServant.class, EntityDataSerializers.INT);
    public int spellCool;
    public AnimationState idleAnimationState = new AnimationState();
    public AnimationState walkAnimationState = new AnimationState();
    public AnimationState attackAnimationState = new AnimationState();

    public GeomancerServant(EntityType<? extends Owned> type, Level worldIn) {
        super(type, worldIn);
    }
    ...
    public static AttributeSupplier.Builder setCustomAttributes() {
        return Monster.createMonsterAttributes()
                ...
                .add(Attributes.FOLLOW_RANGE, za.co.infernos.goety.utils.ConfigHelper.getDouble(AttributesConfig.GeomancerServantFollowRange, 20.0D))
                .add(Attributes.ARMOR, za.co.infernos.goety.utils.ConfigHelper.getDouble(AttributesConfig.GeomancerServantArmor, 20.0D))
                .add(Attributes.MAX_HEALTH, za.co.infernos.goety.utils.ConfigHelper.getDouble(AttributesConfig.GeomancerServantHealth, 20.0D));
    }

    public void setConfigurableAttributes(){
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.MAX_HEALTH), za.co.infernos.goety.utils.ConfigHelper.getDouble(AttributesConfig.GeomancerServantHealth, 20.0D));
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.ARMOR), za.co.infernos.goety.utils.ConfigHelper.getDouble(AttributesConfig.GeomancerServantArmor, 20.0D));
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.FOLLOW_RANGE), za.co.infernos.goety.utils.ConfigHelper.getDouble(AttributesConfig.GeomancerServantFollowRange, 20.0D));
    }
    ...
    public static class GeomancyGoal extends Goal {
        public GeomancerServant geomancer;
        public int spellTick;

        public GeomancyGoal(GeomancerServant geomancer){
