...
import za.co.infernos.goety.common.network.client.CBeamPacket;
...
public abstract class AbstractBeam extends Entity implements ISpellEntity {
    ...
    public void tick() {
        ...
        if (owner != null && owner.isAlive() && za.co.infernos.goety.utils.ConfigHelper.getBoolean(SpellConfig.CorruptionImmobile, false)){
