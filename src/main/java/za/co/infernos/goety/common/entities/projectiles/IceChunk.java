...
import za.co.infernos.goety.client.particles.GatherFrostParticle;
...
import za.co.infernos.goety.common.entities.neutral.GlacialWall;
...
public class IceChunk extends SpellEntity {
    ...
    public void damageTargets(LivingEntity livingEntity){
        float damage = za.co.infernos.goety.utils.ConfigHelper.getFloat(SpellConfig.IceChunkDamage, 1.0F) * WandUtil.damageMultiply();
