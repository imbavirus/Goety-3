...
public class FangSpell extends Spell {
    ...
    public int defaultSoulCost() {
        return za.co.infernos.goety.utils.ConfigHelper.getInt(SpellConfig.FangCost, 0);
    }

    public int defaultCastDuration() {
        return za.co.infernos.goety.utils.ConfigHelper.getInt(SpellConfig.FangDuration, 0);
    }
    ...
    public int defaultSpellCooldown() {
        return za.co.infernos.goety.utils.ConfigHelper.getInt(SpellConfig.FangCoolDown, 0);
    }
    ...
    public List<Enchantment> acceptedEnchantments() {
        ...
        if (za.co.infernos.goety.utils.ConfigHelper.getInt(SpellConfig.FangGainSouls, 0) > 0){
