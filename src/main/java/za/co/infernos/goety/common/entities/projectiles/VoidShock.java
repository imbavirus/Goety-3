...
import za.co.infernos.goety.client.particles.SparkleParticleOption;
...
public class VoidShock extends SpellEntity {
    ...
    public float baseDamage = za.co.infernos.goety.utils.ConfigHelper.getFloat(SpellConfig.VoidShockDamage, 1.0F) * WandUtil.damageMultiply();
    public int life;
