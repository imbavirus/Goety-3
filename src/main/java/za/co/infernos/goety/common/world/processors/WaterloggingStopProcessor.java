...
/**
 * Based from @TelepathicGrunt's codes "<a href="https://github.com/TelepathicGrunt/RepurposedStructures/blob/1.19.0-Forge/src/main/java/com/telepathicgrunt/repurposedstructures/world/processors/WaterloggingFixProcessor.java">...</a>".
 */
public class WaterloggingStopProcessor extends StructureProcessor {

    public static final Codec<WaterloggingStopProcessor> CODEC = Codec.unit(WaterloggingStopProcessor::new);

    private WaterloggingStopProcessor() {
    }
    ...
    protected StructureProcessorType<?> getType() {
        return ModProcessors.WATERLOGGING_STOP_PROCESSOR.get();
    }
}