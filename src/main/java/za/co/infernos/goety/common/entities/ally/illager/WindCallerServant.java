...
import za.co.infernos.goety.common.entities.ally.undead.bound.BoundWindCaller;
import za.co.infernos.goety.common.entities.neutral.Owned;
import za.co.infernos.goety.common.items.ModItems;
import za.co.infernos.goety.common.magic.spells.wind.UpdraftSpell;
import za.co.infernos.goety.common.magic.spells.wind.WindBlastSpell;
...
public class WindCallerServant extends SpellcasterIllagerServant{
    ...
    public static AttributeSupplier.Builder setCustomAttributes() {
        return Monster.createMonsterAttributes()
                ...
                .add(Attributes.FOLLOW_RANGE, za.co.infernos.goety.utils.ConfigHelper.getDouble(AttributesConfig.WindCallerServantFollowRange, 20.0D))
                .add(Attributes.ARMOR, za.co.infernos.goety.utils.ConfigHelper.getDouble(AttributesConfig.WindCallerServantArmor, 20.0D))
                .add(Attributes.MAX_HEALTH, za.co.infernos.goety.utils.ConfigHelper.getDouble(AttributesConfig.WindCallerServantHealth, 20.0D));
    }

    public void setConfigurableAttributes(){
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.MAX_HEALTH), za.co.infernos.goety.utils.ConfigHelper.getDouble(AttributesConfig.WindCallerServantHealth, 20.0D));
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.ARMOR), za.co.infernos.goety.utils.ConfigHelper.getDouble(AttributesConfig.WindCallerServantArmor, 20.0D));
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.FOLLOW_RANGE), za.co.infernos.goety.utils.ConfigHelper.getDouble(AttributesConfig.WindCallerServantFollowRange, 20.0D));
    }
