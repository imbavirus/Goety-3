...
import za.co.infernos.goety.api.magic.SpellPoses;
...
public class FlyingSpell extends EverChargeSpell {
    ...
    public int defaultSoulCost() {
        return za.co.infernos.goety.utils.ConfigHelper.getInt(SpellConfig.FlyingCost, 0);
    }

    @Override
    public int defaultCastUp() {
        return za.co.infernos.goety.utils.ConfigHelper.getInt(SpellConfig.FlyingChargeUp, 0);
    }
