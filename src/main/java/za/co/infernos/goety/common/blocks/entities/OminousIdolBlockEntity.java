...
import za.co.infernos.goety.common.blocks.OminousIdolBlock;
import za.co.infernos.goety.common.entities.ally.illager.RaiderServant;
import za.co.infernos.goety.common.items.block.OminousIdolBlockItem;
...
public class OminousIdolBlockEntity extends OwnedBlockEntity {
    ...
    public boolean hasSpace() {
        return this.getIllagers().size() < za.co.infernos.goety.utils.ConfigHelper.getInt(MainConfig.OminousIdolLimit, 0);
    }
