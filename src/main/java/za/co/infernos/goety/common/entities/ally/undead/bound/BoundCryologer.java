package za.co.infernos.goety.common.entities.ally.undead.bound;

import za.co.infernos.goety.api.entities.IBreathing;
import za.co.infernos.goety.common.effects.GoetyEffects;
import za.co.infernos.goety.common.entities.ModEntityType;
import za.co.infernos.goety.common.entities.ai.AvoidTargetGoal;
import za.co.infernos.goety.common.entities.ai.BreathingAttackGoal;
import za.co.infernos.goety.common.entities.neutral.AbstractMonolith;
import za.co.infernos.goety.common.items.ModItems;
import za.co.infernos.goety.common.magic.spells.frost.HailSpell;
import za.co.infernos.goety.common.magic.spells.frost.IceChunkSpell;
...
public class BoundCryologer extends AbstractBoundIllager implements IBreathing {
    ...
    public static AttributeSupplier.Builder setCustomAttributes(){
        return Mob.createMobAttributes()
                ...
                .add(Attributes.MAX_HEALTH, za.co.infernos.goety.utils.ConfigHelper.getDouble(AttributesConfig.CryologerHealth, 20.0D))
                .add(Attributes.ARMOR, za.co.infernos.goety.utils.ConfigHelper.getDouble(AttributesConfig.CryologerArmor, 20.0D))
                .add(Attributes.MOVEMENT_SPEED, 0.5D)
                .add(Attributes.FLYING_SPEED, 0.15D)
                .add(Attributes.ATTACK_DAMAGE, za.co.infernos.goety.utils.ConfigHelper.getDouble(AttributesConfig.CryologerDamage, 20.0D));
    }

    public void setConfigurableAttributes(){
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.MAX_HEALTH), za.co.infernos.goety.utils.ConfigHelper.getDouble(AttributesConfig.CryologerHealth, 20.0D));
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.ARMOR), za.co.infernos.goety.utils.ConfigHelper.getDouble(AttributesConfig.CryologerArmor, 20.0D));
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.ATTACK_DAMAGE), za.co.infernos.goety.utils.ConfigHelper.getDouble(AttributesConfig.CryologerDamage, 20.0D));
    }
