...
import za.co.infernos.goety.common.entities.ally.undead.MuckWraithServant;
...
import za.co.infernos.goety.common.entities.ally.undead.zombie.JungleZombieServant;
        ...
        protected void castSpell(){
            if (AbstractMossyNecromancer.this.level() instanceof ServerLevel serverLevel) {
                for (int i1 = 0; i1 < 2; ++i1) {
                    ...
                    if (za.co.infernos.goety.utils.ConfigHelper.getBoolean(MobsConfig.NecromancerSummonsLife, false)) {
