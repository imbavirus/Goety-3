package za.co.infernos.goety.common.entities.ally.golem;
...
import za.co.infernos.goety.common.items.block.RedstoneMonstrosityHeadItem;
...
public class RedstoneMonstrosity extends RaiderGolemServant implements PlayerRideable, IAutoRideable, IRM {
    ...
    public void setConfigurableAttributes() {
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.MAX_HEALTH),
                za.co.infernos.goety.utils.ConfigHelper.getDouble(AttributesConfig.RedstoneMonstrosityHealth, 20.0D));
        ...
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.ATTACK_DAMAGE),
                za.co.infernos.goety.utils.ConfigHelper.getDouble(AttributesConfig.RedstoneMonstrosityDamage, 20.0D));
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.FOLLOW_RANGE),
                za.co.infernos.goety.utils.ConfigHelper.getDouble(AttributesConfig.RedstoneMonstrosityFollowRange, 20.0D));
    }
        ...
        public void hurtTarget(Entity target) {
            ...
            if (target instanceof LivingEntity livingEntity) {
                f += (livingEntity.getMaxHealth()
                        * (float)za.co.infernos.goety.utils.ConfigHelper.getDouble(AttributesConfig.RedstoneMonstrosityHPPercentDamage, 20.0D));
            }
