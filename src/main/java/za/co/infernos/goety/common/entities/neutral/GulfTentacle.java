...
import za.co.infernos.goety.common.network.server.STentacleRangePacket;
...
public class GulfTentacle extends Owned {
    ...
    public static AttributeSupplier.Builder setCustomAttributes(){
        return Mob.createMobAttributes()
                .add(Attributes.ATTACK_DAMAGE, za.co.infernos.goety.utils.ConfigHelper.getDouble(SpellConfig.WaterWhipDamage, 20.0D) * WandUtil.damageMultiply());
    }

    @Override
    public void setConfigurableAttributes() {
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.ATTACK_DAMAGE), za.co.infernos.goety.utils.ConfigHelper.getDouble(SpellConfig.WaterWhipDamage, 20.0D) * WandUtil.damageMultiply());
    }
