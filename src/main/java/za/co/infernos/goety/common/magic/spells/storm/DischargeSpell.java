...
public class DischargeSpell extends Spell {
    ...
    public int defaultSoulCost() {
        return za.co.infernos.goety.utils.ConfigHelper.getInt(SpellConfig.DischargeCost, 0);
    }

    @Override
    public int defaultCastDuration() {
        return za.co.infernos.goety.utils.ConfigHelper.getInt(SpellConfig.DischargeDuration, 0);
    }

    @Override
    public int defaultSpellCooldown() {
        return za.co.infernos.goety.utils.ConfigHelper.getInt(SpellConfig.DischargeCoolDown, 0);
    }
    ...
    public void SpellResult(ServerLevel worldIn, LivingEntity caster, ItemStack staff, SpellStat spellStat){
        ...
        float damage = za.co.infernos.goety.utils.ConfigHelper.getFloat(SpellConfig.DischargeDamage, 1.0F) * WandUtil.damageMultiply();
        float maxDamage = za.co.infernos.goety.utils.ConfigHelper.getFloat(SpellConfig.DischargeMaxDamage, 1.0F) * WandUtil.damageMultiply();
