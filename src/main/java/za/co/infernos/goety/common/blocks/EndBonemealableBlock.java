...
public class EndBonemealableBlock extends Block implements BonemealableBlock {

    public EndBonemealableBlock(Properties p_49795_) {
        super(p_49795_);
    }
    ...
    public void performBonemeal(ServerLevel p_221270_, RandomSource p_221271_, BlockPos p_221272_, BlockState p_221273_) {
        ...
        for(int i = 0; i < 128; ++i) {
            ...
            if (blockstate1.isAir() && blockstate2.is(this)) {
                ResourceKey<ConfiguredFeature<?, ?>> resourcekey = ConfiguredFeatures.END_VEGETATION_BONEMEAL;
