...
public class FeastSpell extends ChargingSpell {
    ...
    public int defaultSoulCost() {
        return za.co.infernos.goety.utils.ConfigHelper.getInt(SpellConfig.FeastCost, 0);
    }

    @Override
    public int defaultCastUp() {
        return za.co.infernos.goety.utils.ConfigHelper.getInt(SpellConfig.FeastChargeUp, 0);
    }

    @Override
    public int Cooldown() {
        return za.co.infernos.goety.utils.ConfigHelper.getInt(SpellConfig.FeastDuration, 0);
    }
