...
import za.co.infernos.goety.client.particles.PortalShockwaveParticleOption;
...
import za.co.infernos.goety.common.entities.neutral.ZPiglinBruteServant;
import za.co.infernos.goety.common.entities.neutral.ZPiglinServant;
import za.co.infernos.goety.common.entities.util.SummonCircle;
...
public class ObsidianMonolith extends AbstractMonolith implements Enemy {
    ...
    public static AttributeSupplier.Builder setCustomAttributes() {
        return Mob.createMobAttributes()
                .add(Attributes.MAX_HEALTH, za.co.infernos.goety.utils.ConfigHelper.getDouble(AttributesConfig.ObsidianMonolithHealth, 20.0D))
                .add(Attributes.MOVEMENT_SPEED, 0.0D)
                .add(Attributes.ARMOR, za.co.infernos.goety.utils.ConfigHelper.getDouble(AttributesConfig.ObsidianMonolithArmor, 20.0D))
    ...
    public void setConfigurableAttributes() {
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.MAX_HEALTH),
                za.co.infernos.goety.utils.ConfigHelper.getDouble(AttributesConfig.ObsidianMonolithHealth, 20.0D));
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.ARMOR), za.co.infernos.goety.utils.ConfigHelper.getDouble(AttributesConfig.ObsidianMonolithArmor, 20.0D));
    }
