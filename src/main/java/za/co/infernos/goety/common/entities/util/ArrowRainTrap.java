...
import za.co.infernos.goety.utils.ConstantPaths;
    ...
    public void tick() {
        ...
        if (this.getOwner() != null) {
            if (this.getOwner() instanceof Apostle apostle){
                ...
                AbstractArrow abstractarrowentity = apostle.getArrow(itemstack, Math.max(za.co.infernos.goety.utils.ConfigHelper.getInt(AttributesConfig.ApostleBowDamage, 2) / 2.0F, 1.0F));
