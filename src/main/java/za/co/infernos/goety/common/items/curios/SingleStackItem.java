    ...
    public void appendHoverText(ItemStack stack, Item.TooltipContext context, List<Component> tooltip, TooltipFlag flagIn) {
        ...
        if (stack.getItem() instanceof SingleStackItem) {
            ...
            if (stack.is(ModItems.VOID_CROWN.get())){
                tooltip.add(Component.translatable("info.goety.void_crown").withStyle(main));
                tooltip.add(Component.translatable("info.goety.void_crown_cast").withStyle(secondary));
            }
            ...
            if (stack.getItem() instanceof FrostRobeItem) {
                if (za.co.infernos.goety.utils.ConfigHelper.getInt(ItemConfig.FrostRobeResistance, 0) > 0) {
                    tooltip.add(Component.translatable("info.goety.frost_robe", za.co.infernos.goety.utils.ConfigHelper.getInt(ItemConfig.FrostRobeResistance, 0)).withStyle(main));
                }
            ...
            if (stack.getItem() instanceof WindyRobeItem) {
                ...
                if (stack.is(ModItems.STORM_ROBE.get())) {
                    if (za.co.infernos.goety.utils.ConfigHelper.getInt(ItemConfig.StormRobeResistance, 0) > 0) {
                        tooltip.add(Component.translatable("info.goety.storm_robe", za.co.infernos.goety.utils.ConfigHelper.getInt(ItemConfig.StormRobeResistance, 0)).withStyle(main));
                    }
            ...
            if (stack.getItem() instanceof VoidRobeItem) {
                tooltip.add(Component.translatable("info.goety.void_robe", za.co.infernos.goety.utils.ConfigHelper.getInt(ItemConfig.VoidRobeTeleportChance, 0)).withStyle(main));
            ...
            if (stack.getItem() instanceof WitchRobeItem) {
                ...
                if (za.co.infernos.goety.utils.ConfigHelper.getInt(ItemConfig.WitchRobeResistance, 0) > 0) {
                    tooltip.add(Component.translatable("info.goety.witch_robe", za.co.infernos.goety.utils.ConfigHelper.getInt(ItemConfig.WitchRobeResistance, 0)).withStyle(secondary));
                }
            }
            if (stack.getItem() instanceof WarlockGarmentItem) {
                ...
                if (stack.getItem() instanceof WarlockRobeItem && za.co.infernos.goety.utils.ConfigHelper.getInt(ItemConfig.WarlockRobeResistance, 0) > 0) {
                    tooltip.add(Component.translatable("info.goety.warlock_robe", za.co.infernos.goety.utils.ConfigHelper.getInt(ItemConfig.WarlockRobeResistance, 0)).withStyle(secondary));
                }
            }
            if (stack.getItem() instanceof NetherRobeItem) {
                if (za.co.infernos.goety.utils.ConfigHelper.getInt(ItemConfig.NetherRobeResistance, 0) > 0) {
                    tooltip.add(Component.translatable("info.goety.nether_robe", za.co.infernos.goety.utils.ConfigHelper.getInt(ItemConfig.NetherRobeResistance, 0)).withStyle(main));
                }
