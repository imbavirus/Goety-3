...
import za.co.infernos.goety.utils.SpellExplosion;
...
public class BouncyBubble extends SpellHurtingProjectile{
    ...
    public float damage = za.co.infernos.goety.utils.ConfigHelper.getFloat(SpellConfig.BouncyBubbleDamage, 1.0F) * WandUtil.damageMultiply();
