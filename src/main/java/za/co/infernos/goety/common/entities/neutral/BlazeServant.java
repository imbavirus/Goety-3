...
public class BlazeServant extends Summoned {
    ...
    public static AttributeSupplier.Builder setCustomAttributes(){
        return Mob.createMobAttributes()
                .add(Attributes.MAX_HEALTH, za.co.infernos.goety.utils.ConfigHelper.getDouble(AttributesConfig.BlazeServantHealth, 20.0D))
                .add(Attributes.ATTACK_DAMAGE, za.co.infernos.goety.utils.ConfigHelper.getDouble(AttributesConfig.BlazeServantMeleeDamage, 20.0D))
                .add(Attributes.ARMOR, za.co.infernos.goety.utils.ConfigHelper.getDouble(AttributesConfig.BlazeServantArmor, 20.0D))
    ...
    public void setConfigurableAttributes() {
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.MAX_HEALTH), za.co.infernos.goety.utils.ConfigHelper.getDouble(AttributesConfig.BlazeServantHealth, 20.0D));
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.ATTACK_DAMAGE), za.co.infernos.goety.utils.ConfigHelper.getDouble(AttributesConfig.BlazeServantMeleeDamage, 20.0D));
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.ARMOR), za.co.infernos.goety.utils.ConfigHelper.getDouble(AttributesConfig.BlazeServantArmor, 20.0D));
    }
                ...
                if (d0 < 4.0D) {
                    ...
                    if (this.attackTime <= 0) {
                        ...
                        if (this.attackStep > 1) {
                            ...
                            float damage = (float)za.co.infernos.goety.utils.ConfigHelper.getDouble(AttributesConfig.BlazeServantRangeDamage, 20.0D) + this.blaze.getFireBallDamage();
