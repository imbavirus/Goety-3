    ...
    public void hurtMobs(LivingEntity living){
        if (this.getTrueOwner() != null) {
            if (CuriosFinder.hasUnholySet(this.getTrueOwner())) {
                if (living.hurt(ModDamageSource.hellfire(this, this.getTrueOwner()), (float)za.co.infernos.goety.utils.ConfigHelper.getDouble(AttributesConfig.ApostleMagicDamage, 20.0D) / 1.5F)){
