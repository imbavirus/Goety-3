        ...
        if (target.isAlive() && !target.isInvulnerable() && target != livingEntity) {
            ...
            if (livingEntity == null) {
                flag = target.hurt(ModDamageSource.spike(this, this),
                        za.co.infernos.goety.utils.ConfigHelper.getFloat(SpellConfig.SpikeDamage, 1.0F) + this.getExtraDamage());
            } else {
            ...
            if (flag) {
                if (livingEntity instanceof Player player) {
                    ...
                    SEHelper.increaseSouls(player, za.co.infernos.goety.utils.ConfigHelper.getInt(SpellConfig.SpikeGainSouls, 0) * soulEater);
