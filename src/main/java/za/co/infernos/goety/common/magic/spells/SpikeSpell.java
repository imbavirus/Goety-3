...
public class SpikeSpell extends Spell {
    ...
    public int defaultSoulCost() {
        return za.co.infernos.goety.utils.ConfigHelper.getInt(SpellConfig.SpikeCost, 0);
    }

    public int defaultCastDuration() {
        return za.co.infernos.goety.utils.ConfigHelper.getInt(SpellConfig.SpikeDuration, 0);
    }
    ...
    public int defaultSpellCooldown() {
        return za.co.infernos.goety.utils.ConfigHelper.getInt(SpellConfig.SpikeCoolDown, 0);
    }
    ...
    public List<Enchantment> acceptedEnchantments() {
        ...
        if (za.co.infernos.goety.utils.ConfigHelper.getInt(SpellConfig.SpikeGainSouls, 0) > 0){
