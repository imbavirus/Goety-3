...
public class Neollager extends AbstractIllagerServant {
    ...
    public static AttributeSupplier.Builder setCustomAttributes() {
        return Monster.createMonsterAttributes()
                ...
                .add(Attributes.MAX_HEALTH, za.co.infernos.goety.utils.ConfigHelper.getDouble(AttributesConfig.NeollagerHealth, 20.0D))
                .add(Attributes.ARMOR, za.co.infernos.goety.utils.ConfigHelper.getDouble(AttributesConfig.NeollagerArmor, 20.0D));
    }

    public void setConfigurableAttributes(){
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.MAX_HEALTH), za.co.infernos.goety.utils.ConfigHelper.getDouble(AttributesConfig.NeollagerHealth, 20.0D));
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.ARMOR), za.co.infernos.goety.utils.ConfigHelper.getDouble(AttributesConfig.NeollagerArmor, 20.0D));
    }
    ...
    public <T extends Mob> T convertTo(EntityType<T> p_21407_, boolean p_21408_) {
        ...
        if (convert instanceof AbstractIllagerServant servant) {
            if (za.co.infernos.goety.utils.ConfigHelper.getBoolean(MobsConfig.IllagerServantTrainArmor, true) && za.co.infernos.goety.utils.ConfigHelper.getBoolean(MobsConfig.RaiderServantWearArmor, true)) {
